...
<tr><td class="td_left">Nama Produk Komplemen</td><td class="td_right"><input type="text" name="TEMUAN[NAMA_PRODUK]" class="stext" id="nama_produk" title="Nama obat tradisional" rel="required" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg/11" value="<?php echo $sess_produk['NAMA_PRODUK']; ?>" /></td><td class="td_left">Nama Perusahaan</td><td class="td_right"><input type="text" class="stext" id="produsen" title="Nama perusahaan" name="TEMUAN[PRODUSEN]" rel="required" value="<?php echo $sess_produk['PRODUSEN']; ?>"/></td></tr>
...
<?php */?>
<tr><td class="td_left">Jenis satuan</td><td class="td_right"><?php echo form_dropdown('TEMUAN[SATUAN]',$kemasan,$sess_produk['SATUAN'],'class="sel_penyimpangan" rel="required" title="Kemasan"'); ?></td>
...
<tr><td class="td_left">Jumlah Temuan</td><td class="td_right"><input type="text" rel="required" name="TEMUAN[JUMLAH_TEMUAN]" value="<?php echo $sess_produk['JUMLAH_TEMUAN']; ?>"class="sdate" onkeyup="numericOnly($(this))" rel="required" title="Jumlah temuan" /></td><td class="td_left">Keterangan (sumber perolehan)</td><td class="td_right"><input type="text" class="stext" name="TEMUAN[KETERANGAN_SUMBER]" title="Keterangan (sumber perolehan)" value="<?php echo $sess_produk['KETERANGAN_SUMBER']; ?>" /></td></tr>
</table>
