    ...
    <div class="acco2">
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                  ...
                  <tr><td class="td_left">Kepatuhan CPKB dan Keputusan</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KEPATUHAN_CPKB'])); ?></td></tr>
                  <tr><td class="td_left">Latar Belakang Hasil Pemeriksaan yang Lalu</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['LATAR_BELAKANG'])); ?></td></tr>
        ...
        <div class="collapse">
            <div class="accCntnt">
              <h2 class="small garis">Temuan Observasi</h2>
                ...
                <div style="height:5px;"></div>
                <table class="form_tabel">
                  <tr><td class="td_left">Distribusi dan Pengangkutan</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DISTRIBUSI_PENGANGKUTAN'])); ?></td></tr>
                  ...
                  <tr>
                    <td class="td_left">Site Master File</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['SITE_FILE_MASTER'])); ?></td></tr>
                  <tr><td class="td_left">Lain-Lain</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['LAIN_LAIN'])); ?></td></tr>
                ...
                <table class="form_tabel">
                  <tr><td class="td_left">Kesimpulan Temuan</td><td class="td_right" id="kesimpulan_temuan"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_OBSERVASI'])); ?></td></tr>
                </table>
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                    ...
                    <tr><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DIP_A'])); ?></td></tr>
                    <tr><td>Bagian II : Data Mutu Keamanan dan Bahan Kosmetik</td></tr>
                    <tr><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DIP_B'])); ?></td></tr>
                    <tr><td>Bagian III : Data Mutu Kosmetik</td></tr>
                    <tr><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DIP_C'])); ?></td></tr>
                    <tr><td>Bagian IV : Data Keamanan dan Kemanfaatan Kosmetik</td></tr>
                    <tr><td colspan="2"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DIP_D'])); ?></td></tr>
                </table>
                <h2 class="small">Kesimpulan DIP</h2>
                <table class="form_tabel">
                  <tr><td class="td_left">Kesimpulan DIP</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_DIP'])); ?></td></tr>
                  <tr><td class="td_left">Tindak lanjut</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['TINDAK_LANJUT_DIP'])); ?></td></tr>
                </table>
        ...
        <div class="collapse">
				...
				if($isEditTLBalai){
					...
					<tr id="row_catatan" <?php if($sess['HASIL'] == "MK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Catatan<td class="td_right"><?php echo $sess['REKOMENDASI']; ?></td></tr>
                    ...
                    <tr id="row_dttmk" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02OT_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02OT_tddetiltmk"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_DETIL_TMK'])); ?></td></tr>
					</table>
                    <?php
				}else{
					?>
                    ...
                    <tr id="row_catatan" <?php if($sess['HASIL'] == "MK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Catatan<td class="td_right"><textarea class="stext catatan" title="Catatan" name="PEMERIKSAAN_CPKB[REKOMENDASI]"><?php echo $sess['REKOMENDASI']; ?></textarea></td></tr>
                    <tr id="row_tmk" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Detil Hasil Pemeriksaan</td><td class="td_right"><span class="F02OT_mk" style="display:none;"></span><span class="F02OT_temuan_kos"><?php echo form_dropdown('PEMERIKSAAN_CPKB[DETIL_HASIL][]',$detil_tmk,is_array($sel_tmk)?$sel_tmk:'','id="F02OT_detiltmk" class="stext multiselect" multiple title="Detil hasil pemeriksaan. Jika lebih dari satu tekan klik + Ctrl"'); ?></span></td></tr>
                    
                    <tr id="row_dttmk" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02OT_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02OT_tddetiltmk"><textarea class="stext chk" name="PEMERIKSAAN_CPKB[KESIMPULAN_DETIL_TMK]" id="F02OT_detilkesimpulantmk" title="Detil Kesimpulan TMK"><?php echo $sess['KESIMPULAN_DETIL_TMK']; ?></textarea></td></tr>
                    </table>
                    <?php
				}
				?>
                ...
                ?>
                <tr>
                  <td class="td_left">Hasil</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_CPKB[HASIL_PUSAT]',$hasil,$sess['HASIL_PUSAT'],'class="stext" title="Rekomendasi Hasil Pusat"'); ?></td></tr>
                <tr>
                  <td class="td_left">Catatan</td><td class="td_right"><textarea class="stext chk" title="Catatan rekomendasi pusat" name="PEMERIKSAAN_CPKB[CATATAN_PUSAT]"><?php echo $sess['CATATAN_PUSAT']; ?></textarea></td></tr>
                <?php }else{ ?>
                <tr>
                  <td class="td_left"> Hasil Pusat</td><td class="td_right"><?php echo $sess['HASIL_PUSAT']; ?></td></tr>
                <tr>
                  <td class="td_left">Catatan</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['CATATAN_PUSAT'])); ?></td></tr>
                <?php } ?>
                </table>
                <?php
				if($isEditTL){
                    ...
                    <tr><td class="td_left">Time Line</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['TIME_LINE'])); ?></td></tr>
                    </table>
                    <h2 class="small">C A P A</h2>
                    <table class="form_tabel">
                    <tr><td class="td_left">Hasil Evaluasi CAPA</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['STATUS_CAPA'])); ?></td></tr>
                    </table>
                    <?php
				}else{
					?>
        ...
        <div class="collapse">
            <div class="accCntnt">
              <h2 class="small garis">Perbaikan</h2>
                ...
                <tr id="row_attach" <?php if($sess['STATUS_CAPA'] == "CAPA Closed") echo 'style="display:none;"'; else echo 'style=""'; ?>><td class="td_left"></td><td class="td_right td_attach"><input type="file" class="stext upload" name="userffile" id="attach_perbaikan" url="<?php echo site_url(); ?>/utility/uploads/get_upload_tabel/perbaikan/<?php echo $sess['SARANA_ID']; ?>" allowed="xls-xlsx-doc-docx-rar-zip-pdf" onchange="attach_doc_perbaikan($(this)); return false;" title="File perbaikan" />&nbsp;File tipe : *.doc, *.docx, *.xls, *.xlsx, *.rar, *.zip, *.pdf</td></tr>
                <tr id="row_capa_close" <?php if( $sess['STATUS_CAPA'] == "Perbaikan CAPA" || trim($sess['STATUS_CAPA']) == "") echo 'style="display:none;"'; else echo 'style=""'; ?>><td class="td_left">Detail Perbaikan</td><td class="td_right"><?php echo form_dropdown($obj_ot.'[CAPA_CLOSED]',$capa_close_cpkb,$sess['CAPA_CLOSED'],'class="stext" title="Detail perbaikan CAPA"'); ?></td>
              </tr>
                </table> 
                ...
                ?>
                <?php /*?><a href="#" class="sperbaikan" url="<?php echo $urlPerbaikan; ?>" onclick="jpopup($(this).attr('url'),'SIPT Versi 1.0','',900,''); return false;">Klik disini untuk menambahkan surat perbaikan</a><?php */?>
                </div>
            </div>
        </div><!-- Akhir Perbaikan !-->      
        <?php
...
<div><?php if($isverifikasi){ ?><a href="#" class="button check" onclick="fpost('#f01KO_','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a></div>
<div id="clear_fix"></div>
...
$(document).ready(function(){
	...
	$("#F02OT_detiltmk").change(function(){
		...
		$("#F02OT_detiltmk option:selected").each(function(i){
			str += '<div style="padding-bottom:5px;"><textarea class="stext catatan" name="PEMERIKSAAN_CPKB[KESIMPULAN_DETIL_TMK][]" id="F02OT_detilkesimpulantmk" title="Detil Kesimpulan TMK">'+$(this).text()+' : </textarea></div>';
			gabung += '- '+$(this).text()+"\r\n";
		});
