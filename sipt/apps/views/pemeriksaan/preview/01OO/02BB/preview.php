...
<table class="detil" width="100%">
    ...
    <tr><td>Sarana Bertindak Sebagai</td><td><?php echo $sess['SARANA_BB'] != '' ? $sess['SARANA_BB'] : '-'; ?></td></tr>
    <tr><td>Status Sarana</td><td><?php echo $sess['STATUS_SARANA'] != '' ? $sess['STATUS_SARANA'] : '-'; ?></td></tr>
