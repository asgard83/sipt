...
<tr><td class="td_left">Ringkasan hasil inspeksi sebelumnya</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['LATAR_BELAKANG'])); ?></td></tr>
