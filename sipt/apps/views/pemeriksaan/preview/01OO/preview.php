...
<table class="detil" width="100%">
    ...
    <tr><td>Standard</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['STANDARD'])); ?></td></tr>
    <tr><td>Kepatuhan CPOB & Keputusan</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KEPATUHAN_CPOB'])); ?></td></tr>
    ...
    <tr><td>Rekomendasi</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['REKOMENDASI'])); ?></td></tr>
    <tr><td>Kesimpulan</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN'])); ?></td></tr>
    <tr><td>Distribusi Laporan</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DISTRIBUSI_LAPORAN'])); ?></td></tr>
