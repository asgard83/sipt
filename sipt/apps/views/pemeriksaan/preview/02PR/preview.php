...
<table class="detil" width="100%">
    ...
    <tr><td>Kesimpulan</td><td><?php echo $sess['URAIAN'];?></td></tr>
    <tr><td>Tindakan</td><td><?php if(trim($sess["TINDAKAN"]) != ""){ ?><ul style="list-style-type:decimal; padding-left:20px; margin:0;"><?php $tindakan = explode("#", $sess['TINDAKAN']); echo "<li>".join("</li><li>", $tindakan)."</li>"; ?></ul><?php } ?></ul></td></tr>
</table>
