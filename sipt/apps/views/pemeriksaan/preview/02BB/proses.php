  ...
  <form name="f02BB_" id="f02BB_" method="post" action="<?php echo $act; ?>" autocomplete="off">
    <div class="adCntnr">
      <div class="acco2">
        ...
        <div id="periksa-sebelumnya" <?php if($sess['TUJUAN_PEMERIKSAAN'] == "Penelusuran Jaringan"){ echo 'style="display:none;"'; }else{ echo 'style=""'; } ?>>
          <div style="height:5px;"></div>
        ...
        <div class="collapse">
          <div class="accCntnt">
            ...
            <table id="f02BB_tbhasil" class="form_tabel">
              <tr>
                <td class="td_left">Hasil Pemeriksaan Balai</td>
                <td class="td_right"><?php echo $sess['HASIL']; ?></td>
              </tr>
              <?php if($this->newsession->userdata('SESS_BBPOM_ID') == "96" && $BBPOM_ID != "96"){?>
              <tr>
                <td class="td_left">Hasil Kesimpulan Pusat</td>
                <td class="right"><?php echo array_key_exists('6', $this->newsession->userdata('SESS_KODE_ROLE')) ? $sess['HASIL_PUSAT'] : form_dropdown($obj_hasil, $hasil,$sess['HASIL_PUSAT'] != "" ? $sess['HASIL_PUSAT'] : '', 'id="hasil_pusat" class="stext" title="Hasil Kesimpulan" class="stext" title="Hasil Kesimpulan"'); ?></td>
              </tr>
              <?php }else{
              ...
              <tr>
                <td class="td_left">Hasil Kesimpulan Pusat</td>
                <td class="right"><?php echo $sess['HASIL_PUSAT']; ?></td>
              </tr>
              <?php
							}?>
              <tr>
            ...
            <table class="form_tabel" id="tbltmpbb" <?php echo array_key_exists('STTS_SARANA', $sess) && $sess['STTS_SARANA'] == '4' ? '' : 'style="display:none"'; ?>>
              <tr>
                <td class="td_left">Jenis bahan berbahaya yang pernah di kelola</td>
                <td class="td_right"><?php echo str_replace("#","<br>",$sess['KELOLA_BB']); ?></td>
              </tr>
            </table>
