...
<table class="detil" width="100%">
    ...
    <tr><td>Saran</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['REKOMENDASI']));?></td></tr>
    ...
    <tr><td>CAPA</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['CAPA']));?></td></tr>
</table>
