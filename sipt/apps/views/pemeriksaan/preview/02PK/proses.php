    ...
    <div class="acco2">
        ...
        <div class="collapse">
				...
				if($isEditTLBalai){//Operator
                    ...
                    <tr id="row_dttmk"><td class="td_left" id="F02PK_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02PK_tddetiltmk"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_DETIL_TMK'])); ?></td></tr>
                    <?php
				}else{//Spv
					?>
                <tr><td class="td_left">Hasil Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown($obj_ot.'[HASIL]', $hasil, array_key_exists('HASIL', $sess)?$sess['HASIL']:'', 'id="F02PK_hasil" class="stext" rel="required" title="Hasil Kesimpulan"'); ?></td></tr>
                ...
                <tr id="row_tmk" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Detil Hasil Pemeriksaan</td><td class="td_right"><span class="F02PK_mk" style="display:none;"></span><span class="F02PK_temuan_kos"><?php echo form_dropdown($obj_ot.'[DETIL_HASIL][]',$detil_tmk,is_array($sel_tmk)?$sel_tmk:'','id="F02PK_detiltmk" class="stext multiselect" multiple title="Detil hasil pemeriksaan produk. Jika lebih dari satu tekan klik + Ctrl"'); ?></span></td></tr>
                <tr id="row_dttmk" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02PK_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02PK_tddetiltmk"><textarea class="stext chk" name="<?php echo $obj_ot; ?>[KESIMPULAN_DETIL_TMK]" id="F02PK_detilkesimpulantmk" title="Detil Kesimpulan TMK"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_DETIL_TMK'])); ?></textarea></td></tr>
				<?php
				}
				?>                
                </table>
...
<div><?php if($isverifikasi) { ?><a href="#" class="button check" onclick="fpost('#f02PK_','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a></div>
<div id="clear_fix"></div>
