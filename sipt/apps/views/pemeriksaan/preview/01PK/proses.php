    ...
    <div class="acco2">
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                  ...
                  <tr><td class="td_left">Standard yang Digunakan</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['STANDARD'])); ?></td></tr>

                  <tr><td class="td_left">Kepatuhan dan Keputusan</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KEPATUHAN_CPPKB'])); ?></td></tr>
        ...
        <div class="collapse">
				...
				if($isEditTLBalai){
					...
					?>
                    <table id="F02OT_tbhasil" class="form_tabel">
                    <tr id="row_hasil" <?php if($sess['TUJUAN_PEMERIKSAAN'] == "Sertifikasi" || $sess['TUJUAN_PEMERIKSAAN'] == "Prasertifikasi" || $sess['TUJUAN_PEMERIKSAAN'] == "Resertifikasi") echo 'style="display:none"'; else echo 'style=""';?>><td class="td_left">Hasil Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_CPPKB[HASIL]', $hasil, array_key_exists('HASIL', $sess)?$sess['HASIL']:'', 'id="F02OT_hasil" class="stext" rel="required" title="Hasil Kesimpulan"'); ?></td></tr>
                    <tr id="row_catatan" <?php if($sel_hasil == "MK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Catatan<td class="td_right"><textarea class="stext catatan" title="Catatan" name="PEMERIKSAAN_CPPKB[REKOMENDASI]"><?php echo $sess['REKOMENDASI']; ?></textarea></td></tr>
                    ...
                    <tr id="row_dttmk"  <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02OT_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02OT_tddetiltmk">
                    <div style="padding-bottom:5px;"><textarea class="stext chk" name="PEMERIKSAAN_CPPKB[KESIMPULAN_DETIL_TMK]" id="F02OT_detilkesimpulantmk" title="Detil Kesimpulan TMK"><?php echo $sess['KESIMPULAN_DETIL_TMK']; ?></textarea></div>
                    </td></tr>
                    </table>
                 <?php
				}
				...
				?>
                <tr>
                  <td class="td_left">Hasil</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_CPPKB[HASIL_PUSAT]',$hasil,$sess['HASIL_PUSAT'],'class="stext" title="Rekomendasi Hasil Pusat"'); ?></td></tr>
                <tr><td class="td_left">Catatan </td><td class="td_right"><textarea class="stext chk" title="Catatan rekomendasi pusat" name="PEMERIKSAAN_CPPKB[CATATAN_PUSAT]"><?php echo $sess['CATATAN_PUSAT']; ?></textarea></td></tr>
				<?php }else{ ?>
                <tr>
                  <td class="td_left">Hasil</td><td class="td_right"><?php echo $sess['HASIL_PUSAT']; ?></td></tr>
				...
				if($isEditTL){
                    ...
                    <table class="form_tabel">
                    <tr><td class="td_left">Tindak Lanjut Hasil Inspeksi</td><td class="td_right"><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['TINDAK_LANJUT'])); ?></td></tr>
                    ...
                    <h2 class="small garis">Tindak Lanjut</h2>
                      ...
                      <tr><td class="td_left">Time Line</td><td class="td_right"><textarea class="stext catatan" id="timeline" name="PEMERIKSAAN_CPPKB[TIME_LINE]" title="Timeline tindak lanjut hasil inspeksi"><?php echo $sess['TIME_LINE']; ?></textarea></td></tr>
                      </table>
                      <h2 class="small">C A P A</h2>
                      <table class="form_tabel">
        ...
        <div class="collapse">
            <div class="accCntnt">
              <h2 class="small garis">Perbaikan</h2>
                <table class="form_tabel">
               	<tr><td class="td_left">Tanggal Perbaikan</td><td class="td_right"><input type="text" class="sdate" id="F01PK_tgl_perbaikan" name="PERBAIKAN[TANGGAL_PERBAIKAN]" title="Tanggal perbaikan" /></td></tr>
                <tr id="row_perbaikan" <?php if($sess['STATUS_CAPA'] == "CAPA Closed") echo 'style="display:none;"'; else echo 'style=""'; ?>><td class="td_left">Detail Perbaikan</td><td class="td_right"><textarea id="F01PK_perbaikan" name="PERBAIKAN[DETAIL_PERBAIKAN]" class="stext catatan" title="Detail perbaikan"></textarea></td></tr>
...
<div><?php if($isverifikasi){ ?><a href="#" class="button check" onclick="fpost('#f01PK_','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a></div>
<div id="clear_fix"></div>
...
$(document).ready(function(){
	...
	$('#F01PK_tgl_perbaikan').datepicker({ changeMonth: true,changeYear: true,autoSize: true, dateFormat: 'dd/mm/yy',regional: 'id'});
	...
	$("#F02OT_detiltmk").change(function(){
		...
		$("#F02OT_detiltmk option:selected").each(function(i){
			str += '<div style="padding-bottom:5px;"><textarea class="stext catatan" name="PEMERIKSAAN_CPPKB[KESIMPULAN_DETIL_TMK][]" id="F02OT_detilkesimpulantmk" title="Detil Kesimpulan TMK">'+$(this).text()+' : </textarea></div>';
			gabung += '- '+$(this).text()+"\r\n";
		});
