...
<div style="text-align:justify">Sehubungan dengan hal tersebut di atas, kepada Saudara kami berikan sanksi berupa <b><?php echo $sess['PERIHAL SURAT']; ?></b> produksi pada fasilitas produksi sediaan : <?php echo $sess['TINDAKAN']; ?>,  selama <?php echo $sess['AWAL_PSK']; ?> sampai dengan fasilitas memenuhi persyaratan CPKB
</div>
...
<ul style="list-style-type:decimal;">
    ...
    <li>Surat pernyataan dari Pimpinan dan Apoteker Penanggung Jawab <?php echo $sess_['NAMA_SARANA']; ?> untuk memenuhi ketentuan CPKB</li>
</ul>
</div>
