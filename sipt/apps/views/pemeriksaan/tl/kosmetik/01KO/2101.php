...
<div style="padding-bottom:20px;">
	<ul>
		...
		for($i=0; $i<count($major); $i++){
            ...
            <?php
			if($major[$i]['URAIAN'] != $currenttemuan){
				echo $major[$i]['URAIAN'];
			}
			$currenttemuan = $major[$i]['URAIAN'];
			?>
            </b></div>
            <div style="text-align:justify; margin-left:20px;"><?php echo $major[$i]['TEMUAN_TEKS']; ?></div>
            <?php
		}
		?>
        </li>
