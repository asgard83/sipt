...
<div style="height:30px;"></div>
<div style="text-align:justify">
Bahwa berdasarkan hal tersebut di atas, maka kami minta Saudara untuk : <br />
<ul style="list-style-type:decimal;">
	<li>Melakukan <b><?php echo $sess['PERIHAL SURAT']; ?></b> kepada <?php echo $sess['NAMA_SARANA']; ?> , selama <?php echo $sess['AWAL_PSK']; ?> / sampai <?php echo $sess['AKHIR_PSK']; ?>  serta melakukan stock opname dan pengamanan terhadap stock obat yang ada</li>
    <li>Melaporkan hasil pelaksanaan butir (1) tersebut serta mengirimkan berita acara <?php echo $sess['PERIHAL SURAT']; ?> PBF tersebut kepada kami</li>
</ul>
</div>

<div style="height:30px;"></div>
<div style="text-align:justify;">
<b><?php echo $sess['PERIHAL SURAT']; ?></b> PBF tersebut dapat diaktifkan kembali kegiatannya dengan persetujuan kami setelah mempertimbangkan :
<ul style="list-style-type:decimal;">
	<li>Surat permohonan dari PBF untuk mengaktifkan kembali PBF-nya.</li>
    <li>CAPA terhadap pelanggaran yang ditemukan dalam pemeriksaan telah kami setujui.</li>
    ...
    <li>Telah selesai masa penghentian <?php echo $sess['AWAL_PSK']; ?> sejak tanggal pelaksanaan penghentian kegiatan oleh <?php echo $sess['BALAI'];?> / pemenuhan persyaratan ber-dasarkan temuan hasil inspeksi</li>
</ul>
</div>
