    ...
    <div class="acco2">
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                    ...
                    <tr><td class="td_left">Tujuan Pemeriksaan</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[TUJUAN_PEMERIKSAAN]', $tujuan_pemeriksaan, $sess['TUJUAN_PEMERIKSAAN'], 'class="stext" id="F02PR_tujuan" rel="required" title="Tujuan Pemeriksaan"'); ?></td></tr>
                    </table>
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                    <tr><td width="10"></td>
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[KLASIFIKASI_PEMERIKSAAN]', $klasifikasi_distribusi,array_key_exists('KLASIFIKASI_PEMERIKSAAN', $sess)?$sess['KLASIFIKASI_PEMERIKSAAN']:'', 'id="F02OT_klasifikasi" class="stext" rel="required" title="Pilih salah satu klasifkasi : Importir, Badan Usaha, Distribusi, Penjualan melalui media eletkronik"'); ?></td>
                      </tr>
                </table>
                ...
                <table class="form_tabel">
                    ...
                    <tr id="F02PK_point21a">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[0],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[0]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point21b">
                      <td></td>
                      <td class="atas">b.</td>
                      <td class="atas">Memiliki Angka Pengelan Impor (API)</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[1],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[1]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point21c">
                      <td></td>
                      <td class="atas">c.</td>
                      <td class="atas">Memiliki Surat Keterangan Impor (SKI)</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[2],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[2]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point21d">
                      <td></td>
                      <td class="atas">d.</td>
                      <td class="atas">Memiliki Dokumen Persetujuan Pendaftaran</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[3],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[3]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point21e">
                      <td></td>
                      <td class="atas">e.</td>
                      <td class="atas">Memiliki faktur / bon penjualan</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[4],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[4]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point21f">
                      <td></td>
                      <td class="atas">f.</td>
                      <td class="atas">Ada pencatatan pemasukan dan penjualan dalam kartu stock</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[5],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[5]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point22g">
                      <td></td>
                      <td class="atas">g.</td>
                      <td class="atas">Surat Keterangan GMP produsen Luar Negeri</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[6],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[6]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point23h">
                      <td></td>
                      <td class="atas">h.</td>
                      <td class="atas">Certificate of Free Sales (CFS)</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[7],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[7]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point24i">
                      <td></td>
                      <td class="atas">i.</td>
                      <td class="atas">Surat Penunjukan Sebagai Importir</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[8],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[8]; ?></textarea></td>
                      </tr>
                </table>
            </div>
                ...
                <table class="form_tabel">
                    ...
                    <tr id="F02PK_point22a">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[9],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[9]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point22b">
                      <td></td>
                      <td class="atas">b.</td>
                      <td class="atas">Memiliki Dokumen Persetujuan Pendaftaran</td>                  
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[10],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[10]; ?></textarea></td>
                    ...
                    <tr id="F02PK_point22c">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[11],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[11]; ?></textarea></td>
                    ...
                    <tr id="F02PK_point22d">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[12],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[12]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point22e">
                      <td></td>
                      <td class="atas">e.</td>
                      <td class="atas">Ada pencatatan pemasukan dan penjualan dalam kartu stock</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[13],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[13]; ?></textarea></td>
                      </tr>
                </table>
                ...
                <table class="form_tabel">
                    ...
                    <tr id="F02PK_point23a">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[14],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[14]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point23b">
                      <td></td>
                      <td class="atas">b.</td>
                      <td class="atas">Memiliki  faktur pembelian </td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[15],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[15]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point23c">
                      <td></td>
                      <td class="atas">c.</td>
                      <td class="atas">Mengeluarkan  bon penjualan </td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[16],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[16]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point23d">
                      <td></td>
                      <td class="atas">d.</td>
                      <td class="atas">Ada  pencatatan pemasukan dan penjualan dalam kartu stock</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[17],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[17]; ?></textarea></td>
                      </tr>
                </table>
            </div>
                ...
                <table class="form_tabel">
                    ...
                    <tr>
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[18],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak" onchange="show_hide($(this).val(), \'.detail_gudang\');"'); ?></td>
                  </tr>
                </table>
                </div>
                ...
                <table class="form_tabel">
                    <tr id="F02PK_gudang_detail1">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[19],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[18]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail2">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>- Memiliki  gudang pada alamat lain</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[20],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[19]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail3">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>- Memiliki  gudang yang memenuhi syarat</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[21],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[20]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail4">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;&nbsp;1.&nbsp;Kebersihan</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[22],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[21]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail5">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;&nbsp;2.&nbsp;Terhindar  dari binatang pengerat</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[23],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[22]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail6">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;&nbsp;3.&nbsp;Dilengkapi  pendingin udara untuk produk tertentu </td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[24],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[23]; ?></textarea></td>
                  </tr>
                    <tr id="F02PK_gudang_detail7">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;&nbsp;4.&nbsp;Terhindar  dari kebocoran</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[25],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan" id="F02PK_gudang_teks"><?php echo $aspek_keterangan[24]; ?></textarea></td>
                  </tr>
                </table>
      </div>
                ...
                <table class="form_tabel">
                    <tr>
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[26],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak" onchange="show_hide($(this).val(), \'.detail_display\');"'); ?></td>
                  </tr>
                </table>
                </div>
                ...
                <table class="form_tabel">
                    <tr id="F02PK_display_produk_detail1">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[27],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[25]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_display_produk_detail2">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>- Rak</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[28],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[26]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_display_produk_detail3">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>- Lain-lain</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[29],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[27]; ?></textarea></td>
                      </tr>
                </table>
            </div>
                ...
                <table class="form_tabel">
                    <tr>
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[30],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak" onchange="show_hide($(this).val(), \'.detail_syarat\');"'); ?></td>
                      </tr>
                </table>
                </div>
                ...
                <table class="form_tabel">
                    <tr id="F02PK_display_produk1_detail1">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[31],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[28]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_display_produk1_detail2">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>2. Terhindar  dari binatang pengerat</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[32],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[29]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_display_produk1_detail3">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>3. Dilengkapi  pendingin udara untuk produk tertentu</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[33],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[30]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_display_produk1_detail4">
                      <td></td>
                      <td>&nbsp;</td>
                      <td>4. Terhindar  dari kebocoran</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[34],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[31]; ?></textarea></td>
                      </tr>
                </table>
            </div>
                ...
                <table class="form_tabel">
                    ...
                    <tr id="F02PK_point321">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[35],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[32]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point322">
                      <td></td>
                      <td class="atas">b.</td>
                      <td class="atas">Cara  meletakkan produk teratur</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[36],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[32]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point323">
                      ...
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[37],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[33]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point324">
                      <td></td>
                      <td class="atas">d.</td>
                      <td class="atas">Mengikuti  sistem FEFO</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[38],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[34]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point325">
                      <td></td>
                      <td class="atas">e.</td>
                      <td class="atas">Bercampur  dengan produk  lain</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[39],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[35]; ?></textarea></td>
                      </tr>
                    <tr id="F02PK_point326">
                      <td></td>
                      <td class="atas">f.</td>
                      <td class="atas">Bercampur  dengan barang lain</td>
                      <td class="atas"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[ASPEK_CHECK][]',$pilihan,$aspek_check[40],'class="sel_penyimpangan" title="Pilih salah satu, Ya atau Tidak"'); ?></td>
                      <td class="atas"><textarea class="stext" name="PEMERIKSAAN_DIST_OT[ASPEK_KETERANGAN][]" title="Keterangan"><?php echo $aspek_keterangan[36]; ?></textarea></td>
                      </tr>
                </table>
                </div>
                ...
                <table id="form_tabel">
                  <tr><td class="td_left">&nbsp;</td><td class="td_right"><textarea class="stext chk" name="PEMERIKSAAN_DIST_CPOTB[HASIL_TEMUAN_LAIN]" id="TEMUAN_LAIN" title="Hasil temuan lainnya yang tidak tercantum dalam aspek penilaian"><?php echo $sess['HASIL_TEMUAN_LAIN'];?></textarea></td></tr>
                </table>
        ...
        <div class="collapse">
                ...
                <tr><td class="temuan_left">Nama Obat Tradisional</td><td class="temuan_right"><input type="text" class="stext" id="F01HH_temuan_obat" title="Nama obat tradisional" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg/ot" /></td><td class="temuan_pemisah">&nbsp;</td><td class="temuan_left">Nama Perusahaan</td><td class="temuan_right"><input type="text" class="stext" id="F01HH_temuan_perusahaan" title="Nama perusahaan"/></td></tr>
        ...
        <div class="collapse">
                ...
                <tr><td class="td_left">Hasil Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN[HASIL]', $hasil, array_key_exists('HASIL', $sess)?$sess['HASIL']:'', 'id="F02OT_hasil" class="stext" rel="required" title="Hasil Kesimpulan"'); ?></td></tr>
                <tr id="row_catatan" <?php if($sel_hasil == "MK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Catatan<td class="td_right"><textarea class="stext catatan" title="Catatan" name="PEMERIKSAAN_DIST_OT[CATATAN]"><?php echo $sess['CATATAN']; ?></textarea></td></tr>
                <tr id="row_tmk" <?php if($sel_hasil == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Detil Hasil Pemeriksaan</td><td class="td_right"><span class="F02OT_mk" style="display:none;"></span><span class="F02OT_temuan_kos"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[DETIL_HASIL][]',$detil_tmk,is_array($sel_tmk)?$sel_tmk:'','id="F02OT_detiltmk" class="stext multiselect" multiple title="Detil hasil pemeriksaan. Jika lebih dari satu tekan klik + Ctrl"'); ?></span></td></tr>
                <tr id="row_dttmk" <?php if($sel_hasil == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02OT_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02OT_tddetiltmk"><textarea class="stext chk" name="PEMERIKSAAN_DIST_OT[KESIMPULAN_DETIL_TMK]" id="KESIMPULAN_DETIL_TMK" title="Detil Kesimpulan TMK"><?php echo $sess['KESIMPULAN_DETIL_TMK']; ?></textarea></td></tr>
                </table>
                
                <h2 class="small">Tindak Lanjut</h2>
                <table class="form_tabel">
                <tr><td class="td_left">Tindak lanjut</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_DIST_OT[TINDAK_LANJUT_BALAI][]',$tindak_lanjut_balai,is_array($sel_tl_balai)?$sel_tl_balai:'','class="stext multiselect" multiple title="Tindak lanjut terhadap sarana. Jika lebih dari satu klik + Ctrl"'); ?></td></tr>
                <tr><td class="td_left">Saran Tindak Lanjut</td><td class="td_right"><textarea class="stext chk" title="Saran Tindak Lanjut" name="PEMERIKSAAN_DIST_OT[SARAN_TL]"><?php echo $sess['SARAN_TL']; ?></textarea></td></tr>
                </table>
...
<div><a href="#" class="button save" onclick="fpost('#f02OT_','',''); return false;"><span><span class="icon"></span>&nbsp; Simpan &nbsp;</span></a>&nbsp;<a href="#" class="button back" url="<?php echo $urlback; ?>" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Batal &nbsp;</span></a></div>
<div id="clear_fix"></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#F02OT_klasifikasi").change(function(){
			val = $(this).val();
