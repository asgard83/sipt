...
<div class="content">
<form name="f02TR_" id="f02TR_" method="post" action="<?php echo $act; ?>" autocomplete="off">
<div class="adCntnr">
    <div class="acco2">
          ...
          <div class="collapse">
                  ...
                  <table class="form_tabel">
                      <tr>
                        <td class="td_left">Nama Rumah Sakit</td>
                ...
                <table class="form_tabel">
                  ...
                  <tr><td class="td_left">Tujuan Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_DISTRIBUSI[TUJUAN_PEMERIKSAAN]', $tujuan_periksa, array_key_exists('TUJUAN_PEMERIKSAAN', $sess)?$sess['TUJUAN_PEMERIKSAAN']:'', 'id="F02TR_tujuanperiksa" class="stext" rel="required" title="Pilih salah satu tujuan pemeriksaan"'); ?></td>
                </table>
                  </div>
          </div><!--Akhir Informasi Pemeriksaan !-->
          <div id="F02TR_rutin" <?php if($sel_tujuan != "Rutin"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
          ...
          <div class="collapse">
                  ...
                  <h2 class="small">1. Profil Sarana</h2>
                      <table class="form_tabel" group="1. Profil Sarana">
                          ...
                          <tr id="point1suba" y="Nama dan alamat rumah sakit sesuai Surat Izin dan masih berlaku." t="Nama dan alamat rumah sakit tidak sesuai Surat Izin dan atau sudah tidak berlaku.">
                              <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah nama dan alamat  Rumah Sakit sesuai izin dan masih berlaku?</td>
                              <td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[0]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                          </tr>
                          <tr id="point1subb" y="Kepala Instalasi/Apoteker telah mempunyai SP/SIK" t="Kepala Instalasi/Apoteker tidak mempunyai SP/SIK">
                              <td class="td_no">b.&nbsp;</td><td class="td_aspek">Apakah kepala Instalasi/Apoteker yang telah mempunyai SP/SIK?</td>
                              <td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[1]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                          </tr>
                          <tr id="point1subc" y="Selama jam buka IFRS terdapat tenaga teknis kefarmasian." t="Selama jam buka IFRS tidak terdapat tenaga teknis kefarmasian.">
                            <td class="td_no">c.&nbsp;</td>
                            <td class="td_aspek">Apakah selama jam buka IFRS terdapat tenaga teknis kefarmasian?</td>
                          ...
                          <tr id="point1subd" y="Memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru." t="Tidak atau kurang memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru.">
                            <td class="td_no">d.&nbsp;</td>
                            <td class="td_aspek">Apakah memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru?</td>
                            <td class="td_kritis">Tingkat Kekritisan (M)</td>
                      ...
                      <table class="form_tabel" group="2. Bangunan dan Peralatan">
                          ...
                          <tr id="point2subh" y="Memiliki timbangan." t="Tidak memiliki timbangan.">
                            <td class="td_no">h.&nbsp;</td>
                            <td class="td_aspek">Apakah memiliki timbangan?</td>
                            <td class="td_kritis">Tingkat Kekritisan (m)</td>
                          ...
                          <tr id="point2subi" y="Dilengkapi dengan alat pemadam kebakaran." t="Tidak dilengkapi dengan alat pemadam kebakaran.">
                            <td class="td_no">i.&nbsp;</td>
                            <td class="td_aspek">Apakah dilengkapi dengan alat pemadam kebakaran?</td>
                            <td class="td_kritis">Tingkat Kekritisan (M)</td>
                      ...
                      <table class="form_tabel" group="3. Pengadaan">
                          ...
                          <tr id="point3suba" y="Pengadaan dari sumber resmi." t="Pengadaan tidak dari sumber resmi.">
                              <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah pengadaan dari sumber resmi?</td>
                              <td class="td_kritis">Tingkat Kekritisan (C)</td>
                              <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[13]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                          </tr>
                          <tr id="point3subb" y="Surat pesanan ditandatangani oleh penanggungjawab IFRS mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek." t="Surat pesanan tidak ditandatangani oleh penanggungjawab IFRS, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek.">
                              <td class="td_no">b.&nbsp;</td><td class="td_aspek">Apakah surat pesanan ditandatangani oleh Penaggungjawab IFRS, mencantumkan nama jelas dan nomor SIK/SP dan distempel RS?</td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                          ...
                          <tr id="point3subc" y="Surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan." t="Surat pesanan tidak diarsipkan berdasarkan nomor urut dan tanggal pemesanan.">
                              <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan?</td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                      ...
                      <table class="form_tabel" group="4. Penerimaan dan Penyimpanan">
                          <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                          <tr id="point5suba" y="Tenaga teknis kefarmasian menandatangani faktur pembelian pada saat barang diterima." t="Tenaga teknis kefarmasian tidak menandatangani faktur pembelian pada saat barang diterima.">
                          ...
                          <tr id="point4subdd" y="Pengisian kartu stok dan catatan penerimaan sesuai dengan ketentuan CDOB (manual atau elektronik)" t="Pengisian kartu stok dan catatan penerimaan tidak sesuai dengan ketentuan CDOB (manual atau elektronik)">
                          ...
                          <tr id="point4subh" y="Obat yang kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan diinventarisir, dipisahkan penyimpanannya dan terkunci." t="Obat yang kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan tidak diinventarisir, tidak dipisahkan penyimpanannya dan tidak terkunci.">
                              <td class="td_no">h.&nbsp;</td><td class="td_aspek">Apakah obat yang mendekati kadaluarsa, telah kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan diinventarisir, dipisahkan penyimpanannya dan terkunci?</td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                      ...
                      <table class="form_tabel" group="5. Penyaluran">
                          ...
                          <tr id="point5suba" y="Setiap penyaluran obat keras berdasarkan resep dari RS tersebut." t="Penyaluran obat keras ada yang tidak berdasarkan resep dari RS tersebut">
                              <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah setiap penyaluran obat berdasarkan resep dari dalam RS tersebut?</td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                          ...
                          <tr dir="point5subb" y="Resep diarsipkan berdasarkan nomor urut dan tanggal pengeluaran." t="Resep tidak diarsipkan berdasarkan nomor urut dan tanggal pengeluaran.">
                          ...
                          <tr id="point5subd" y="Apoteker IFRS memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien." t="Apoteker IFRS tidak memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien.">
                              <td class="td_no">d.&nbsp;</td><td class="td_aspek">Apakah Apoteker IFRS memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien?</td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                      ...
                      <table class="form_tabel" group="6. Penanganan Produk Kembalian dan Kadaluarsa">
                          ...
                          <tr id="point6suba" y="Setelah menerima informasi recall dari distributor, IFRS segera menghentikan penjualan dan mengembalikan ke distributor." t="Setelah menerima informasi recall dari distributor, IFRS tidak segera menghentikan penjualan dan mengembalikan ke distributor.">
                              <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah setelah menerima informasi recall dari distributor, IFRS segera menghentikan penjualan dan mengembalikan ke distributor? </td>
                              <td class="td_kritis">Tingkat Kekritisan (M)</td>
                              <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[31]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                          </tr>
                      ...
                      <table class="form_tabel" group="7. Pemusnahan">
                          ...
                          <tr id="point7subc" y="Untuk tiap pemusnahan obat dibuatkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi dari instansi pemerintah yang berwenang." t="Semua atau sebagian pemusnahan obat tidak dibuatkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi dari instansi pemerintah yang berwenang.">
                            <td class="td_no">c.&nbsp;</td>
                            <td class="td_aspek">Apakah untuk tiap pemusnahan obat dibuatkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi dari instansi pemerintah yang berwenang?</td>
                            <td class="td_kritis">Tingkat Kekritisan (M)</td>
          ...
          <div id="F02TR_kasus" <?php if($sel_tujuan != "Kasus"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
          ...
          <div class="collapse">
                  ...
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_A]" id="F02TR_kasus_pointa" title="Profil sarana dan organisasi"><?php echo array_key_exists('KASUS_POINT_A', $sess)?$sess['KASUS_POINT_A']:'';?></textarea>
                  <h2 class="small">B. PERSONALIA</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_B]" id="F02TR_kasus_pointb" title="Personalia"><?php echo array_key_exists('KASUS_POINT_B', $sess)?$sess['KASUS_POINT_B']:'';?></textarea>
                  <h2 class="small">C. GUDANG DAN PERLENGKAPAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_C]" id="F02TR_kasus_pointc" title="Gudang dan Perlengkapak"><?php echo array_key_exists('KASUS_POINT_C', $sess)?$sess['KASUS_POINT_C']:'';?></textarea>
                  <h2 class="small">D. PENGADAAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_D]" id="F02TR_kasus_pointd" title="Pengadaan"><?php echo array_key_exists('KASUS_POINT_D', $sess)?$sess['KASUS_POINT_D']:'';?></textarea>
                  <h2 class="small">E. PENYIMPANAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_E]" id="F02TR_kasus_pointe" title="Penyimpanan"><?php echo array_key_exists('KASUS_POINT_E', $sess)?$sess['KASUS_POINT_E']:'';?></textarea>
                  <h2 class="small">F. PENDISTRIBUSIAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_F]" id="F02TR_kasus_pointf" title="Pendistribusian"><?php echo array_key_exists('KASUS_POINT_F', $sess)?$sess['KASUS_POINT_F']:'';?></textarea>
                  <h2 class="small">G. DOKUMENTASI</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_G]" id="F02TR_kasus_pointg" title="Dokumentasi"><?php echo array_key_exists('KASUS_POINT_G', $sess)?$sess['KASUS_POINT_G']:'';?></textarea>
                  <h2 class="small">H. LAIN-LAIN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_H]" id="F02TR_kasus_pointh" title="Lain - Lain"><?php echo array_key_exists('KASUS_POINT_H', $sess)?$sess['KASUS_POINT_H']:'';?></textarea>
                 </div>
          </div><!-- Akhir Kasus!-->
          </div>
          ...
          <div class="collapse">
                  ...
                  <h2 class="small garis">Hasil Pemeriksaan</h2>
                    <table class="form_tabel">
                        ...
                        <tr id="td_pelanggaran"><td class="td_left">Kesimpulan Detil Pelanggaran</td><td class="right">m&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MINOR]" id="F02TR_jumlahminor" readonly="readonly" value="<?php echo array_key_exists('MINOR', $sess)?$sess['MINOR']:''; ?>" title="Jumlah Minor" />&nbsp;&nbsp;M&nbsp;<input type="text" class="scode" id="F02TR_jumlahmajor" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MAJOR]" readonly="readonly"  value="<?php echo array_key_exists('MAJOR', $sess)?$sess['MAJOR']:''; ?>" title="Jumlah Major" />&nbsp;&nbsp;C&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL]" id="F02TR_jumlahcritical" readonly="readonly" value="<?php echo array_key_exists('CRITICAL', $sess)?$sess['CRITICAL']:''; ?>" title="Jumlah Kritikal" /></td></tr>
                        <tr id="td_hasil"><td class="td_left">Hasil Temuan</td><td class="right"><textarea id="F02TR_catatan" name="PEMERIKSAAN_DISTRIBUSI[HASIL_TEMUAN]" class="stext catatan" title="Hasil Temuan"><?php echo array_key_exists('HASIL_TEMUAN', $sess)?$sess['HASIL_TEMUAN']:'';?></textarea></td></tr>
...
<div id="clear_fix"></div>
    <div><a href="#" class="button save" onclick="fpost('#f02TR_','',''); return false;"><span><span class="icon"></span>&nbsp; Simpan &nbsp;</span></a>&nbsp;<a href="#" class="button back" url="<?php echo $urlback; ?>" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Batal &nbsp;</span></a>&nbsp;<a href="#" class="button download" url="<?php echo site_url(); ?>/post/pemeriksaan/set_preview_distribusi/" onclick="prev_checklist($(this), '#f02TR_'); return false;"><span><span class="icon"></span>&nbsp; Preview Hasil Temuan &nbsp;</span></a></div>
    <div id="clear_fix"></div>
...
$(document).ready(function(){
	...
	if($sess['PERIKSA_ID'] == ""){
		?>
		var m = 0; var M = 0; var C = 0; var Ca = 0; var temuan = new Array(); $("#F02TR_kasus").css("style:display","none");
		<?php
	}else{
		?>
		...
		if($sess['TUJUAN_PEMERIKSAAN'] == "Kasus"){
			?>
			$("#F02TR_rutin").css("style:display","none");
			$("#F02TR_kasus").show();
			<?php
		}else if($sess['TUJUAN_PEMERIKSAAN'] == "Rutin"){
			?>
			$("#F02TR_rutin").show();
			$("#F02TR_kasus").css("style:display","none");
			<?php
		}
	}
	?>
	$("select.sel_penyimpangan").change(function(){ var val = $(this).val(); var tb = $(this).closest("table").attr("id"); var row = $(this).closest("table tr").attr("id"); var point = $("#"+row+" td:nth-child(1)").text(); var tidak = $(this).closest("table tr").attr("t"); var tingkat = $(this).attr("tingkat"); if(tingkat == "m"){ if(val == "T"){ m++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ m--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ m--; } } if(m < 0) return m = 0; }else if(tingkat == "M"){ if(val == "T"){ M++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ M--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ M--; } } if(M < 0) return M = 0; }else if(tingkat == "C"){ if(val == "T"){ C++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ C--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ C--; } } if(C < 0) return C = 0; } if(val == "T"){ temuan.push(tidak); }else if(val == "Y" || val == "N"){ ArrExist(temuan, tidak); } $("#F02TR_jumlahminor").val(parseInt(m)); $("#F02TR_jumlahmajor").val(parseInt(M)); $("#F02TR_jumlahcritical").val(parseInt(C)); $("#F02TR_catatan").val(temuan.join("___")); });
	$("#F02TR_tujuanperiksa").change(function(){ tujuan_pemeriksaan($(this), "#F02TR_rutin", "#F02TR_kasus", "tr#td_pelanggaran", "tr#td_hasil"); });
});
...
function setHasil(elHasil, tdPelanggaran, tdHasil){
  ...
  if(val == "TMK"){
	  ...
	  ?>
	  $("#F02TR_jumlahminor, #F02TR_jumlahmajor, #F02TR_jumlahcritical, #F02TR_catatan").val(''); 
	  $("#F02TR_rutin select.sel_penyimpangan").get(0).selectedIndex = 0;
	  temuan = Array();
  }
  return false;
}
