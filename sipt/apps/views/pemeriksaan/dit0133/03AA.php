...
<div class="content">
<form name="f03AA_" id="f03AA_" method="post" action="<?php echo $act; ?>" autocomplete="off">
<div class="adCntnr">
    <div class="acco2">
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                  <tr>
                    <td class="td_left">Nama Apotek</td>
                  ...
                  <tr>
                    <td class="td_left">Telp.</td><td class="td_right">
					<?php if(trim($sess['TELEPON'])!="") { ?><ul style="list-style-type:decimal; padding-left:20px; margin:0;"><?php $telepon = explode(";", $sess['TELEPON']); echo "<li>".join("</li><li>", $telepon)."</li>"; ?></ul><?php } ?></td>
                </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="td_left">Apoteker Pengelola Apotek (APA)</td>
                    <td class="td_right"><?php echo array_key_exists('NAMA_APA', $sess)?$sess['NAMA_APA']:""; ?></td>
                </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="td_left">Pemilik Sarana Apotek (PSA)</td>
                    <td class="td_right"><?php echo array_key_exists('NAMA_PSA', $sess)?$sess['NAMA_PSA']:""; ?></td>
                </tr>
                  <tr>
                    <td class="td_left">Apokter Pendamping</td>
                    <td class="td_right"><?php echo array_key_exists('NAMA_APOTEKER_PENDAMPING', $sess)?$sess['NAMA_APOTEKER_PENDAMPING']:""; ?></td>
                </tr>
                </table>   			
                ...
                <table class="form_tabel">
                  ...
                  <tr><td class="td_left">Tujuan Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_DISTRIBUSI[TUJUAN_PEMERIKSAAN]', $tujuan_periksa, array_key_exists('TUJUAN_PEMERIKSAAN', $sess)?$sess['TUJUAN_PEMERIKSAAN']:'', 'id="F03AA_tujuanperiksa" class="stext" rel="required" title="Pilih salah satu tujuan pemeriksaan"'); ?></td>
                </table>
                </div>
        </div><!-- Akhir Pemeriksaan !-->	
    	
        <div id="F03AA_rutin" <?php if($sel_tujuan != "Rutin"){ echo 'style="display:none;"'; }?>>
        <div style="height:5px;"></div>
        ...
        <div class="collapse">
                ...
                <table class="form_tabel" group="1. Profil Sarana">
                    ...
                    <tr id="point1suba" y="Nama dan alamat apotek sesuai Surat Izin Apotek." t="Nama dan alamat apotek tidak sesuai Surat Izin Apotek.">
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah nama dan alamat apotek sesuai Surat Izin Apotek?</td>
                    ...
                    <tr id="point1subb" y="APA/Apoteker pendamping dan PSA sesuai izin." t="APA/Apoteker pendamping dan PSA tidak sesuai izin.">
                        <td class="td_no">b.&nbsp;</td><td class="td_aspek">apakah APA/Apoteker pendamping dan PSA sesuai izin?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[1]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point1subc" y="Selama jam buka apotek terdapat tenaga teknis kefarmasian." t="Selama jam buka apotek tidak terdapat tenaga teknis kefarmasian.">
                        <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah selama jam buka apotek terdapat tenaga teknis kefarmasian?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[2]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point1subd" y="Memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru." t="Tidak atau kurang memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru.">
                        <td class="td_no">d.&nbsp;</td><td class="td_aspek">Apakah memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[3]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                </table>
                ...
                <table class="form_tabel" group="2. Bangunan dan Peralatan">
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                    <tr id="point2suba" y="Ukuran, rancang bangun dan konstruksi bangunan/ruangan sesuai dengan ijin." t="Ukuran, rancang bangun dan konstruksi bangunan/ruangan tidak sesuai dengan ijin."> 
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah ukuran, rancang bangun dan konstruksi bangunan/ruangan sesuai dengan ijin?</td>
                    ...
                    <tr id="point2subc" y="Ventilasi dan penerangan di ruangan memadai." t="Ventilasi dan penerangan di ruangan tidak memadai.">
                    ...
                    <tr id="point2sube" y="Mempunyai tempat penyimpanan yang memadai sesuai dengan kriteria penyimpanan obat." t="Tidak mempunyai tempat penyimpanan yang memadai sesuai dengan kriteria penyimpanan obat">
                        <td class="td_no">e.&nbsp;</td><td class="td_aspek">Apakah mempunyai tempat penyimpanan yang memadai sesuai dengan kriteria penyimpanan obat?</td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                    ...
                    <tr id="point2subf" y="Mempunyai tempat khusus penyimpanan narkotika & psikotropika sesuai ketentuan." t="Tidak mempunyai tempat khusus penyimpanan narkotika & psikotropika sesuai ketentuan.">
                        <td class="td_no">f.&nbsp;</td><td class="td_aspek">Apakah mempunyai tempat khusus penyimpanan narkotika &amp; psikotropika sesuai ketentuan?</td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                    ...
                    <tr id="point2subg" y="Memiliki ruang peracikan." t="Tidak memiliki ruang peracikan.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (m)</td>
                        <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[10]:'', 'tingkat="m" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                ...
                <table class="form_tabel" group="3. Pengadaan">
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                    <tr id="point3suba" y="Pengadaan dari sumber resmi." t="Pengadaan tidak dari sumber resmi.">
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah pengadaan dari sumber resmi?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[13]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point3subb" y="Surat pesanan ditandatangani oleh APA, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek." t="Surat pesanan tidak ditandatangani oleh APA, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek.">
                        <td class="td_no">b.&nbsp;</td><td class="td_aspek">Apakah surat pesanan ditandatangani oleh APA, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek?</td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[14]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point3subc" y="Surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan." t="Surat pesanan tidak diarsipkan berdasarkan nomor urut dan tanggal pemesanan.">
                        <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[15]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point3subd" y="Faktur atau Surat Penyerahan Barang (SPB) diarsipkan berdasarkan tanggal penerimaan oleh penanggung jawab dan atau bagian administrasi." t="Faktur atau Surat Penyerahan Barang (SPB) tidak diarsipkan berdasarkan tanggal penerimaan oleh penanggung jawab dan atau bagian administrasi.">
                        <td class="td_no">d.&nbsp;</td><td class="td_aspek">Apakah faktur atau Surat Penyerahan Barang (SPB), diarsipkan berdasarkan tanggal penerimaan oleh penanggung jawab dan atau bagian administrasi?</td>
                ...
                <table class="form_tabel" group="4. Penerimaan dan Penyimpanan">
                    ...
                    <tr id="point4subb" y="Setiap penerimaan barang dilakukan pemeriksaan  terhadap barang tersebut meliputi :  nomor izin edar, nomor bets, tanggal kadaluarsa, kebenaran kemasan, mutu produk secara fisik." t="Semua atau sebagian penerimaan barang tidak dilakukan pemeriksaan terhadap barang tersebut meliputi :  nomor izin edar, nomor bets, tanggal kadaluarsa, kebenaran kemasan, mutu produk secara fisik. ">
                    ...
                    <tr id="point4subf" y="Obat disimpan pada kondisi sesuai dengan yang tercantum dalam kemasan obat serta terpisah dari komoditi lainnya." t="Obat disimpan pada kondisi yang tidak sesuai dengan yang tercantum dalam kemasan obat serta tidak terpisah dari komoditi lainnya.">
                    ...
                    <tr id="point4subg" y="Vaksin/CCP disimpan pada tempat yang sesuai dengan persyaratan penandaan, dilengkapi termometer dan dilakukan pencatatan monitoring suhu minimal dua kali sehari." t="Vaksin/CCP disimpan pada tempat yang tidak sesuai dengan persyaratan penandaan, tidak dilengkapi termometer dan tidak dilakukan pencatatan monitoring suhu minimal dua kali sehari.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (C)</td>
                        <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[23]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point4subh" y="Penyimpanan vaksin dilengkapi dengan  generator otomatis yang berfungsi dengan baik atau mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam." t="Penyimpanan vaksin tidak dilengkapi dengan generator otomatis yang berfungsi dengan baik atau tidak mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (C)</td>
                        <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[24]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point4subi" y="Obat yang kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan diinventarisir, dipisahkan penyimpanannya dan terkunci." t="Obat yang kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan tidak diinventarisir, tidak dipisahkan penyimpanannya dan tidak terkunci.">
                        <td class="td_no">i.&nbsp;</td><td class="td_aspek">Apakah obat yang kadaluarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan diinventarisir, dipisahkan penyimpanannya dan terkunci?</td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                ...
                <table class="form_tabel" group="5. Penyaluran">
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                    <tr id="point5suba" y="Setiap penyaluran obat keras (di luar DOWA) berdasarkan resep yang sah." t="Setiap penyaluran obat keras (di luar DOWA) tidak berdasarkan resep yang sah.">
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah setiap penyaluran obat keras (di luar DOWA) berdasarkan resep yang sah?</td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                    ...
                    <tr id="point5subd" y="APA memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien." t="APA tidak memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien.">
                        <td class="td_no">d.&nbsp;</td><td class="td_aspek">Apakah APA memberikan Konsultasi, Informasi, dan Edukasi (KIE) kepada pasien?</td>
                        <td class="td_kritis">Tingkat Kekritisan (m)</td>
                    ...
                    <tr id="point5sube" y="Obat-obat yang disalurkan adalah obat-obat yang terdaftar" t="Obat-obat yang disalurkan adalah obat-obat yang tidak terdaftar.">
                      <td class="td_no">e.&nbsp;</td>
                      <td class="td_aspek">Apakah  obat-obat yang disalurkan adalah obat-obat yang terdaftar?</td>
                      <td class="td_kritis">Tingkat Kekritisan (C)</td>
                      <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[31]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                  </tr>
                </table>
                ...
                <table class="form_tabel" group="6. Penanganan Produk Kembalian dan Kadaluarsa">
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                    <tr id="point6suba" y="Setelah menerima informasi recall dari distributor, apotek segera menghentikan penjualan dan mengembalikan ke distributor." t="Setelah menerima informasi recall dari distributor, apotek tidak segera menghentikan penjualan dan mengembalikan ke distributor.">
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah setelah menerima informasi recall dari distributor, apotek segera menghentikan penjualan dan mengembalikan ke distributor? </td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                ...
                <table class="form_tabel" group="7. Pemusnahan">
                    ...
                    <tr id="point7suba" y="Pemusnahan obat dilaksanakan sesuai dengan ketentuan." t="Pemusnahan obat tidak dilaksanakan sesuai dengan ketentuan.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                        <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[35]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                    <tr id="point7subb" y="Perencanaan dan pelaksanaan pemusnahan dilaporkan kepada instansi pemerintah yang berwenang dengan melampirkan Berita Acara Pelaksanaan Pemusnahan." t="Perencanaan dan pelaksanaan pemusnahan tidak dilaporkan kepada instansi pemerintah yang berwenang dengan melampirkan Berita Acara Pelaksanaan Pemusnahan.">
                        <td class="td_no">b.&nbsp;</td><td class="td_aspek">Apakah perencanaan dan pelaksanaan pemusnahan dilaporkan kepada instansi pemerintah yang berwenang dengan melampirkan Berita Acara Pelaksanaan Pemusnahan? </td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                    ...
                    <tr id="point7subc" y="Untuk tiap pemusnahan obat dibuatkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi dari instansi pemerintah yang berwenang." t="Semua atau sebagian pemusnahan obat tidak dibuatkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi dari instansi pemerintah yang berwenang.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
                        <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[37]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                    </tr>
                </table>
                ...
                <table class="form_tabel" group="8. Lain-lain">
                    ...
                    <tr id="point8" y="Dilakukan pelaporan narkotika dan psikotropika setiap bulan ke instansi pemerintah yang berwenang." t="Tidak dilakukan pelaporan narkotika dan psikotropika setiap bulan ke instansi pemerintah yang berwenang.">
                        <td class="td_no">&nbsp;</td><td class="td_aspek">Apakah dilakukan pelaporan narkotika dan psikotropika setiap bulan ke instansi pemerintah yang berwenang? </td>
                        <td class="td_kritis">Tingkat Kekritisan (M)</td>
          ...
          <div id="F03AA_kasus" <?php if($sel_tujuan != "Kasus"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
          ...
          <div class="collapse">
                  ...
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_A]" id="F03AA_kasus_pointa" title="Profil sarana dan organisasi"><?php echo array_key_exists('KASUS_POINT_A', $sess)?$sess['KASUS_POINT_A']:'';?></textarea>
                  <h2 class="small">B. PERSONALIA</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_B]" id="F03AA_kasus_pointb" title="Personalia"><?php echo array_key_exists('KASUS_POINT_B', $sess)?$sess['KASUS_POINT_B']:'';?></textarea>
                  <h2 class="small">C. GUDANG DAN PERLENGKAPAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_C]" id="F03AA_kasus_pointc" title="Gudang dan Perlengkapak"><?php echo array_key_exists('KASUS_POINT_C', $sess)?$sess['KASUS_POINT_C']:'';?></textarea>
                  <h2 class="small">D. PENGADAAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_D]" id="F03AA_kasus_pointd" title="Pengadaan"><?php echo array_key_exists('KASUS_POINT_D', $sess)?$sess['KASUS_POINT_D']:'';?></textarea>
                  <h2 class="small">E. PENYIMPANAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_E]" id="F03AA_kasus_pointe" title="Penyimpanan"><?php echo array_key_exists('KASUS_POINT_E', $sess)?$sess['KASUS_POINT_E']:'';?></textarea>
                  <h2 class="small">F. PENDISTRIBUSIAN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_F]" id="F03AA_kasus_pointf" title="Pendistribusian"><?php echo array_key_exists('KASUS_POINT_F', $sess)?$sess['KASUS_POINT_F']:'';?></textarea>
                  <h2 class="small">G. DOKUMENTASI</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_G]" id="F03AA_kasus_pointg" title="Dokumentasi"><?php echo array_key_exists('KASUS_POINT_G', $sess)?$sess['KASUS_POINT_G']:'';?></textarea>
                  <h2 class="small">H. LAIN-LAIN</h2>
                  <textarea class="stext chk" name="PEMERIKSAAN_DISTRIBUSI[KASUS_POINT_H]" id="F03AA_kasus_pointh" title="Lain - Lain"><?php echo array_key_exists('KASUS_POINT_H', $sess)?$sess['KASUS_POINT_H']:'';?></textarea>
                 </div>
          </div><!-- Akhir Kasus!-->
          </div>
          ...
          <div class="collapse">
                  ...
                  <h2 class="small garis">Hasil Pemeriksaan</h2>
                    <table class="form_tabel">
                        ...
                        <tr id="td_pelanggaran"><td class="td_left">Kesimpulan Detil Pelanggaran</td><td class="right">m&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MINOR]" id="F03AA_jumlahminor" readonly="readonly" value="<?php echo array_key_exists('MINOR', $sess)?$sess['MINOR']:''; ?>" title="Jumlah Minor" />&nbsp;&nbsp;M&nbsp;<input type="text" class="scode" id="F03AA_jumlahmajor" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MAJOR]" readonly="readonly"  value="<?php echo array_key_exists('MAJOR', $sess)?$sess['MAJOR']:''; ?>" title="Jumlah Major" />&nbsp;&nbsp;C&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL]" id="F03AA_jumlahcritical" readonly="readonly" value="<?php echo array_key_exists('CRITICAL', $sess)?$sess['CRITICAL']:''; ?>" title="Jumlah Kritikal" /></td></tr>
                        <tr id="td_hasil"><td class="td_left">Hasil Temuan</td><td class="right"><textarea id="F03AA_catatan" name="PEMERIKSAAN_DISTRIBUSI[HASIL_TEMUAN]" class="stext catatan" title="Hasil Temuan"><?php echo array_key_exists('HASIL_TEMUAN', $sess)?$sess['HASIL_TEMUAN']:'';?></textarea></td></tr>
...
$(document).ready(function(){
	...
	if($sess['PERIKSA_ID'] == ""){
		?>
		var m = 0; var M = 0; var C = 0; var Ca = 0; var temuan = new Array(); $("#F03AA_kasus").css("style:display","none");
		<?php
	}else{
		?>
		...
		if($sess['TUJUAN_PEMERIKSAAN'] == "Kasus"){
			?>
			$("#F03AA_rutin").css("style:display","none");
			$("#F03AA_kasus").show();
			<?php
		}else if($sess['TUJUAN_PEMERIKSAAN'] == "Rutin"){
			?>
			$("#F03AA_rutin").show();
			$("#F03AA_kasus").css("style:display","none");
			<?php
		}
	}
	?>
	$("select.sel_penyimpangan").change(function(){ var val = $(this).val(); var tb = $(this).closest("table").attr("id"); var row = $(this).closest("table tr").attr("id"); var point = $("#"+row+" td:nth-child(1)").text(); var tidak = $(this).closest("table tr").attr("t"); var tingkat = $(this).attr("tingkat"); if(tingkat == "m"){ if(val == "T"){ m++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ m--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ m--; } } if(m < 0) return m = 0; }else if(tingkat == "M"){ if(val == "T"){ M++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ M--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ M--; } } if(M < 0) return M = 0; }else if(tingkat == "C"){ if(val == "T"){ C++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ C--; } }else if(val == "N"){ if(TingkatKritis(temuan, tidak)){ C--; } } if(C < 0) return C = 0; } if(val == "T"){ temuan.push(tidak); }else if(val == "Y" || val == "N"){ ArrExist(temuan, tidak); } $("#F03AA_jumlahminor").val(parseInt(m)); $("#F03AA_jumlahmajor").val(parseInt(M)); $("#F03AA_jumlahcritical").val(parseInt(C)); $("#F03AA_catatan").val(temuan.join("___")); }); 
	$("#F03AA_tujuanperiksa").change(function(){ tujuan_pemeriksaan($(this), "#F03AA_rutin", "#F03AA_kasus", "tr#td_pelanggaran", "tr#td_hasil"); });
});
...
function setHasil(elHasil, tdPelanggaran, tdHasil){
  ...
  if(val == "TMK"){
	  ...
	  ?>
	  $("#F03AA_jumlahminor, #F03AA_jumlahmajor, #F03AA_jumlahcritical, #F03AA_catatan").val(''); 
	  $("#F03AA_rutin select.sel_penyimpangan").get(0).selectedIndex = 0;
	  temuan = Array();
  }
  return false;
}
