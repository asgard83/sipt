        ...
        <div class="collapse">
                ...
                <table class="form_tabel" group="1. Profil Sarana">
                    ...
                    <tr id="point1subb" y="APA/Apoteker pendamping dan PSA sesuai izin." t="APA/Apoteker pendamping dan PSA tidak sesuai izin.">
                        <td class="td_no">b.&nbsp;</td><td class="td_aspek">apakah APA/Apoteker pendamping dan PSA sesuai izin?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[1]; ?></td>
                    </tr>
                    <tr id="point1subc" y="Selama jam buka apotek terdapat tenaga teknis kefarmasian." t="Selama jam buka apotek tidak terdapat tenaga teknis kefarmasian.">
                        <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah selama jam buka apotek terdapat tenaga teknis kefarmasian?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[2]; ?></td>
                    </tr>
                    <tr id="point1subd" y="Memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru." t="Tidak atau kurang memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru.">
                        <td class="td_no">d.&nbsp;</td><td class="td_aspek">Apakah memiliki buku standar dan peraturan perundang-undangan (FI, UU Psikotropika, UU Narkotika, UU Kesehatan, Perundang-undangan di bidang obat/apotek) terbaru?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo $aspek_penilaian[3]; ?></td>
                    </tr>
                </table>
                ...
                <table class="form_tabel" group="3. Pengadaan">
                    ...
                    <tr id="point3suba" y="Pengadaan dari sumber resmi." t="Pengadaan tidak dari sumber resmi.">
                        <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah pengadaan dari sumber resmi?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[13]; ?></td>
                    </tr>
                    <tr id="point3subb" y="Surat pesanan ditandatangani oleh APA, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek." t="Surat pesanan tidak ditandatangani oleh APA, mencantumkan nama jelas dan nomor SIK/SP dan distempel apotek.">
                        ...
                        <td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo $aspek_penilaian[14]; ?></td>
                    </tr>
                    <tr id="point3subc" y="Surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan." t="Surat pesanan tidak diarsipkan berdasarkan nomor urut dan tanggal pemesanan.">
                        <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo $aspek_penilaian[15]; ?></td>
                    </tr>
...
<div id="clear_fix"></div>
    <div><?php if($isverifikasi){ ?><a href="#" class="button check" onclick="fpost('#f03AA_','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a>&nbsp;</div>
