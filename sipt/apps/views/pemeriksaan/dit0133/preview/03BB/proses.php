...
<div class="adCntnr">
    <div class="acco2">
        ...
        <div id="F03BB_rutin" <?php if($sess['TUJUAN_PEMERIKSAAN'] != "Rutin"){ echo 'style="display:none;"'; }?>>
        <div style="height:5px;"></div>
        ...
        <div class="collapse">
                ...
                <h2 class="small">1. Profil Sarana</h2>
                    ...
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                        <tr id="point1suba" y="Selama jam buka balai pengobatan terdapat tenaga teknis kefarmasian." t="Selama jam buka balai pengobatan tidak terdapat tenaga teknis kefarmasian.">
                            <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah selama jam buka balai pengobatan terdapat tenaga teknis kefarmasian?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo $aspek_penilaian[0]; ?></td>
                        </tr>
                    ...
                    <tr><td class="td_no isi">&nbsp;</td><td class="td_aspek isi">ASPEK DAN DETAIL</td><td class="td_kritis isi">TINGKAT KEKRITISAN</td><td class="td_kriteria isi">YA / TIDAK / NA</td></tr>
                        <tr id="point3suba" y="Pengadaan berasal dari sumber resmi." t="Pengadaan tidak dari sumber resmi.">
                            <td class="td_no">a.&nbsp;</td><td class="td_aspek">Apakah pengadaan berasal dari sumber resmi?</td><td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[11]; ?></td>
                        </tr>
                        ...
                        <tr id="point3subc" y="Surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan." t="Surat pesanan tidak diarsipkan berdasarkan nomor urut dan tanggal pemesanan.">
                            <td class="td_no">c.&nbsp;</td><td class="td_aspek">Apakah surat pesanan diarsipkan berdasarkan nomor urut dan tanggal pemesanan?</td><td class="td_kritis">Tingkat Kekritisan (M)</td><td class="td_kritis"><?php echo $aspek_penilaian[13]; ?></td>
                        </tr>
          ...
          <div id="F03BB_kasus"  <?php if($sess['TUJUAN_PEMERIKSAAN'] != "Kasus"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
...
<div><?php if($isverifikasi){ ?><a href="#" class="button check" onclick="fpost('#f03BB','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a></div>
