...
<div class="adCntnr">
    <div class="acco2">
          ...
          <div id="F02TR_rutin" <?php if($sess['TUJUAN_PEMERIKSAAN'] != "Rutin"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
                  ...
                  <h2 class="small">1. Profil Sarana</h2>
                      <table class="form_tabel" group="1. Profil Sarana">
                          ...
                          <tr id="point1suba" y="Nama dan alamat rumah sakit sesuai Surat Izin dan masih berlaku." t="Nama dan alamat rumah sakit tidak sesuai Surat Izin dan atau sudah tidak berlaku.">
                              ...
                              <td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[0]; ?></td>
                          </tr>
                          <tr id="point1subb" y="Kepala Instalasi/Apoteker telah mempunyai SP/SIK" t="Kepala Instalasi/Apoteker tidak mempunyai SP/SIK">
                              ...
                              <td class="td_kritis">Tingkat Kekritisan (C)</td><td class="td_kritis"><?php echo $aspek_penilaian[1]; ?></td>
                          </tr>
          ...
          <div id="F02TR_kasus"  <?php if($sess['TUJUAN_PEMERIKSAAN'] != "Kasus"){ echo 'style="display:none;"'; }?>>
          <div style="height:5px;"></div>
...
<div id="clear_fix"></div>
    <div><?php if($isverifikasi){ ?><a href="#" class="button check" onclick="fpost('#f02TR_','',''); return false;"><span><span class="icon"></span>&nbsp; Proses &nbsp;</span></a>&nbsp;<?php } ?><a href="#" class="button back" onclick="kembali(); return false;"><span><span class="icon"></span>&nbsp; Kembali &nbsp;</span></a></div>
