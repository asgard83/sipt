        ...
        <div class="collapse">
                ...
                <h2 class="small garis">INFORMASI SARANA</h2>
                  ...
                  <table class="form_tabel">
                    ...
                    <tr><td class="td_left">Tujuan Pemeriksaan</td><td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_DISTRIBUSI[TUJUAN_PEMERIKSAAN]', $tujuan_periksa, array_key_exists('TUJUAN_PEMERIKSAAN', $sess)?$sess['TUJUAN_PEMERIKSAAN']:'', 'id="F02LL_tujuanperiksa" class="stext" rel="required" title="Pilih salah satu tujuan pemeriksaan"'); ?></td></tr>
              ...
              <div class="collapse">
                      ...
                      <table class="form_tabel" group="14. Pedagang Besar Bahan Baku Farmasi">
                          ...
                          <tr id="point14seri1a" y="Mempunyai ijin khusus repacking (untuk PBBBF yang melakukan repacking)" t="Melalukan repacking tetapi tidak mempunyai ijin khusus repacking.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[60]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri1b" y="Mempunyai protap repacking." t="Tidak mempunyai protap repacking">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[61]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri1c" y="Mempunyai protap sampling." t="Tidak mempunyai protap pengujian.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[62]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri1d" y="Mempunyai protap pengujian." t="Tidak mempunyai protap pengujian.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[63]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri1e" y="Mempunyai protap sanitasi ruangan." t="Tidak mempunyai protap sanitasi ruangan.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[64]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                      ...
                      <table class="form_tabel" group="Personalia">
                          ...
                          <tr id="point14seri2a" y="Penanggung jawab seorang Apoteker yang bekerja full time." t="Penanggung jawab seorang Apoteker yang bekerja paruh waktu.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (Ca)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[67]:'', 'tingkat="Ca" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri2b" y="Operator mendapat pelatihan khusus tentang teknik repacking tiap langkah proses, termasuk cara menggunakan pakaian kerja untuk melakukan kegiatan di ruang repacking (khusus PBBBF yang melakukan repacking?)" t="Operator belum mendapat pelatihan khusus tentang teknik repacking tiap langkah proses, termasuk cara menggunakan pakaian kerja untuk melakukan kegiatan di ruang repacking (khusus PBBBF yang melakukan repacking)">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[68]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                      </table>
                      ...
                      <table class="form_tabel" group="Program Hygiene Petugas Repacking Bahan Baku Farmasi (Khusus PBBBF yang Melakukan Packing">
                          ...
                          <tr id="point14seri3a" y="Tersedia pakaian kerja yang sesuai area repacking." t="Tidak tersedia pakaian kerja yang sesuai area repacking.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[69]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri3b" y="Seluruh personalia yang masuk ke dalam area repacking memakai baju yang sesuai area repacking." t="Personalia yang masuk ke dalam area repacking tidak memakai baju yang sesuai area repacking.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[70]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri3c" y="Seluruh personalia yang masuk ke dalam area repacking memakai masker dan penutup rambut." t="Personalia yang masuk ke dalam area repacking tidak memakai masker dan penutup rambut.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[71]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri3d" y="Seluruh personalia yang masuk ke dalam area repacking memakai sepatu yang telah ditentukan atau sarung sepatu." t="Personalia yang masuk ke dalam area repacking tidak memakai sepatu yang telah ditentukan atau sarung sepatu.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[72]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              ...
                              <tr id="point14seri3f" y="Dilakukan pemeriksaan kesehatan secara berkala." t="Tidak dilakukan pemeriksaan kesehatan secara berkala.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[74]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                      </table>
                      ...
                      <table class="form_tabel" group="Bangunan dan Peralatan">
                          ...
                          <tr id="point14seri4a" y="Tingkat kebersihan ruang sampling sesuai dengan ketentuan." t="Tingkat kebersihan ruang sampling tidak sesuai dengan ketentuan.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[75]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri4b" y="Tingkat kebersihan ruang repacking sesuai dengan ketentuan." t="Tingkat kebersihan ruang repacking tidak sesuai dengan ketentuan.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[76]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri4c" y="Ruang repacking untuk bahan baku obat golongan antibiotika betalaktam sesuai dengan ketentuan untuk mencegah kontaminasi/kontaminasi silang." t="Ruang repacking untuk bahan baku obat golongan antibiotika betalaktam tidak sesuai dengan ketentuan sehingga tidak mencegah kontaminasi/kontaminasi silang.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[77]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri4d" y="Mempunyai laboratorium." t="Tidak mempunyai laboratorium.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[78]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri4e" y="Ruang laboratorium sesuai dengan ketentuan." t="Ruang laboratorium tidak sesuai dengan ketentuan.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[79]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri4f" y="Laboratorium dilengkapi dengan peralatan yang sesuai dengan ketentuan." t="Laboratorium tidak dilengkapi dengan peralatan yang sesuai dengan ketentuan.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[80]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri4g" y="Wadah disimpan dalam keadaan bersih dan kering." t="Wadah tidak disimpan dalam keadaan bersih dan kering.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[81]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                      </table>
                      ...
                      <table class="form_tabel" group="Pengadaan, Penyimpanan dan Penyaluran">
                          ...
                          <tr id="point14seri5a" y="Dalam melakukan importasi, bahan obat dilengkapi dengan CoA dari Produsen dan Surat Keterangan Impor (SKI)" t="Dalam melakukan importasi, bahan obat tidak dilengkapi dengan CoA dari Produsen dan Surat Keterangan Impor (SKI)">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[82]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri5b" y="Mempunyai sistem karantina untuk bahan baku farmasi." t="Tidak mempunyai sistem karantina untuk bahan baku farmasi.">
                                  ...
                                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[83]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                  </tr>
                              <tr id="point14seri5c" y="Tempat karantina terpisah dengan tempat penyimpanan lainnya." t="Tempat karantina tidak terpisah dengan tempat penyimpanan lainnya.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[84]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5d" y="Dilaksanakan sampling terhadap bahan baku." t="Tidak dilaksanakan sampling terhadap bahan baku.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[85]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5e" y="Mempunyai referensi untuk pengujian." t="Tidak mempunyai referensi untuk pengujian.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[86]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5f" y="Mempunyai metoda analisa untuk setiap bahan baku." t="Tidak mempunyai metoda analisa untuk setiap bahan baku.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[87]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5g" y="Dilaksanakan pemeriksaan laboratorium terhadap bahan baku." t="Tidak dilaksanakan pemeriksaan laboratorium terhadap bahan baku.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (C)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[88]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5h" y="Terhadap bahan baku yang lulus pemeriksaan diberikan label khusus." t="Terhadap bahan baku yang lulus pemeriksaan tidak diberikan label khusus.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[89]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5i" y="Terhadap bahan baku yang tidak lulus pemeriksaan diberikan label khusus." t="Terhadap bahan baku yang tidak lulus pemeriksaan tidak diberikan label khusus.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[90]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5j" y="Terdapat tempat reject yang terpisah dan terkunci." t="Tidak terdapat tempat reject yang terpisah dan terkunci.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[91]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                              <tr id="point14seri5k" y="Bahan baku yang disalurkan dilengkapi dengan CoA dari PBBBF." t="Bahan baku yang disalurkan tidak dilengkapi dengan CoA dari PBBBF.">
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[92]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                                ...
                                <td class="td_kritis">Tingkat Kekritisan (M)</td>
                                <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[93]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                                </tr>
                      </table>
        ...
        <div class="collapse">
                ...
                <h2 class="small garis">Hasil Pemeriksaan</h2>
                  <table class="form_tabel">
                      ...
                      <tr id="td_pelanggaran"><td class="td_left">Kesimpulan Detil Pelanggaran</td><td class="right">m&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MINOR]" id="F02LL_jumlahminor" readonly="readonly" value="<?php echo array_key_exists('MINOR', $sess)?$sess['MINOR']:''; ?>" title="Jumlah Minor" />&nbsp;&nbsp;M&nbsp;<input type="text" class="scode" id="F02LL_jumlahmajor" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MAJOR]" readonly="readonly"  value="<?php echo array_key_exists('MAJOR', $sess)?$sess['MAJOR']:''; ?>" title="Jumlah Major" />&nbsp;&nbsp;C&nbsp;<input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL]" id="F02LL_jumlahcritical" readonly="readonly" value="<?php echo array_key_exists('CRITICAL', $sess)?$sess['CRITICAL']:''; ?>" title="Jumlah Critical" />&nbsp;&nbsp;Ca&nbsp;<input type="text" class="scode" id="F02LL_jumlahca" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL_ABSOLUTE]" readonly="readonly" value="<?php echo array_key_exists('CRITICAL_ABSOLUT', $sess)?$sess['CRITICAL_ABSOLUT']:''; ?>" title="Jumlah Critical Absolute" /></td></tr>
                      <tr id="td_hasil"><td class="td_left">Hasil Temuan</td><td class="right"><textarea id="F02LL_catatan" name="PEMERIKSAAN_DISTRIBUSI[HASIL_TEMUAN]" class="stext catatan" title="Hasil temuan"><?php echo array_key_exists('HASIL_TEMUAN', $sess)?$sess['HASIL_TEMUAN']:'';?></textarea></td></tr>
...
$(document).ready(function(){
	...
	$("select.sel_penyimpangan").change(function(){
		var val = $(this).val(); var tb = $(this).closest("table").attr("id"); var group_table = $(this).closest("table").attr("group"); var row = $(this).closest("table tr").attr("id"); var point = $("#"+row+" td:nth-child(1)").text(); var tidak = $(this).closest("table tr").attr("t"); var tingkat = $(this).attr("tingkat"); if(tingkat == "m"){ if(val == "T"){ m++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ m--;} }else if(val == "N"){if(TingkatKritis(temuan, tidak)){ m--;} }  if(m <0 ) return m = 0;}else if(tingkat == "M"){ if(val == "T"){ M++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ M--; }}else if(val == "N"){if(TingkatKritis(temuan, tidak)){ M--;}} if(M < 0) return M = 0; }else if(tingkat == "C"){ if(val == "T"){ C++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){C--; }}else if(val == "N"){if(TingkatKritis(temuan, tidak)){C--;}} if(C < 0) return C = 0;}else if(tingkat == "Ca"){ if(val == "T"){ Ca++; }else if(val == "Y"){ if(TingkatKritis(temuan, tidak)){ Ca--; } }else if(val == "N"){if(TingkatKritis(temuan, tidak)){Ca--;}} if(Ca < 0) return Ca = 0; } if(val == "T"){temuan.push(tidak); }else if(val == "Y" || val == "N"){ArrExist(temuan, tidak);} $("#F02LL_jumlahminor").val(parseInt(m)); $("#F02LL_jumlahmajor").val(parseInt(M)); $("#F02LL_jumlahcritical").val(parseInt(C)); $("#F02LL_jumlahca").val(parseInt(Ca)); $("#F02LL_catatan").val(temuan.join("___"));
	});	
