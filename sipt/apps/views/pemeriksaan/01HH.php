    ...
    <div class="acco2">
        ...
        <div class="collapse">
                ...
                <table class="form_tabel">
                  ...
                  <tr><td class="td_left">Tujuan Pemeriksaan</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_CPOTB[TUJUAN_PEMERIKSAAN]', $tujuan_pemeriksaan, $sess['TUJUAN_PEMERIKSAAN'], 'class="stext" title="Pilih salah satu tujuan pemeriksaan" onchange="sel_tujuan($(this));"'); ?></td></tr>
                <tr>
                <td class="td_left">Standard yang Digunakan</td><td class="td_right"><textarea name="PEMERIKSAAN_CPOTB[STANDARD]" class="stext chk" title="Pedoman Standard CPOTB"><?php echo array_key_exists('STANDARD', $sess)?$sess['STANDARD']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Kepatuhan CPOTB dan Keputusan</td><td class="td_right"><textarea class="stext chk" id="F01OO_keputusan" name="PEMERIKSAAN_CPOTB[KEPATUHAN_CPOTB]" title="Kepatuhan CPOTB dan Keputusan"><?php echo array_key_exists('KEPATUHAN_CPOTB', $sess)?$sess['KEPATUHAN_CPOTB']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Latar Belakang Hasil Pemeriksaan yang Lalu</td><td class="td_right"><textarea class="stext chk" id="F01OO_latarbelakang" name="PEMERIKSAAN_CPOTB[LATAR_BELAKANG]" title="Latar belakang hasil pemeriksaan yang lalu"><?php echo array_key_exists('LATAR_BELAKANG', $sess)?$sess['LATAR_BELAKANG']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Perubahan Bermakna sejak inspeksi terakhir</td><td class="td_right"><textarea class="stext chk" id="F01OO_perubahanmajor2" name="PEMERIKSAAN_CPOTB[PERUBAHAN_BERMAKNA]" title="Perubahan bermaknsa sejak inspeksi terkahir"><?php echo array_key_exists('PERUBAHAN_BERMAKNA', $sess)?$sess['PERUBAHAN_BERMAKNA']:""; ?></textarea></td></tr>
                  <tr><td colspan="2"><h2 class="small">Penjelasan Singkat Dari Kegiatan Inspeksi yang Dilakukan</h2></td></tr>
                  <tr><td class="td_left">Ruang Lingkup</td><td class="td_right"><textarea class="stext chk" id="F01OO_ruanglingkup" name="PEMERIKSAAN_CPOTB[RUANG_LINGKUP]" title="Ruang lingkup"><?php echo array_key_exists('RUANG_LINGKUP', $sess)?$sess['RUANG_LINGKUP']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Area Inspeksi</td><td class="td_right"><textarea class="stext chk" id="F01OO_areainspeksi" name="PEMERIKSAAN_CPOTB[AREA_INSPEKSI]" title="Area Inspeksi"><?php echo array_key_exists('AREA_INSPEKSI', $sess)?$sess['AREA_INSPEKSI']:""; ?></textarea></td></tr>
                </table>
				</div>
            ...
            <div class="accCntnt">
              ...
              <table class="listtemuan" id="tb_temuan" width="100%">
                  ...
                  <?php
                      ...
                      do{
                      ?>
                      <tr class="urut<?php echo $i; ?>"><td width="545px;"><div style="padding-bottom:5px;"><?php echo form_dropdown('TEMUAN[TEMUAN_OBSERVASI][]',$temuan_observasi,$temuan_cpotb[$i]['TEMUAN_OBSERVASI'],'class="stext"'); ?></div><div><textarea class="stext chk" id="TEMUAN_OB<?php echo $i; ?>" name="TEMUAN[TEMUAN_TEKS][]"><?php echo $temuan_cpotb[$i]['TEMUAN_TEKS']; ?></textarea></div></td><td><div style="padding-bottom:5px;"><?php echo form_dropdown('TEMUAN[TEMUAN_KRITERIA][]', $cb_observasi, $temuan_cpotb[$i]['TEMUAN_KRITERIA'], 'class="sel_penyimpangan" title="Pilih salah satu pilihan : Kritikal, Major, Minor, Observasi" hasil="" onchange="CountKriteria($(this).val());"'); ?>&nbsp;&nbsp;
                      <?php
                      if($i==0){
                      ?>
                ...
                <div style="height:5px;"></div>
                <table class="form_tabel">
                  <tr><td class="td_left">Distribusi dan Pengangkutan</td><td class="td_right"><textarea class="stext chk" id="F01OO_distribusiangkut" name="PEMERIKSAAN_CPOTB[DISTRIBUSI_PENGANGKUTAN]" title="Distribusi dan pengangkutan"><?php echo array_key_exists('DISTRIBUSI_PENGANGKUTAN', $sess)?$sess['DISTRIBUSI_PENGANGKUTAN']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Pertanyaan Berkaitan dengan Penilaian Permohonan Pendaftaran Produk</td><td class="td_right"><textarea class="stext chk" id="F01OO_personel" name="PEMERIKSAAN_CPOTB[PERMOHONAN_PENDAFTARAN_PRODUK]" title="Pertanyaan berkaitan dengan penilaian permohonan pendaftaran produk"><?php echo array_key_exists('PERMOHONAN_PENDAFTARAN_PRODUK', $sess)?$sess['PERMOHONAN_PENDAFTARAN_PRODUK']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Isu Spesifik Lainnya</td><td class="td_right"><textarea class="stext chk" id="F01OO_isu" name="PEMERIKSAAN_CPOTB[ISU_SPESIFIK_LAINNYA]" title="Isu spesifik lainnya"><?php echo array_key_exists('ISU_SPESIFIK_LAINNYA', $sess)?$sess['ISU_SPESIFIK_LAINNYA']:""; ?></textarea></td></tr>
                  <tr>
                    <td class="td_left">Site Master File</td><td class="td_right"><textarea class="stext chk" id="F01OO_sitefile" name="PEMERIKSAAN_CPOTB[SITE_FILE_MASTER]" title="Site master file"><?php echo array_key_exists('SITE_FILE_MASTER', $sess)?$sess['SITE_FILE_MASTER']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Lain-Lain</td><td class="td_right"><textarea class="stext chk" id="F01OO_lainlain" name="PEMERIKSAAN_CPOTB[LAIN_LAIN]" title="Lain-lain"><?php echo array_key_exists('LAIN_LAIN', $sess)?$sess['LAIN_LAIN']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Sampel yang Diambil</td><td class="td_right"><textarea class="stext chk" id="F01OO_sampel" name="PEMERIKSAAN_CPOTB[SAMPEL_DIAMBIL]" title="Sampel yang diambil"><?php echo array_key_exists('SAMPEL_DIAMBIL', $sess)?$sess['SAMPEL_DIAMBIL']:""; ?></textarea></td></tr>
                  <tr><td class="td_left">Distribusi Laporan</td><td class="td_right"><textarea class="stext chk" id="F01OO_distribusilaporan" name="PEMERIKSAAN_CPOTB[DISTRIBUSI_LAPORAN]" title="Distribusi laporan"><?php echo array_key_exists('DISTRIBUSI_LAPORAN', $sess)?$sess['DISTRIBUSI_LAPORAN']:""; ?></textarea></td></tr>
                ...
                <table class="form_tabel">
                  <tr><td class="td_left">Tindakan</td><td class="td_right"><?php echo form_dropdown('PEMERIKSAAN_CPOTB[TINDAKAN_OBSERVASI][]', $tindakan_observasi, is_array($sel_tindakan_observasi)?$sel_tindakan_observasi:'', 'class="stext multiselect" title="Pilih salah satu, atau untuk lebih dari satu Klik + tekan Ctrl" multiple'); ?></td></tr>
                </table>
        ...
        <div class="collapse">
              ...
              <table class="form_tabel">
                  <tr><td class="td_left">1. Temuan Kritikal</td><td class="td_right"><input type="text" class="scode" id="jumlah_kritikal" readonly="readonly" name="PEMERIKSAAN_CPOTB[TEMUAN_KRITIKAL]" title="Jumlah temuan kritikal" value="<?php echo array_key_exists('TEMUAN_KRITIKAL', $sess)?$sess['TEMUAN_KRITIKAL']:""; ?>" /></td></tr>
                  <tr><td class="td_left">2. Temuan Major</td><td class="td_right"><input type="text" class="scode" id="jumlah_major" readonly="readonly" name="PEMERIKSAAN_CPOTB[TEMUAN_MAJOR]" title="Jumlah temuan major" value="<?php echo array_key_exists('TEMUAN_MAJOR', $sess)?$sess['TEMUAN_MAJOR']:""; ?>" /></td></tr>
                  <tr><td class="td_left">3. Temuan Minor</td><td class="td_right"><input type="text" class="scode" id="jumlah_minor" readonly="readonly" name="PEMERIKSAAN_CPOTB[TEMUAN_MINOR]" title="Jumlah temuan minor" value="<?php echo array_key_exists('TEMUAN_MINOR', $sess)?$sess['TEMUAN_MINOR']:""; ?>" /></td></tr></table>
				</div>
        </div><!-- Akhir Informasi Sarana !-->
        ...
        <div class="collapse">
                ...
                <tr id="row_catatan" <?php if($sel_hasil == "MK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left">Catatan<td class="td_right"><textarea class="stext chk" title="Catatan" name="PEMERIKSAAN_CPOTB[REKOMENDASI]"><?php echo $sess['REKOMENDASI']; ?></textarea></td></tr>
                ...
                <tr id="row_dttmk" <?php if($sel_hasil == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>><td class="td_left" id="F02OT_tdlabeldetiltmk">Detil Kesimpulan TMK</td><td class="td_right" id="F02OT_tddetiltmk"><textarea name="PEMERIKSAAN_CPOTB[KESIMPULAN_DETIL_TMK]" id="KESIMPULAN_DETIL_TMK" class="stext chk" title="Detil Kesimpulan TMK"><?php echo $sess['KESIMPULAN_DETIL_TMK']; ?></textarea></td></tr>
                </table>
				...
				if($this->newsession->userdata('SESS_BBPOM_ID') == '94'){
                    ...
                    <h2 class="small garis">Tindak Lanjut</h2>
                      ...
                      <tr><td class="td_left">Time Line</td><td class="td_right"><textarea class="stext chk" id="timeline" name="PEMERIKSAAN_CPOTB[TIME_LINE]" title="Timeline tindak lanjut hasil inspeksi"><?php echo $sess['TIME_LINE']; ?></textarea></td></tr>
                      </table>
...
<div><a href="#" class="button save" onclick="fpost('#f01HH_','#div_izin',''); return false;"><span><span class="icon"></span>&nbsp; Simpan &nbsp;</span></a>&nbsp;<a href="#" class="button back" url="<?php echo $urlback; ?>" onclick="batal($(this)); return false;"><span><span class="icon"></span>&nbsp; Batal &nbsp;</span></a></div>
<div id="clear_fix"></div>
...
$(document).ready(function(){
	...
	$("#F01HH_temuan_kategori").change(function(){if($(this).val() == "TMK Penandaan"){$("#td_temuan").show();$(".tmk_penandaan").show();$(".farmasetik").hide();}else if($(this).val() == "Farmasetik"){$("#td_temuan").show();$(".tmk_penandaan").hide();$(".farmasetik").show();}else{$("#td_temuan").hide();$(".tmk_penandaan").hide();$(".farmasetik").hide();}});	  
	...
	$(".del_lampiran").live("click", function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$(".file_"+jenis+"").html('<input type=\"hidden\" name=\"PEMERIKSAAN_CPOTB[LAMPIRAN]\" value="">');
			}
		});
		return false;
	});
			...
			if(typeof(data.error) != "undefined"){
				if(data.error != ""){
					...
					if(jenis == "LAMPIRAN"){
						...
						$(".file_"+arrdata[2]+"").html("<b>1 File telah dilampirkan. </b>&nbsp;<a href=\"<?php echo base_url(); ?>files/"+arrdata[3]+"/"+arrdata[0]+"\" target=\"_blank\">Tampilkan File</a>&nbsp;&bull;&nbsp;<a href=\"#\" class=\"del_lampiran\" url=\"<?php echo site_url(); ?>/utility/uploads/del_upload/"+arrdata[3]+"/"+arrdata[0]+"\" jns="+arrdata[2]+">Edit atau Hapus File ?</a><input type=\"hidden\" name=\"PEMERIKSAAN_CPOTB[LAMPIRAN]\" value="+arrdata[0]+">");
					}
				}
			}
		},
