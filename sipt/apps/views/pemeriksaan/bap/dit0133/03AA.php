...
<table style="width:100%">
	...
	<tr><td><?php echo $sess['NAMA_PSA']; ?></td><td>&nbsp;</td></tr>
</table>
...
<table width="100%">
	<tr><td width="200">Nama Apotek</td><td width="20">:</td><td><?php echo $sess['NAMA_SARANA']; ?></td></tr>
	<tr><td width="200">Alamat</td><td width="20">:</td><td><?php echo $sess['ALAMAT_1']; ?></td></tr>
	...
	<tr><td width="200">Apoteker Pengelola Apotek</td><td width="20">:</td><td><?php echo $sess['NAMA_APA']; ?></td></tr>
	<tr><td width="200">No. SIK</td><td width="20">:</td><td><?php echo $sess['NO_SIK']; ?></td></tr>
	<tr><td width="200">Pemilik Sarana Apotek</td><td width="20">:</td><td><?php echo $sess['NAMA_PSA']; ?></td></tr>
	<tr><td width="200">Apoteker Pendamping</td><td width="20">:</td><td><?php echo $sess['NAMA_APOTEKER_PENDAMPING']; ?></td></tr>
	<tr><td width="200">Nomor Izin</td><td width="20">:</td><td><?php echo $sess['NOMOR_IZIN']; ?></td></tr>
</table>
<div style="height:5px;"></div>
...
<tr><td>Detail Tindak Lanjut</td><td width="20">:</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DETAIL_TINDAK_LANJUT_PUSAT'])); ?></td></tr>
</table>
<?php } ?>
