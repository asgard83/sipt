...
<tr><td width="200" <?php if($sess['HASIL'] == "TMK"){echo 'style=""'; }else{ echo 'style="display:none;"'; }?>>Detil Kesimpulan TMK</td><td>:</td><td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['KESIMPULAN_DETIL_TMK'])); ?></td></tr>
<?php }else if($ses["HASIL"] == "MK") { ?>
<tr><td width="200">Catatan</td><td>:</td><td><?php echo $sess["CATATAN"]; ?></td></tr>
<?php }else { ?>
<tr><td width="200">Catatan</td><td>:</td><td><?php echo $sess["CATATAN"]; ?></td></tr>
<?php } ?>
...
<table width="100%">
	<tr><td width="200">Tindak Lanjut</td><td width="20">:</td><td><?php if(trim($sess["TINDAKAN_SARANA"]) != ""){ ?><ul style="list-style-type:decimal; padding-left:15px; margin:0;"><?php $tl_balai = explode("#", $sess['TINDAKAN_SARANA']); echo "<li>".join("</li><li>", $tl_balai)."</li>"; ?></ul><?php } ?></td></tr>
    <tr><td width="200">Saran Tindak Lanjut</td><td>:</td><td><?php echo $sess['SARAN_TL']; ?></td></tr>
</table>
...
<p>Checklist Aspek Penilaian</p>
                ...
                <table class="form_tabel">
                   ...
                   <tr id="F02KO_point21i">
                      <td></td>
                      <td class="atas">i.</td>
                      <td class="atas">Surat Keterangan GMP Produsen luar negeri
Certificate of Free Sale (CFS) </td>
                ...
                <table class="form_tabel">
                    ...
                    <tr id="F02KO_point22a">
                      ...
                      <td class="atas" width="75"><?php echo $aspek_check[9]; ?></td>
                ...
                <table class="form_tabel">
                    <tr id="F02KO_gudang_detail1">
                      ...
                      <td class="atas" width="75"><?php echo $aspek_check[21]; ?></td>
                ...
                <div class="detail_display"<?php if(is_array($aspek_check)){ if($aspek_check[29] == "Ya"){ echo 'style=""'; }else{ echo 'style="display:none;"';} }else{ echo 'style=""';}?>>
                <table class="form_tabel">
                    <tr id="F02KO_display_produk_detail1">
                      <td width="10"></td>
                      <td width="20">&nbsp;</td>
                      <td width="385">- Lemari / tempat tertutup</td>
                      <td class="atas" width="75"><?php echo $aspek_check[30]; ?></td>
                ...
                <div class="detail_syarat" <?php if(is_array($aspek_check)){ if($aspek_check[31] == "Ya"){ echo 'style=""'; }else{ echo 'style="display:none;"';} }else{ echo 'style=""';}?>>
                <table class="form_tabel">
                    <tr id="F02KO_display_produk1_detail1">
                      <td width="10"></td>
                      <td width="20">&nbsp;</td>
                      <td width="385">1. Kebersihan</td>
                      <td class="atas" width="75"><?php echo $aspek_check[32]; ?></td>
...
<p>Dokumen Informasi Produk</p>
<table width="100%">
    <tr><td><b>Bagian I : Dokumen Administrasi & Ringkasan Produk</b></td></tr>
    <tr><td><?php echo $sess['HASIL_DIP_A']; ?></td></tr>
    <tr><td><b>Bagian II : Data Mutu Keamanan dan Bahan Kosmetik</b></td></tr>
    <tr><td><?php echo $sess['HASIL_DIP_B']; ?></td></tr>
    <tr><td><b>Bagian III : Data Mutu Kosmetik</b></td></tr>
    <tr><td><?php echo $sess['HASIL_DIP_C']; ?></td></tr>
    <tr><td><b>Bagian IV : Data Keamanan dan Kemanfaatan Kosmetik</b></td></tr>
    <tr><td><?php echo $sess['HASIL_DIP_D']; ?></td></tr>
</table>
<pagebreak />
