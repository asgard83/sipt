...
<table width="100%">
  ...
  <tr>
    <td width="200">Apoteker Pengelola Apotek</td>
    <td width="20">:</td>
    <td><?php echo $sess['NAMA_APA']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="200">Pemilik Sarana Apotek</td>
    <td width="20">:</td>
    <td><?php echo $sess['NAMA_PSA']; ?></td>
  </tr>
  <tr>
    <td width="200">Apoteker Pendamping</td>
    <td width="20">:</td>
    <td><?php echo $sess['NAMA_APOTEKER_PENDAMPING']; ?></td>
  </tr>
  <tr>
    <td width="200">Nomor Izin</td>
    <td width="20">:</td>
...
<table width="100%">
  ...
  <tr>
    <td>Detail Tindak Lanjut</td>
    <td width="20">:</td>
    <td><?php echo preg_replace('/[^(\x20-\x7F)]*/','',html_entity_decode($sess['DETAIL_TINDAK_LANJUT_PUSAT'])); ?></td>
  </tr>
</table>
<?php } ?>
<?php
