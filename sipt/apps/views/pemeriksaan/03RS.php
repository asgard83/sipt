          ...
          <div class="accCntnt">
            ...
            <table class="form_tabel">
              ...
              <tr>
                ...
                <td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_DISTRIBUSI[TUJUAN_PEMERIKSAAN]', $tujuan_periksa, array_key_exists('TUJUAN_PEMERIKSAAN', $sess)?$sess['TUJUAN_PEMERIKSAAN']:'', 'id="F03RS_tujuanperiksa" class="stext" rel="required" title="Pilih salah satu tujuan pemeriksaan"'); ?></td>
            </table>
          </div>
        </div>
        <!-- Akhir Pemeriksaan !-->
          ...
          <div class="collapse">
            <div class="accCntnt">
              ...
              <table class="form_tabel" group="1. Bangunan dan Peralatan">
                ...
                <tr id="point2suba" y="Tersedia palet atau peralatan lain yang menjamin bahan obat tidak bersentuhan langsung dengan lantai." t="Tidak tersedia palet atau peralatan lain yang menjamin bahan obat tidak bersentuhan langsung dengan lantai.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah tersedia palet atau peralatan lain yang menjamin bahan obat tidak bersentuhan langsung dengan lantai?</td>
              ...
              <table class="form_tabel" group="2. Penandaan">
                <tr>
                  <td class="td_no isi">&nbsp;</td>
                  <td class="td_aspek isi">ASPEK DAN DETAIL</td>
                  <td class="td_kritis isi">TINGKAT KEKRITISAN</td>
                ...
                <tr id="point3suba" y="Selain dari Gudang Farmasi Kabupaten/Kota pengadaan berasal dari sumber resmi." t="Selain dari Gudang Farmasi Kabupaten/Kota pengadaan berasal dari sumber tidak resmi.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah selain dari Gudang Farmasi Kabupaten/Kota pengadaan berasal dari sumber resmi?</td>
                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[1]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
                <tr id="point2subb" y="Surat pesanan/LPLPO ditandatangani oleh Penanggungjawab, tidak mencantumkan nama jelas dan nomor SIKA/SIKTTK atau SIK tenaga kesehatan lain dan tidak distempel puskesmas" t="Surat pesanan/LPLPO tidak ditandatangani oleh Penanggungjawab, tidak mencantumkan nama jelas dan nomor SIKA/SIKTTK atau SIK tenaga kesehatan lain dan tidak distempel puskesmas">
                  <td class="td_no">b.&nbsp;</td>
                  <td class="td_aspek">Apakah surat pesanan/LPLPO ditandatangani oleh Penanggungjawab, mencantumkan nama jelas dan nomor SIPA/SIKTTK atau SIK tenaga kesehatan lain dan distempel puskesmas?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                ...
                <tr id="point3subc" y="Salinan surat pesanan/LPLPO diarsipkan dan tidak mampu telusur" t="Salinan surat pesanan/LPLPO tidak diarsipkan dan tidak mampu telusur">
                  <td class="td_no">c.&nbsp;</td>
                  <td class="td_aspek">Apakah salinan surat pesanan/LPLPO diarsipkan dan mampu telusur?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
              ...
              <table class="form_tabel" group="3. Penerimaan dan Penyimpanan">
                ...
                <tr id="point4suba" y="Semua atau sebagian LPLPO/faktur pengadaan obat ditandatangani oleh tenaga kefarmasian atau tenaga kesehatan yang ditunjuk pada saat diterima." t="Semua atau sebagian LPLPO/faktur pengadaan obat tidak ditandatangani oleh tenaga kefarmasian atau tenaga kesehatan yang ditunjuk pada saat diterima.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah LPLPO/faktur pengadaan obat ditandatangani oleh tenaga kefarmasian atau tenaga kesehatan yang ditunjuk pada saat diterima?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                ...
                <tr id="point4subb" y="Setiap penerimaan obat dilakukan pemeriksaan kesesuaian antara fisik dan dokumen (meliputi:  item, jumlah, nomor bets, tanggal kadaluarsa) serta tidak dilakukan pemeriksaan kebenaran/kondisi kemasan." t="Setiap penerimaan obat  tidak dilakukan pemeriksaan kesesuaian antara fisik dan dokumen (meliputi:  item, jumlah, nomor bets, tanggal kadaluarsa) serta tidak dilakukan pemeriksaan kebenaran/kondisi kemasan.">
                  <td class="td_no">b.&nbsp;</td>
                ...
                <tr id="point4subd" t="Pengeluaran obat tidak berdasarkan sistem first in first out / first exp first out." y="Pengeluaran obat berdasarkan sistem first in first out / first exp first out.">
                  <td class="td_no">d.&nbsp;</td>
                ...
                <tr id="point4sube" y="Obat dan bahan obat disimpan sesuai dengan persyaratan yang tercantum dalam penandaan." t="Obat dan bahan obat tidak disimpan sesuai dengan persyaratan yang tercantum dalam penandaan.">
                  <td class="td_no">e.&nbsp;</td>
                ...
                <tr id="point4subg" y="Tempat penyimpanan Vaksin/CCP dilengkapi termometer dan dilakukan pencatatan monitoring suhu minimal dua kali sehari" t="Tempat penyimpanan Vaksin/CCP tidak dilengkapi termometer dan dilakukan pencatatan monitoring suhu minimal dua kali sehari">
                  ...
                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[11]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
                <tr id="point4subh" y="Penyimpanan vaksin dilengkapi dengan generator otomatis yang berfungsi dengan baik atau tidak mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam." t="Penyimpanan vaksin tidak dilengkapi dengan generator otomatis yang berfungsi dengan baik atau tidak mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam.">
                  ...
                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[12]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
              ...
              <table class="form_tabel" group="4. Penyaluran">
                ...
                <tr id="point5suba" y="Semua atau sebagian penerahan obat berdasarkan resep dari dalam puskesmas tersebut." t="Semua atau sebagian penerahan obat tidak berdasarkan resep dari dalam puskesmas tersebut.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah setiap penyaluran obat berdasarkan resep dari dalam puskesmas tersebut?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                ...
                <tr id="point5subb" y="Dokumentasi penyerahan obat (resep) dapat tertelusur." t="Dokumentasi penyerahan obat (resep) tidak dapat tertelusur.">
                  <td class="td_no">b.&nbsp;</td>
              ...
              <table class="form_tabel" group="5. Penanganan Produk Kembalian dan Kadaluarsa">
                ...
                <tr id="point6suba" y="Setelah menerima informasi recall dari distributor, puskesmas segera menghentikan penjualan dan mengembalikan ke distributor." t="Setelah menerima informasi recall dari distributor, puskesmas tidak segera menghentikan penjualan dan mengembalikan ke distributor.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah setelah menerima informasi recall dari sumber pengadaan, puskesmas segera menghentikan penjualan dan mengembalikan ke sumber pengadaan? </td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
              ...
              <table class="form_tabel" group="6. Pemusnahan">
                ...
                <tr id="point7suba" y="Dilakukan pemusnahan atau pengembalian ke sumber pengadaan untuk obat yang rusak, kedaluwarsa atau tidak layak jual." t="Tidak dilakukan pemusnahan atau pengembalian ke sumber pengadaan untuk obat yang rusak, kedaluwarsa atau tidak layak jual.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah dilakukan pemusnahan atau pengembalian ke sumber pengadaan untuk obat yang rusak, kedaluwarsa atau tidak layak jual? </td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
          ...
          <div class="accCntnt">
            ...
            <table class="form_tabel">
              ...
              <tr id="td_pelanggaran">
                ...
                <td class="right">m&nbsp;
                  <input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MINOR]" id="F03RS_jumlahminor" readonly value="<?php echo array_key_exists('MINOR', $sess)?$sess['MINOR']:''; ?>" title="Jumlah Minor" />
                  &nbsp;&nbsp;M&nbsp;
                  <input type="text" class="scode" id="F03RS_jumlahmajor" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MAJOR]" readonly  value="<?php echo array_key_exists('MAJOR', $sess)?$sess['MAJOR']:''; ?>" title="Jumlah Major" />
                  &nbsp;&nbsp;C&nbsp;
                  <input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL]" id="F03RS_jumlahcritical" readonly value="<?php echo array_key_exists('CRITICAL', $sess)?$sess['CRITICAL']:''; ?>" title="Jumlah Kritikal" /></td>
              </tr>
              <tr id="td_hasil">
                <td class="td_left">Hasil Temuan</td>
                <td class="right"><textarea id="F03RS_catatan" name="PEMERIKSAAN_DISTRIBUSI[HASIL_TEMUAN]" class="stext catatan" title="Hasil Temuan"><?php echo array_key_exists('HASIL_TEMUAN', $sess)?$sess['HASIL_TEMUAN']:'';?></textarea></td>
              </tr>
              <tr>
...
$(document).ready(function(){
    ...
    $("#F03RS_jumlahminor").val(parseInt(m));
    $("#F03RS_jumlahmajor").val(parseInt(M));
    $("#F03RS_jumlahcritical").val(parseInt(C));
    $("#F03RS_catatan").val(temuan.join("___"));
