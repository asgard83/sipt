...
<table class="xcelheader">
	<tr><td>&nbsp;</td>
	<td colspan="21"><b>REKAPITULASI JUMLAH STATUS KOMODITI</b></td></tr>
	<tr><td>&nbsp;</td><td colspan="5">Komoditi</td><td colspan="6" align="left"><?php echo $komoditi; ?></td></tr>
...
<table class="xcel">
  ...
  <tr>
    ...
    <td valign="top" style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['OPDRAFTBALAI']; ?></td>
	...
	$TOTOTLBALAI = $TOTOTLBALAI + $kolom[$i]['OPDRAFTBALAI'];
    ...
    <td valign="top" style="border:1px solid #000; border:thin;"><?php echo $TOTOTLBALAI; ?></td>
