...
<table class="xcel">
  <tr>
    ...
    <th colspan="2" style="border:1px solid #000; border:thin; background:#CCC;" align="center">PROGRESS</th>
  </tr>
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">PROSES</th>    
  ...
  if(count($kolom) > 0){ 
	...
	<tr>
	  ...
	  <td valign="top" style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['PROSES']; ?></td>
