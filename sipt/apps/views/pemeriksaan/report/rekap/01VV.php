...
<table class="xcel">
  ...
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">Pencabutan Nomor Pendaftaran</th>
    <th style="border:1px solid #000; border:thin; background:#CCC;">Pengamanan</th>
    <th style="border:1px solid #000; border:thin; background:#CCC;">Perintah Penarikan</th>
  ...
  if($jml > 0){
	  ...
	  <tr>
		...
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['PNP']; ?></td>
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['PENGAMANAN']; ?></td>
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['PP']; ?></td>
  ...
  ?>
  <tr>
    <td style="border:1px solid #000; border:thin;" colspan="12">Data Tidak Ditemukan</td>
  </tr>
  <?php
  }
  ?>
