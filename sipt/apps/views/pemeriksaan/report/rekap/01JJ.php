...
<table class="xcel">
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">BAIK<br />SEKALI</th>
  ...
  if($jml > 0){
	  ...
	  <tr>
		...
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['JMLBAIKSEKALI']; ?></td>
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['JMLBAIK']; ?></td>
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['JMLKURANG']; ?></td>
		<td style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['JMLJELEK']; ?></td>
	  </tr>
	  <?php
	  $no++;
	  }
  ...
  ?>
  <tr>
    <td style="border:1px solid #000; border:thin;" colspan="7">Data Tidak Ditemukan</td>
  </tr>
  <?php
  }
  ?>
