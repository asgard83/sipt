...
<table class="xcel">
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;" colspan="6">Tindak Lanjut : <br />Pemusnahan OT BKO, OT TIE, dan OT Rusak</th>
    <th style="border:1px solid #000; border:thin; background:#CCC;" rowspan="2">Perkiraan Harga</th>
  </tr>
  <tr>
    <th style="border:1px solid #000; border:thin; background:#CCC;">- Mengedarkan OT BKO <br />- OT TIE <br />- OT Rusak</th>
