...
<table class="xcelheader">
	<tr><td>&nbsp;</td>
	<td colspan="15"><b>REKAP LAPORAN BB/B POM PEMERIKSAAN SARANA PRODUKSI KOSMETIKA TERKAIT TEMUAN PRODUK</b></td></tr>
...
<table class="xcelheader">
	...
	<td colspan="20"><b>LAPORAN HASIL PEMERIKSAAN SARANA PRODUKSI KOSMETIKA</b></td></tr>
...
<table class="xcel">
  ...
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">Kepatuhan CPKB</th>
  ...
  <tr>
    ...
    <td valign="top" style="border:1px solid #000; border:thin;"><?php echo $kolom[$i]['KEPATUHAN_CPKB']; ?></td>
