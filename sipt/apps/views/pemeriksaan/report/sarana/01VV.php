...
<table class="xcelheader">
	    <td colspan="10"><b>REKAP LAPORAN BB/B POM PEMERIKSAAN SARANA PRODUKSI PANGAN PIRT TERKAIT TEMUAN PRODUK</b></td></tr>
	<tr><td>&nbsp;</td><td>Jenis Sarana</td><td colspan="8"><b><?php echo $judul; ?></b></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Awal</td><td colspan="8"><?php echo $awal; ?></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Akhir</td><td colspan="8"><?php echo $akhir; ?></td></tr>
    <tr><td>&nbsp;</td><td>Balai Besar / Balai Pemeriksa</td><td colspan="8"><?php echo $balai; ?></td></tr>      
...
<table class="xcel">
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">Klasifikasi Temuan</th>
  ...
  <tr>
    ...
    <td valign="top" style="border:1px solid #000; border:thin;"><?php echo $temuan[$z]['KLASIFIKASI_TEMUAN']; ?></td>
...
<table class="xcelheader">
	<tr><td>&nbsp;</td></tr>
	  <td colspan="11"><b>LAPORAN HASIL PEMERIKSAAN SARANA PRODUKSI PANGAN PIRT</b></td></tr>
	<tr><td>&nbsp;</td><td>Jenis Sarana</td><td colspan="9"><b><?php echo $judul; ?></b></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Awal</td><td colspan="9"><?php echo $awal; ?></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Akhir</td><td colspan="9"><?php echo $akhir; ?></td></tr>
    <tr><td>&nbsp;</td><td>Balai Besar / Balai Pemeriksa</td><td colspan="9"><?php echo $balai; ?></td></tr>      
...
<table class="xcel">
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">Hasil Temuan Lain</th>
  ...
  <?php $no++; } } else { ?>
  <tr>
    <td valign="top" style="border:1px solid #000; border:thin;" colspan="11">Data Tidak Ditemukan</td>
  </tr>
  <?php } ?>
</table>
<?php } ?>