...
<table class="xcelheader">
	  <td colspan="10"><b>REKAP LAPORAN BB/B POM PEMERIKSAAN SARANA INTENSIFIKASI PENGAWASAN KHUSUS TERKAIT TEMUAN PRODUK</b></td></tr>
...
<table class="xcelheader">
	<tr><td>&nbsp;</td></tr>
	<td colspan="8"><b>LAPORAN HASIL PEMERIKSAAN SARANA INTENSIFIKASI PENGAWASAN KHUSUS</b></td></tr>
	<tr><td>&nbsp;</td><td>Jenis Sarana</td><td colspan="6"><b><?php echo $judul; ?></b></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Awal</td><td colspan="6"><?php echo $awal; ?></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Akhir</td><td colspan="6"><?php echo $akhir; ?></td></tr>
    <tr><td>&nbsp;</td><td>Balai Besar / Balai Pemeriksa</td><td colspan="6"><?php echo $balai; ?></td></tr>      
...
<table class="xcel">
  ...
  <?php $no++; } } else { ?>
  <tr>
    <td valign="top" style="border:1px solid #000; border:thin;" colspan="8">Data Tidak Ditemukan</td>
  </tr>
  <?php } ?>
</table>
<?php } ?>