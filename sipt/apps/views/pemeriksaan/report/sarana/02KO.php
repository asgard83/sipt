...
?>
<style type="text/css">
table.xcel{text-align: left; border-width:thin; border-color:#000; border-collapse:collapse; color:#000; font-family: "lucida grande", Tahoma, verdana, arial, sans-serif; font-size:10px; direction:ltr;}
...
<table class="xcelheader">
	<tr><td>&nbsp;</td><td colspan="15"><b>REKAP LAPORAN BB/B POM PEMERIKSAAN SARANA DISTRIBUSI KOSMETIKA TERKAIT TEMUAN PRODUK</b></td></tr>
...
<div>
<table class="xcelheader">
	<tr><td>&nbsp;</td><td colspan="12"><b>LAPORAN HASIL PEMERIKSAAN SARANA DISTRIBUSI KOSMETIKA</b></td></tr>
	<tr><td>&nbsp;</td><td>Jenis Sarana</td><td colspan="11"><b><?php echo $judul; ?></b></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Awal</td><td colspan="11"><?php echo $awal; ?></td></tr>
	<tr><td>&nbsp;</td><td>Pemeriksaan Akhir</td><td colspan="11"><?php echo $akhir; ?></td></tr>
    <tr><td>&nbsp;</td><td>Balai Besar / Balai Pemeriksa</td><td colspan="11"><?php echo $balai; ?></td></tr>      
...
<table class="xcel">
  <tr>
    ...
    <th style="border:1px solid #000; border:thin; background:#CCC;">Tindakan Sarana</th>
  ...
  <tr>
    ...
    <td valign="top" style="border:1px solid #000; border:thin;"><ul style="list-style-type:disc; padding-left:10px; margin:0;"><?php $tindakan = explode("#",$kolom[$i]['TINDAKAN_SARANA']); echo "<li>".join("</li><li>", $tindakan)."</li>"; ?></ul></td>
  ...
  <?php $no++; } } else { ?>
  <tr>
    <td valign="top" style="border:1px solid #000; border:thin;" colspan="13">Data Tidak Ditemukan</td>
  </tr>
  <?php } ?>
</table>
<?php } ?>