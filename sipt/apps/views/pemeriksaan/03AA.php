          ...
          <div class="accCntnt">
            ...
            <table class="form_tabel">
              ...
              <tr>
                ...
                <td class="td_right"><?php if(trim($sess['TELEPON'])!="") { ?>
            ...
            <table class="form_tabel">
              ...
              <tr>
                ...
                <td class="td_right"><?php echo  form_dropdown('PEMERIKSAAN_DISTRIBUSI[TUJUAN_PEMERIKSAAN]', $tujuan_periksa, array_key_exists('TUJUAN_PEMERIKSAAN', $sess)?$sess['TUJUAN_PEMERIKSAAN']:'', 'id="F03AA_tujuanperiksa" class="stext" rel="required" title="Pilih salah satu tujuan pemeriksaan"'); ?></td>
            </table>
          </div>
        </div>
        <!-- Akhir Pemeriksaan !-->
            ...
            <div class="accCntnt">
              ...
              <table class="form_tabel" group="1. Profil Sarana">
                ...
                <tr id="point1suba" y="Nama dan alamat apotek sesuai Surat Izin Apotek." t="Nama dan alamat apotek tidak sesuai Surat Izin Apotek.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah nama dan alamat apotek serta APA sesuai Surat Izin Apotek?</td>
              ...
              <table class="form_tabel" group="2. Pengadaan">
                ...
                <tr id="point3suba" y="Semua atau sebagian pengadaan obat dan bahan obat tidak dari sumber resmi." t="Semua atau sebagian pengadaan obat dan bahan obat tidak dari sumber resmi.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah pengadaan obat dan bahan obat dari sumber resmi?</td>
                  <td class="td_kritis">Tingkat Kekritisan (C)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[0], is_array($aspek_penilaian)?$aspek_penilaian[1]:'', 'tingkat="C" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
                <tr id="point3subb" y="Semua atau sebagian surat pesanan untuk pengadaan obat/bahan obat ditandatangani oleh Apoteker Pengelola Apotek, tidak mencantumkan nama jelas, nomor SIPA serta tidak distempel apotek." t="Semua atau sebagian surat pesanan untuk pengadaan obat/bahan obat tidak ditandatangani oleh Apoteker Pengelola Apotek, tidak mencantumkan nama jelas, nomor SIPA serta tidak distempel apotek.">
                  <td class="td_no">b.&nbsp;</td>
                  <td class="td_aspek">Apakah surat pesanan untuk pengadaan obat/bahan obat ditandatangani oleh Apoteker Pengelola Apotek, mencantumkan nama jelas dan nomor SIPA dan distempel apotek?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
              ...
              <table class="form_tabel" group="3. Penerimaan dan Penyimpanan">
                ...
                <tr id="point4subf" y="Vaksin/CCP disimpan pada tempat yang sesuai dengan persyaratan penandaan." t="Vaksin/CCP tidak disimpan pada tempat yang sesuai dengan persyaratan penandaan.">
                  <td class="td_no">f.&nbsp;</td>
                ...
                <tr id="point4subg" y="Tempat penyimpanan Vaksin/CCP dilengkapi termometer dan dilakukan pencatatan monitoring suhu minimal dua kali sehari" t="Tempat penyimpanan Vaksin/CCP tidak dilengkapi termometer dan dilakukan pencatatan monitoring suhu minimal dua kali sehari">
                  <td class="td_no">g.&nbsp;</td>
                ...
                <tr id="point4subh" y="Penyimpanan vaksin dilengkapi dengan generator otomatis yang berfungsi dengan baik atau tidak mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam." t="Penyimpanan vaksin tidak dilengkapi dengan generator otomatis yang berfungsi dengan baik atau tidak mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam.">
                  <td class="td_no">h.&nbsp;</td>
                  <td class="td_aspek">Apakah penyimpanan vaksin dilengkapi dengan generator otomatis yang berfungsi dengan baik? Atau Apakah mempunyai petugas  yang dapat menjamin generator yang tidak otomatis berfungsi dengan baik selama 24 jam?</td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[12]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
                <tr id="point4subi" y="Obat yang kedaluwarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan dipisahkan penyimpanannya dan tidak dicatat?" t="Obat yang kedaluwarsa, mengalami kerusakan kemasan, tutup atau yang diduga kemungkinan mengalami kontaminasi dan yang akan dimusnahkan tidak dipisahkan penyimpanannya dan tidak dicatat?">
                  <td class="td_no">i.&nbsp;</td>
                  ...
                  <td class="td_kritis">Tingkat Kekritisan (m)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[13]:'', 'tingkat="m" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
              ...
              <table class="form_tabel" group="4. Penyaluran">
                ...
                <tr id="point5suba" y="Setiap penyerahan obat keras (di luar DOWA) berdasarkan resep yang sah." t="Setiap penyerahan obat keras (di luar DOWA) tidak berdasarkan resep yang sah.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah setiap penyerahan obat keras (di luar DOWA) berdasarkan resep yang sah?</td>
                  <td class="td_kritis">Tingkat Kekritisan (m)</td>
              ...
              <table class="form_tabel" group="5. Penanganan Produk Kembalian dan Kadaluarsa">
                ...
                <tr id="point6suba" y="Setelah menerima informasi recall dari distributor, apotek segera menghentikan penjualan dan mengembalikan ke distributor." t="Setelah menerima informasi recall dari distributor, apotek tidak segera menghentikan penjualan dan mengembalikan ke distributor.">
                  <td class="td_no">a.&nbsp;</td>
                  <td class="td_aspek">Apakah setelah menerima informasi recall dari distributor, apotek segera menghentikan penjualan dan mengembalikan ke distributor? </td>
                  <td class="td_kritis">Tingkat Kekritisan (M)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[18]:'', 'tingkat="M" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
              ...
              <table class="form_tabel" group="6. Pemusnahan">
                ...
                <tr id="point7subb" y="Laporan pelaksanaan pemusnahan ditembuskan Balai Besar/Balai POM setempat dengan melampirkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi." t="Laporan pelaksanaan pemusnahan tidak mditembuskan Balai Besar/Balai POM setempat dengan melampirkan Berita Acara Pelaksanaan Pemusnahan yang ditandatangani oleh pelaksana pemusnahan dan saksi.">
                  ...
                  <td class="td_kritis">Tingkat Kekritisan (m)</td>
                  <td class="td_kritis"><?php echo form_dropdown('PEMERIKSAAN_DISTRIBUSI[ASPEK_PENILAIAN][]', $cb_kritis[1], is_array($aspek_penilaian)?$aspek_penilaian[21]:'', 'tingkat="m" class="sel_penyimpangan" rel="required" title="Pilih salah satu Ya, Tidak atau NA"'); ?></td>
                </tr>
              </table>
          ...
          <div class="accCntnt">
            ...
            <table class="form_tabel">
              ...
              <tr id="td_pelanggaran">
                ...
                <td class="right">m&nbsp;
                  <input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MINOR]" id="F03AA_jumlahminor" readonly value="<?php echo array_key_exists('MINOR', $sess)?$sess['MINOR']:''; ?>" title="Jumlah Minor" />
                  &nbsp;&nbsp;M&nbsp;
                  <input type="text" class="scode" id="F03AA_jumlahmajor" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_MAJOR]" readonly  value="<?php echo array_key_exists('MAJOR', $sess)?$sess['MAJOR']:''; ?>" title="Jumlah Major" />
                  &nbsp;&nbsp;C&nbsp;
                  <input type="text" class="scode" name="PEMERIKSAAN_DISTRIBUSI[KLASIFIKASI_PELANGGARAN_CRITICAL]" id="F03AA_jumlahcritical" readonly value="<?php echo array_key_exists('CRITICAL', $sess)?$sess['CRITICAL']:''; ?>" title="Jumlah Kritikal" /></td>
              </tr>
              <tr id="td_hasil">
                <td class="td_left">Hasil Temuan</td>
                <td class="right"><textarea id="F03AA_catatan" name="PEMERIKSAAN_DISTRIBUSI[HASIL_TEMUAN]" class="stext catatan" title="Hasil Temuan"><?php echo array_key_exists('HASIL_TEMUAN', $sess)?$sess['HASIL_TEMUAN']:'';?></textarea></td>
              </tr>
              <tr>
...
$(document).ready(function(){
    ...
    $("#F03AA_jumlahminor").val(parseInt(m));
    $("#F03AA_jumlahmajor").val(parseInt(M));
    $("#F03AA_jumlahcritical").val(parseInt(C));
    $("#F03AA_catatan").val(temuan.join("___"));
