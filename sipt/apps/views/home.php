    ...
    <div id="menu-wrapper"> <!-- menu wrapper -->
      ...
      <ul id="menus">
        ...
        <li><a href="#" title="Monitoring"> Monitoring</a>
          <ul class="submenu">
            <li><a href="<?php echo site_url(); ?>/home/monitoring/pemeriksaan-pirt" title="Monitoring data pemeriksaan PIRT">Pemeriksaan PIRT</a></li>
          </ul>
        </li>
        <?php
       ...
       ?>
        <li><a href="#" title="Jenis Pelaporan"> Entri </a>
          <ul class="submenu">
           ...
           if (in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))){ // || in_array('9', $this->newsession->userdata('SESS_KODE_ROLE'))) {#Pusat
             ...
             ?>
				...
				{
					?>
                    <li><a href="#" title="Pengujian Rutin" class="hasChild"> Surveilance Kategori D2</a>
                      <ul class="submenu">
                          <li><a href="<?php echo site_url(); ?>/home/pengujian/surveilance">Verifikasi Sampel</a></li>
                          <li><a href="<?php echo site_url(); ?>/home/pengujian/surveilance/sent">Sampel Terkirim</a></li>
                      </ul>
                    </li>
                    <?php	
				}
				...
				{
					?>
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/puk/list/receive">Review PUK</a></li>
                <?php
				}
            ...
            if (in_array('2', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('3', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('4', $this->newsession->userdata('SESS_KODE_ROLE'))) {
             ...
             if (in_array('2', $this->newsession->userdata('SESS_KODE_ROLE'))) {
              ...
              ?>
                ...
                <li class="separator">&nbsp;</li>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/surveilance/feed-back">Feed Back Surveilance Kategori D2</a></li>
                <?php
             ...
             ?>
                ...
                <li class="separator">&nbsp;</li>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/surveilance">Sampling Obat Kategori D2</a></li>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/surveilance/feed-back">Feed Back Surveilance Kategori D2</a></li>
                <li><a href="#" title="Sampel Uji Rujuk" class="hasChild"> Sampel Uji Rujuk</a>
                  <ul class="submenu">
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/rujukan/draft"> Draft Rujukan</a></li>
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/rujukan/proses"> Dalam Proses</a></li>
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/rujukan/hasil"> Hasil Rujukan</a></li>
                    <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/none"> Sampel Rujukan Tidak Uji</a></li>
                    <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/sent"> Sampel Rujukan Terkirim</a></li>                    
                    <li class="separator">&nbsp;</li>
                    <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/done"> Sampel Rujukan Selesai</a></li>                    
                  </ul>
                </li>
                <li><a href="#" title="Sampel Uji Unggulan" class="hasChild"> Sampel Uji Lab. Unggulan</a>
                  <ul class="submenu">
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/unggulan/hasil"> Hasil Uji</a></li>
                    <li><a href="<?php echo site_url(); ?>/home/pengujian/unggulan/rekom"> Hasil Rekomendasi</a></li>
                    <li class="separator">&nbsp;</li>
                    <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/done"> Sampel Unggulan Selesai</a></li>
                  </ul>
                </li>
                <?php
        ...
        <li><a href="#" title="Pengujian" class="hasChild"> Pengujian </a>
         ...
         if (in_array('7', $this->newsession->userdata('SESS_KODE_ROLE'))) { #TPS
          ...
          ?>
            ...
            <li><a href="#" class="hasChild"> Sampel Rujukan </a>
              <ul>
                <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/draft">Penerimaan Sampel</a></li>
                <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/deliver">Penyerahan Sampel</a></li>
              </ul>
            </li>
            <li><a href="#" class="hasChild"> Sampel Unggulan </a>
              <ul>
                <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/draft">Draft Sampel</a></li>
                <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/receive">Penerimaan Sampel</a></li>
                <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/deliver">Penyerahan Sampel</a></li>
              </ul>
            </li>
            <?php
         ...
         if (in_array('8', $this->newsession->userdata('SESS_KODE_ROLE'))) { #MA
          ...
          ?>
            ...
            <li><a href="#" class="hasChild"> Sampel Rujukan </a>
              <ul>
                <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/verifikasi"> Verifikasi Penerimaan Sampel</a></li>
                <li><a href="<?php echo site_url(); ?>/home/rujukan/sampel/all"> Sampel Terkirim</a></li>
              </ul>
            </li>
             <li><a href="#" class="hasChild"> Sampel Unggulan </a>
              <ul>
                <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/verifikasi"> Verifikasi Penerimaan Sampel</a></li>
                <li><a href="<?php echo site_url(); ?>/home/unggulan/sampel/all"> Sampel Terkirim</a></li>
              </ul>
            </li>
            <?php
          ...
          ?>
            <li><a href="#" title="Perintah Kerja" class="hasChild"> Perintah Uji</a>
              <ul>
                ...
                <li><a href="<?php echo site_url(); ?>/home/pengujian/puk/list/review"> Hasil Review PUK</a></li>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/sp/list/rujukan"> Daftar Sampel Rujukan</a></li>
              </ul>
            </li>
            <li><a href="<?php echo site_url(); ?>/home/pengujian/lhu/list/draft" title="Laporan Hasil Uji"> Laporan Hasil Uji</a></li>
            <li><a href="#" class="hasChild" title="Konsep Laporan"> Konsep Laporan</a>
              <ul>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/lhu/list/all"> Baru </a></li>
                <li><a href="<?php echo site_url(); ?>/home/pengujian/lhu/list/send">Terkirim</a></li>
              </ul>
            </li>
            <?php /*?><li><a href="<?php echo site_url(); ?>/home/pengujian/lhu/list/all" title="Catatan Pengujian"> Konsep Laporan / Sertifikat</a></li><?php */?>
            <?php
          ...
          ?>
            <li><a href="#" class="hasChild" title="Hasil Pengujian">Pengujian Balai</a>
              <ul class="submenu">
                ...
                <li><a href="<?php echo site_url(); ?>/home/ppomn/laporan/monev" title="Sampel dalam proses monev PPOMN"> Proses Monev</a></li>
                <li><a href="<?php echo site_url(); ?>/home/ppomn/laporan/insert" title="Sampel dalam proses tindak lanjut Ditwas / Insert"> Proses Ditwas / Insert</a></li>
              </ul>
            </li>
            <?php
        ...
        <li><a href="#" title="Jenis Pelaporan"> Report </a>
         ...
         if (in_array('1', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('10', $this->newsession->userdata('SESS_KODE_ROLE'))) {#RHPK Pengujian
          ...
          ?>
                ...
                <li><a href="<?php echo site_url(); ?>/home/report/pengujian/rekap-timeline" title="Rekapitulasi Time Line Pengujian"> Rekap Timeline Pengujian</a></li>
                <?php
...
if (in_array('1', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('2', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('5', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('6', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('9', $this->newsession->userdata('SESS_KODE_ROLE'))) {
 ...
 ?>
        <li>
        <a href="#" title="Master Data"> Master Data </a>
        <ul class="submenu">
        ...
        ?>
         ...
         if (!in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))) {
          ...
          <li><a href="<?php echo site_url(); ?>/home/master/rokok" title="Master Data Rokok"> Rokok </a></li>
          <?php
