                  ...
                  <form action="<?php echo $act; ?>" id="fver-spu" method="post" autocomplete="off">
                    <table class="form_tabel">
                        <?php if($allowed){
							...
							<tr><td class="td_left">Mengetahui Kepala Balai</td><td class="td_right"><input type="text" class="stext" title="Petugas penerima sampel" readonly="readonly" value="<?php echo $kabalai[0]; ?>" /><input type="hidden" name="TTD_MP" value="<?php echo $kabalai[1]; ?>" /></td></tr>
