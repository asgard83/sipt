      ...
      <div class="accCntnt">
        ...
        <form action="<?php echo $act; ?>" id="fver-spu" method="post" autocomplete="off">
          <table class="form_tabel">
            ...
            <tr>
              <td class="td_left">Diterima di TPS Tanggal</td>
              <td class="td_right"><input type="text" class="sdate" name="TANGGAL_TERIMA_TPS" title="Tanggal terima sampel di TPS" /></td>
            </tr>
            <tr>
              <td class="td_left">Petugas Penerima Sampel</td>
              <td class="td_right"><input type="text" class="stext" name="PETUGAS_PENERIMA" title="Petugas penerima sampel, jika lebih dari satu pisahkan dengan titik koma (;)" id="penerima" url="<?php echo site_url(); ?>/autocompletes/autocomplete/operator_tps" /></td>
            </tr>
            <?php
							}
						}else{ #else allowed?>
