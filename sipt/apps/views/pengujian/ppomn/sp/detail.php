    ...
    <div class="acco2">
      ...
      <div class="accCntnt">
        ...
        <table class="form_tabel">
          ...
          <tr>
            <td class="td_left"><b>Menyetujui Ka. PPOMN</b></td>
          ...
          <tr>
            ...
            <td class="td_right"><?php
						...
						if($jml > 0){
							for($i = 0; $i < $jml; $i++){
								?>
              <div><a href="javascript:void(0);" class="delsampelmt" url="<?php echo site_url(); ?>/get/pengujian/del_sampel_mt_ppomn/<?php echo $sess['SPU_ID']; ?>/<?php echo $kabid[$i]['USER_ID']; ?>" namamt="<?php echo $kabid[$i]['NAMA_USER']; ?>" nospu="<?php echo $sess['UR_SPU']; ?>"><img src="<?php echo base_url(); ?>images/icon-delete.png" align="middle"></a>&nbsp;<b><?php echo $kabid[$i]['NAMA_USER']; ?></b></div>
              <div><?php echo $kabid[$i]['USER_ID']; ?></div>
              <div>&bull;&nbsp;<?php echo $kabid[$i]['JABATAN']; ?></div>
              <div><i>Jika, terjadi kesalahan dalam menentukan disposisi surat perintah kepada kepala bidang pengujian. Silahkan klik <a href="javascript:void(0);" class="redispo" judul="Edit Data Kepala Bidang" url="<?php echo site_url(); ?>/get/pengujian/get_dispo_ppomn/<?php echo $sess['SPU_ID']; ?>/<?php echo $kabid[$i]['USER_ID']; ?>"><b>DI SINI</b></a> untuk memperbaikinya.</i></div>
              <hr>
              <?php
							}
						}
          ...
          <tr>
            <td class="td_left" colspan="2"><div><i>Jika ada Kepala Bidang yang terlewat, silahkan klik <a href="javascript:void(0);" class="redispo" url="<?php echo site_url(); ?>/get/pengujian/get_addmt_ppomn/<?php echo $sess['SPU_ID']; ?>" judul="Penambahan Kepala Bidang"><b>DI SINI</b></a> untuk menambah Kepada Bidang yang dimaksud.</i></div></td>
          </tr>
        </table>
        <div id="tabs">
          <ul>
