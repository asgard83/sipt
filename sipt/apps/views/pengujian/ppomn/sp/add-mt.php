...
<form name="fadd-mt" id="fadd-mt" method="post" action="<?php echo $act; ?>" autocomplete="off">
	...
	<table class="form_tabel">
		...
		<tr>
			<td class="td_left">Ditujukan Kepada Kepala Bidang</td>
			<td class="td_right"><?php echo form_dropdown('USER_ID',$arrmt,'','class="stext" title="Pilih Manager Teknis" rel="required"'); ?></td>
		</tr>
	</table>
	<div style="height:10px;">&nbsp;</div>
	<div style="padding-left:5px;"><a href="#" class="button save" onclick="save_edit('#fadd-mt'); return false;"><span><span class="icon"></span>&nbsp; Proses Penambahan Kepala Bidang &nbsp;</span></a></div>
</form>
