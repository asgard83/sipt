	...
	<div class="acco2">
		...
		<div class="collapse">
            ...
            <div style="background:#FBE3E4; border:1px solid #FBE3E4; padding:10px;">
                ...
                <h2 class="small"><a href="#" url="<?php echo site_url(); ?>/get/pengujian/log_sampel/<?php echo $sampel[0]['KODE_SAMPEL']; ?>" onclick="expand_detail($(this), 'detail_log'); return false;" id="detail_hisotry">Detail Log Sampel (
                  <?= $jml_log; ?>
                  )</a></h2>
