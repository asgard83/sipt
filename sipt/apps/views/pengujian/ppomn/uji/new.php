        ...
        <div class="accCntnt">
          ...
          <table class="form_tabel" width="100%">
            ...
            <tr>
              ...
              <td class="td_right"><input type="text" id="jterima" class="sdate" title="Jumlah sampel yang diterima" value="<?php echo in_array('B1',$this->newsession->userdata('SESS_SUB_SARANA')) || in_array('B2',$this->newsession->userdata('SESS_SUB_SARANA')) ? $jml[0]['JUMLAH_KIMIA'] : $jml[0]['JUMLAH_MIKRO']; ?>" readonly="readonly"/>
                &nbsp; <?php echo $jml[0]['SATUAN']; ?></td>
            </tr>
            <tr>
              <td class="td_left">Sisa Sampel</td>
              <td class="td_right"><input type="text" class="scode" id="sisa_uji" readonly="readonly" value="<?php echo in_array('B1',$this->newsession->userdata('SESS_SUB_SARANA')) || in_array('B2',$this->newsession->userdata('SESS_SUB_SARANA')) ? $sampel[0]['SISA_KIMIA'] : $sampel[0]['SISA_MIKRO']; ?>" title="Sisa sampel yang diuji <?php echo in_array('B1',$this->newsession->userdata('SESS_SUB_SARANA')) || in_array('B2',$this->newsession->userdata('SESS_SUB_SARANA')) ? 'kimia' : 'mikro' ?>" /></td>
            </tr>
          </table>
          <?php
                 $jparams = count($sess);
          ...
          <div>
            ...
            <table class="form_tabel">
              <tr>
                ...
                <td class="td_right"><input type="text" class="sdate datepick" title="Mulai Di Uji" name="UJI[AWAL_UJI][]" value="<?php echo $sess[$i]['AWAL_UJI']; ?>" rel="required" /></td>
                <td></td>
