...
$(document).ready(function(){
  ...
  var tahunskrng = tgl.getFullYear(); 
	$('input.sdate').datepicker({ dateFormat: 'dd/mm/yy',regional: 'id',minDate: new Date(tahunskrng, 01 - 1, 1), maxDate: new Date()});
	...
	$("#chk_revisi").change(function(){
		if($(this).attr("checked")){
			$("#fspp").attr("action", "<?php echo site_url().'/post/spk/spk_act/spk-tolak'; ?>");
			...
			$("#fspp").attr("action", "<?php echo site_url().'/post/spk/spk_act/spp-save'; ?>");
