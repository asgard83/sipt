          ...
          <div class="accCntnt">
            ...
            <table class="form_tabel">
              ...
              <tr>
                ...
                <td class="td_right"><input type="text" class="sdate" title="Tanggal Sampling" name="SAMPEL[TANGGAL_SAMPLING]" rel="required" value="<?php echo $sess['TANGGAL_SAMPLING']; ?>" id="tanggal_sampling" onchange="chk_tgl('#tanggal_surat', '#tanggal_sampling', 'Mohon diperiksa kembali tanggal sampling tidak boleh lebih kecil dari tanggal surat tugas'); return false;" /></td>
