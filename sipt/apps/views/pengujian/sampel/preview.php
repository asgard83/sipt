			...
			<div class="accCntnt">
				...
				<table class="form_tabel">
					...
					<tr>
					  ...
					  <div>Retain&nbsp;
					    <input type="text" class="scode" id="sisa" title="Sisa (retain) sampel " name="SAMPEL[SISA]" readonly value="<?php echo array_key_exists('SISA', $sess)?$sess['SISA']:"0"; ?>" onkeyup="numericOnly($(this))" /></div></td>
					  <td></td>
