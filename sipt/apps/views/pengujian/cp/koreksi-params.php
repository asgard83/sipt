...
<form id="fkoreksi-params" action="<?php echo $act; ?>"	autocomplete="off" name="fkoreksi-params" method="post">
...
<table class="form_tabel">
	...
	<tr>
		...
		<td colspan="4" class="td_right"><div style="padding-bottom:5px;"><span>Diuji </span><span style="margin-left:39px;"><?php echo $sess['JUMLAH_UJI']; ?></span></div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="td_right"><?php echo form_dropdown('UJI[HASIL_PARAMETER]', $hasil, $sess['HASIL_PARAMETER'], 'class="sel_header" title="Pilih salah satu pilihan : MS atau TMS" rel="required"'); ?></td>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
...
<div style="padding-left:5px;">
	<a href="#" class="button save" onclick="save_edit('#fkoreksi-params'); return false;"><span><span class="icon"></span>&nbsp; Simpan Data Koreksi &nbsp;</span></a>
</div>
