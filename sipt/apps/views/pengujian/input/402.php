...
<tr>
  ...
  <td class="td_right"><?php
	if(in_array(trim($row[0]['HASIL_SAMPEL']), $arrhasil)){
		...
		echo form_dropdown('TINDAK_LANJUT', $tindak_lanjut, trim($row['0']['TINDAK_LANJUT']), 'class="stext" title="Piilh tindak lanjut hasil pengujian"rel="required" style="width:500px;"');
	}
	?></td>
</tr>
<tr>
  <td class="td_left">Tembusan</td>
  <td class="td_right"><?php echo $row[0]['TEMBUSAN']; ?></td>
</tr>
