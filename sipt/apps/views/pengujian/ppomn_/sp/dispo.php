        ...
        <form name="fspu" id="fspu" method="post" action="<?php echo $act; ?>" autocomplete="off">
          <table class="form_tabel">
            ...
            <tr class="row-petugas" ke="0" id="petugas">
              ...
              <td class="td_right"><input type="text" class="stext operator" rel="required" url="<?php echo site_url(); ?>/autocompletes/autocomplete/get_petugas_pengujian/4/<?php echo $sess['SPU_ID']; ?>" title="Ketikan Nama Manajer Teknis, kemudian tekan enter" /><input type="hidden" id="ippetugas-0" name="USER_ID[]" />
                &nbsp;<a href="#" class="addpetugas"><img src="<?php echo base_url(); ?>images/add.png" align="top" style="border:none" /></a>
                <div style="padding-top:5px; font-size:9px; font-weight:bold;">Klik tanda plus disamping untuk menambah manajer teknis</div>
                </td>
            </tr>
          </table>
