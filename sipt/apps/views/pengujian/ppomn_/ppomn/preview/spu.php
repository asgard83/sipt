    ...
    <div class="acco2">
      ...
      <div class="accCntnt">
		...
		if(!in_array('B5',$this->newsession->userdata('SESS_SUB_SARANA'))){
            ...
            Terdapat sebanyak <b><?php echo $chkmikro; ?></b> sampel yang memerlukan uji mikrobiologi. Klik <a href="<?php echo site_url(). '/home/ppomn/spk/new/'.$sess['SPU_ID'].'.'.$sess['STATUS']; ?>"><b>disini</b></a> untuk memohon uji ke bidang mikrobiologi.
            </div>
        	<?php
			}
		}
        ...
        <form action="<?php echo $act; ?>" id="fver-spu" method="post" autocomplete="off">
          <table class="form_tabel">
            <tr>
              ...
              <td class="td_right"><?php echo form_dropdown('STATUS',$status,'','class="stext" title="Pilih salah satu, untuk memproses dokumen SPU" rel="required"', $disverifikasi); ?></td>
            </tr>
            <tr>
