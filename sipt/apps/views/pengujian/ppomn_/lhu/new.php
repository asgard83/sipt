    	...
    	<div class="acco2">
        	<div class="expand"><a title="expand/collapse" href="#" style="display: block;">LAPORAN HASIL UJI</a></div>
				...
				<form name="fcp" id="fcp" method="post" action="<?php echo $act; ?>" autocomplete="off">
					...
					<table class="form_tabel">
						<tr>
							<td class="td_left bold">Kesimpulan</td><td class="td_right"><?php echo $rowcp[0]['HASIL']; ?></td>
						</tr>
...
<?php */?>    
						...
						<tr>
							<td class="td_left bold">Catatan</td><td class="td_right"><textarea class="stext catatan" rel="required" name="CATATAN_CP" title="Catatan"></textarea></td>
						</tr>
						</table>
					<div style="height:5px;">&nbsp;</div>
		...
		<a href="#" class="button check" onclick="fpost('#fcp','',''); return false;"><span><span class="icon"></span>&nbsp; Verifikasi &nbsp;</span></a>&nbsp;
