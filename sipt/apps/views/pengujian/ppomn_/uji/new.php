      ...
      <div class="collapse">
        <div class="accCntnt">
          ...
          <table class="form_tabel" width="100%">
            <tr>
              <td class="td_left">Kode Sampel</td>
              <td class="td_right"><?php echo $kode_sampel; ?></td>
            </tr>
            <tr>
              <td class="td_left">Jumlah sampel yang diterima</td>
              <td class="td_right"><input type="text jawal" class="sdate" title="Jumlah sampel yang diterima" value="<?php echo in_array('B1',$this->newsession->userdata('SESS_SUB_SARANA')) || in_array('B2',$this->newsession->userdata('SESS_SUB_SARANA')) ? $jml[0]['JUMLAH_KIMIA'] : $jml[0]['JUMLAH_MIKRO']; ?>" readonly="readonly"/>
            ...
            <table class="form_tabel">
              ...
              <tr>
                ...
                <td class="td_right"><span class="upload_LCP<?php echo $i; ?>">
                  ...
                  </span><span class="file_LCP<?php echo $i; ?>"></span></td>
                <td></td>
                <td class="td_left">&nbsp;</td>
                <td class="td_right">&nbsp;</td>
              </tr>
			...
			success: function(data){
				...
				if(typeof(data.error) != "undefined"){
					if(data.error != ""){
						...
						$(".file_LCP"+ke+"").html("<b>1 File telah dilampirkan. </b>&nbsp;<a href=\"<?php echo base_url(); ?>files/LCP/"+arrdata[3]+"/"+arrdata[0]+"\" target=\"_blank\">Tampilkan File</a>&nbsp;&bull;&nbsp;<a href=\"#\" class=\"del_upload\" url=\"<?php echo site_url(); ?>/utility/uploads/del_upload/"+arrdata[3]+"/"+arrdata[0]+"\" ke="+ke+">Edit atau Hapus File ?</a><input type=\"hidden\" name=\"UJI[LCP][]\" value="+arrdata[0]+">");
					}
				}
			},
