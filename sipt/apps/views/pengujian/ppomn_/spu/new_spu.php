        	...
        	<div class="expand"><a title="expand/collapse" href="#" style="display: block;">SURAT PERINTAH UJI</a></div>
                ...
                <h2 class="small garis">Informasi Data Surat Perintah Uji</h2>
                    ...
                    <table class="form_tabel">
                         <tr><td class="td_left">Tanggal Terima Sampel</td><td class="td_right"><b><?php echo $sess['TANGGAL_TERIMA']; ?></b></td></tr>
                    	<tr><td class="td_left">Nomor Surat Permintaan Uji</td><td class="td_right">
						<?php
						 ...
						 ?>
						<b><?php echo $no_spu; ?></b></td></tr>
                        <tr><td class="td_left">Tanggal Surat Perintah Uji</td><td class="td_right"><input type="text" class="sdate" title="Tanggal Surat Perintah Uji" rel="required" name="PERINTAH_UJI[TANGGAL_PERINTAH]" /></td></tr>
                        
                        <tr><td class="td_left petugas">Ditujukan Kepada</td><td class="td_right"><input type="text" class="stext operator"  url="<?php echo site_url(); ?>/autocompletes/autocomplete/get_petugas_pengujian/4/<?php echo $sess['SPU_GENERATE']; ?>" title="Ketikan Nama Manager Teknis, kemudian tekan enter" /></td></tr>
