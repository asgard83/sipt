            ...
            <table class="tabelajax">
			 ...
			 for($i=0; $i<$jml; $i++){
              ...
              <tr ke="<?php echo $i; ?>">
                ...
                <td class="tdparams" ke="<?php echo $i; ?>">
                <div class="pane-params" id="pane-param<?php echo $i; ?>">
                <input type="text" style="height:20px;" class="stext paramuji" title="Ketik nama parameter uji, kemudian tekan enter untuk menambahkan parameter uji" id="<?php echo $arr[$i]['KATEGORI']; ?>" url="<?php echo site_url(); ?>/autocompletes/autocomplete/get_jenis_pengujian/<?php echo $arr[$i]['KATEGORI']; ?>" rel="required" ke="<?php echo $i; ?>" spl="<?php echo $arr[$i]['KODE_SAMPEL']; ?>"/>&nbsp;<a href="#" class="addparams"><img src="<?php echo base_url(); ?>images/add.png" align="top" style="border:none" /></a>
                	<div>
                	</div>
                </div>
                </td>
                <td><input type="text" style="height:20px;" class="stext operator" rel="required" url="<?php echo site_url(); ?>/autocompletes/autocomplete/get_petugas_pengujian/3/<?php echo $spuid; ?>" title="Ketikan Nama Penyelia, kemudian tekan enter" />
                  <input type="hidden" id="ippetugas-<?php echo $i; ?>" name="USER_ID[]" /></td>
                <?php
				 $no++;
			 }
			 ?>
