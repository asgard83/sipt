              ...
              <tr>
                ...
                <td class="td_right"><?php
						  if($kode_sampel == ""){
							  ...
							  echo "<b>".$sess['KO']."</b><input type=\"hidden\" name=\"KOMODITI[]\" value=\"".$sess['KOMODITI']."\">";
						  }
						  ?></td>
              </tr>
              <tr>
	...
	$("#tujuan_sampling").change(function(){
		...
		if(kunci != "01" && kunci != "02"){
			...
			if(komoditi == "10" || komoditi == "11" || komoditi == "12"){
				...
				$.get('<?php echo site_url().'/autocompletes/autocomplete/get_kategori/'; ?>' + komoditi + '/' + kunci, function(hasil){
					var hasil = hasil.replace(' ', '');
					var jum = hasil.length;
					if(jum == 0 || kunci == 00){
						$('#tdanak2').hide();
