            ...
            <div class="collapse">
                <div class="accCntnt">
					...
					<table class="form_tabel">
						...
						<tr><td class="td_left">Anggaran</td><td class="td_right"><?php echo $row[0]['UR_ANGGARAN']; ?></td></tr>
						<tr><td class="td_left">Asal Sampel</td><td class="td_right"><?php echo $row[0]['UR_ASAL_SAMPEL']; ?></td></tr>
						<tr><td class="td_left">Bulan Anggaran</td><td class="td_right"><?php echo $row[0]['BULAN_ANGGARAN']; ?></td></tr>
					</table>
