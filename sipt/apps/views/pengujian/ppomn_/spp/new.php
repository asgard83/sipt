    ...
    <div class="acco2">
      ...
      <div class="accCntnt">
        ...
        <form name="fspp" id="fspp" method="post" action="<?php echo $act; ?>" autocomplete="off">
          ...
          <div> 
            <!-- <table class="listtemuan tablesorter" width="100%" id="list-sampel"> !-->
          ...
          <table class="listtemuan" width="100%" id="draft-spl">
            <thead>
              <tr>
                <th width="80">Kode Sampel</th>
          ...
          <h2 class="small"><a href="#" url="<?php echo site_url(); ?>/get/pengujian/log_spu/<?php echo $nospu; ?>" onclick="expand_detail($(this), 'divhistory_spu'); return false;" id="history_spu">Detail Log SPU (
            <?= $logspu; ?>
            )</a></h2>
          <div id="divhistory_spu"></div>
