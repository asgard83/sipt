...
<div class="content">
    <div class="adCntnr">
    	<div class="acco2">
            <div class="expand"><a title="expand/collapse" href="#" style="display: block;">INFORMASI SURAT TUGAS</a></div>
                <div class="accCntnt">
                  <h2 class="small garis">Informasi</h2>
                    <table class="form_tabel">
                        ...
                        <tr><td class="td_left">Anggaran Sampling</td><td class="td_right"><?php echo $anggaran_sampling; ?></td></tr>
                        <tr><td class="td_left">Bulan Anggaran</td><td class="td_right"><?php echo $bulan_anggaran; ?></td></tr>
            ...
            <div class="expand"><a title="expand/collapse" href="#" style="display: block;">DATA SAMPEL</a></div>
            <div class="accCntnt">
        	...
        	<div class="expand"><a title="expand/collapse" href="#" style="display: block;">FORM DATA SAMPEL</a></div>
                <div class="accCntnt">
                  <h2 class="small garis">Data sampel Baru</h2>
                  <form name="fnewsampel" id="fnewsampel" method="post" action="<?php echo $act; ?>" autocomplete="off">
                    ...
                    <input type="hidden" name="periksa" value="<?php echo $periksa; ?>" />
