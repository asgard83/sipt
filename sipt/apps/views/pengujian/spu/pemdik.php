        ...
        <form name="fkirim_sampel" id="fkirim_sampel" method="post" action="<?php echo site_url(); ?>/post/spu/set_spu/save" autocomplete="off">
          <table class="form_tabel">
            <tr>
              ...
              <td class="td_right"><input type="text" name="PERMINTAAN_UJI[TANGGAL]" class="sdate" rel="required" /></td>
            </tr>
            <tr>
              <td class="td_left">Komoditi</td>
              <td class="td_right"><?php echo $sess[0]['KLASIFIKASIS']; ?></td>
            </tr>
            <tr>
              <td class="td_left">Anggaran</td>
              <td class="td_right"><?php echo $sess[0]['ANGGARANS']; ?></td>
            </tr>
            <tr>
              <td class="td_left">Asal Sampling</td>
              <td class="td_right"><?php echo $sess[0]['ASAL']; ?></td>
            </tr>
            <tr>
              <td class="td_left">Bulan Anggaran</td>
              <td class="td_right"><?php echo $sess[0]['BULAN']; ?></td>
            </tr>
          </table>
