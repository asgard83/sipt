...
<div class="content">
            ...
            <div id="contparameter" style="display:none;">
              ...
              <table class="form_tabel" id="tbparamater">
                <tr>
                  ...
                  <td class="td_right"><b><?php echo $sess['TANGGAL_SPK']; ?></b><input type="hidden" name="TANGGAL_SPK" value="<?php echo $sess['TANGGAL_SPK']; ?>"</td>
                  <td colspan="3">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="td_right"><input type="text" id="rlingkup" class="stext" title="Ruang Lingkup" readonly /></td>
                  <td></td>
  ...
  <div style="height:10px;">&nbsp;</div>
  <div style="padding-left:5px;"> <a id="btn-proses" style="display:none;" href="#" class="button check" onclick="fpost('#fnewparam','',''); return false;"><span><span class="icon"></span>&nbsp; Proses Ulang SPK &nbsp;</span></a> &nbsp;<a href="#" class="button reload" onclick="window.history.back(); return false;"><span><span class="icon"></span>&nbsp; Batal &nbsp;</span></a></div>
  <div style="height:10px;">&nbsp;</div>
</div>
	...
	$(document).ready(function(e){
		...
		$("#chk-parameter").change(function(){
			if($(this).attr("checked")){
				...
				$("#fnewparam").attr("action", "<?php echo site_url().'/post/spk/spk_act/add-params'; ?>");
