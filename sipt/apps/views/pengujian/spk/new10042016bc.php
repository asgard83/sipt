...
<div class="content">
        ...
        <div class="collapse">
			<?php if($sampel[0]['KOMODITI'] == "01"){ ?>
					<script>
						...
						$(document).ready(function(e){
							if('<?= $param['val']['0'] ?>' == '-'){
								...
								for(var val2 in myArr[val]){
									...
									text += '<td><input type="text" value="'+myPus[val][val2]+'" id="pustaka-'+val+'-'+val2+'"></td></tr>';
						...
						function chkuji(){
							...
							for(var val2 in myArr[val]){
								...
								text += '<td><input type="text" id="pustaka-'+val+'-'+val2+'"></td></tr>';
								//text += '<td width="75"><input type="button" value="Tambahkan" onclick="lstuji('+val+', '+val2+');"></td></tr>';
							}
							text += '';
							document.getElementById("uji").innerHTML = text;
							...
							if($("#chkex-"+val+"").val() != "" && $("#chkex-"+val+"").val() != undefined){
								...
								for(var val2 in myArr[val]){
									if($("#metode-"+val+"-"+val2).val() == "" || $("#syarat-"+val+"-"+val2).val() == "" || $("#pustaka-"+val+"-"+val2).val() == ""){
										...
										text2 += '<td> <input type="checkbox" class="justifikasi" name="chkdt['+val+'-'+val2+']" value=1 checked onchange="justifikasi(); return false;"></td>';
										text2 += '</tr>';
										ochk = "1";
									}
								}
					...
					<div class="accCntnt">
						...
						<table class="listtemuan" width="100%" border=0>
						<tr>
						...
						<h2 class="small garis">Daftar Penentuan Parameter Hasil Uji</h2>
                        ...
                        <div style="height:5px;">&nbsp;</div>
                        <table class="form_tabel catatan-justifikasi">
                        <tr>
  ...
  <div style="padding-left:5px;">
    ...
    <tr>
      ...
      <p><b>Keterangan : Sampling Surveilance Obat Kategori D2</b></p>
      <p><input type="checkbox" id="chksurveilance">&nbsp;<b>Silahkan checklist untuk menandai sampel yang dikirimkan ke Ditwas Distribusi dikarenakan sampel tidak mencukupi, atau sampel cukup tetapi MA tidak ada dan atau Baku Banding Tidak ada</b></p>
      </div>
      </td>
    </tr>
    <tr>
    	<td class="td_left bold">Catatan</td>
        <td class="td_right"><textarea class="stext catatan" name="catatan" title="Catatan sampel Obat Kategori D2"></textarea></td>
    </tr>
    </table>
    <div style="height:5px;">&nbsp;</div>
    <?php
