...
<div class="headersarana">PENGAWASAN IKLAN PANGAN IRT</div>
<?php
           ...
           <tbody id="tb_pangan">
            ...
            do {
             ...
             <tr class="urut<?php echo $i; ?>">
              ...
              <td>
               <input type="text" size="50" name="PRODUK[NAMA][]" class="namaPangan" id="namaPangan" title="Nama Pangan" rel="required" value="<?php echo $sess2[$i]['NAMA_PRODUK']; ?>" />&nbsp;
               <?php
               if ($i == 0) {
                ?>
             ...
             <tr class="urut<?php echo $i; ?>">
              ...
              <td><input type="text" size="50" name="PRODUK[MERK_PRODUK][]" id="merkDagang" title="Merk Dagang" rel="required" value="<?php echo $sess2[$i]['MERK_PRODUK']; ?>" />
              </td>
             </tr>
             <tr class="urut<?php echo $i; ?>">
              <td width="150">Nama Pemilik Izin Edar</td>
              <td><input type="text" size="50" name="PRODUK[NAMAPEMILIKIZINEDAR][]" id="namaPemilikNIE" rel="required" title="Pemilik Izin Edar" value="<?php echo $sess2[$i]['NAMA_PEMILIK_IZIN_EDAR']; ?>" />
              </td>
             </tr>
             <tr class="urut<?php echo $i; ?>">
              <td width="150">Nomor Izin Edar</td>
              <td><input type="text" size="50" name="PRODUK[NOMORIZINEDAR][]" id="NIE" title="Nomor Izin Edar" rel="required" value="<?php echo $sess2[$i]['NOMOR_IZIN_EDAR']; ?>" />
              </td>
             </tr>
             <tr class="urut<?php echo $i; ?>">
              <td width="150">Alamat Pemilik Izin Edar</td>
              <td><textarea name="PRODUK[ALAMAT_PEMILIK_IZIN_EDAR][]" style="width: 314px;" id="" title="Alamat Pemilik Izin Edar" rel="required"><?php echo $sess2[$i]['ALAMAT_PEMILIK_IZIN_EDAR']; ?></textarea>
              </td>
             </tr>
             <?php
             $i++;
        ...
        <tr>
         <td class="td_left_checklist" colspan="5" style="margin-right: 200px">
          ...
          if (array_key_exists('FILE_IKLAN', $sess) && trim($sess['FILE_IKLAN']) != "") {
           ?><input type="hidden" name="IKLAN_PANGAN[FILE_IKLAN]" value="<?php echo $sess['FILE_IKLAN']; ?>">
           <span class="file_FILE_IKLAN"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_013/irt'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" url="<?php echo site_url(); ?>/utility/uploads/del_upload/<?php echo 'iklan_013/irt'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" jns="FILE_IKLAN">Edit atau Hapus File ?</a></span>
           <span class="upload_FILE_IKLAN" hidden><input type="file" class="upload_FILE_IKLAN" jenis="FILE_IKLAN" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_013/irt'; ?>" id="fileToUpload_FILE_IKLAN" name="userfile" onchange="do_upload($(this));
            return false;" title="Lampiran" />
            &nbsp;Tipe File : *.jpg .jpeg .pdf .doc .docx .rar</span><span class="file_FILE_IKLAN"></span>
           <?php
          } else {
           ?>
           <span class="upload_FILE_IKLAN"><input type="file" class="upload" jenis="FILE_IKLAN" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_013/irt'; ?>" id="fileToUpload_FILE_IKLAN" name="userfile" onchange="do_upload($(this));
            return false;" title="Lampiran"/>
            &nbsp;Tipe File : *.jpg .jpeg .pdf .doc .docx .rar</span><span class="file_FILE_IKLAN"></span>
           <?php
          }
...
//    $("#namaMediaIklan").unautocomplete();
          ...
          function showHide() {
           ...
           var golonganPangan = $('#golonganPangan').val();
...
<?php } ?>
           ...
           $('.addnomor').click(function() {
            ...
            $("#tb_pangan").append('<tr class= "' + cls + '"><td>&nbsp;</td></tr><tr class= "' + cls + '"><td width="150">Nama Pangan</td><td><input type="text" size="50" name="PRODUK[NAMA][]" class="namaPangan' + cls + '" id="namaPangan" title="Nama Pangan" rel="required" /><a href="javascript:void(0)" class="min" id="minCls' + cls + '" ><img src="<?php echo base_url(); ?>images/cancel.png" align="top" style="border:none" title="Hapus Pangan" /></a><input type="hidden" name="BBPOM[BBPOM_ID][]" id="bbpomid' + cls + '"><input type="hidden" name="BBPOM[MBBPOM_ID][]" id="mbbpomid' + cls + '"></td></tr><tr class= "' + cls + '"><td width="150">Merk Dagang</td><td><input type="text" size="50" name="PRODUK[MERK_PRODUK][]" id="merkDagang" title="Merk Dagang" rel="required" /></td></tr><tr class= "' + cls + '"><td width="150">Nama Pemilik Izin Edar</td><td><input type="text" size="50" name="PRODUK[NAMAPEMILIKIZINEDAR][]" id="namaPemilikNIE" rel="required" title="Pemilik Izin Edar" /></td></tr><tr class= "' + cls + '"><td width="150">Nomor Izin Edar</td><td><input type="text" size="50" name="PRODUK[NOMORIZINEDAR][]" id="NIE" title="Nomor Izin Edar" rel="required" /></td></tr><tr class= "' + cls + '"><textarea name="PRODUK[ALAMAT_PEMILIK_IZIN_EDAR][]" style="width: 314px;" id="" title="Alamat Pemilik Izin Edar" rel="required"></textarea></tr>')
