...
?>
<div class="content">
    <form action="<?php echo $act; ?>" method="post" autocomplete="off" id="fpengawasanIklan_011">
        <div class="adCntnr">
            <div class="acco2">
                ...
                <div class="acco2"><div class="expand"><a title="expand/collapse" href="#" style="display: block;">INFORMASI SUPLEMEN KESEHATAN - IKLAN</a></div>
                    <div class="collapse">
                        <div class="accCntnt">
                            <table>
                                <tr>
                                            ...
                                            <tbody id="tb_SM">
                                                ...
                                                do {
                                                    ...
                                                    <tr class="urut<?php echo $i; ?>">
                                                        <td width="150">Nama SM</td>
                                                        <td>
                                                            <input type="text" size="40" name="PRODUK[NAMA][]" class="namaSM" id="namaSM" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg_2/" title="Nama SM" rel="required" value="<?php echo $sess2[$i]['NAMA_PRODUK']; ?>" />&nbsp;
                                                            <?php
                                                            if ($i == 0) {
                                                                ?>
                                                                <a href="javascript:void(0)" class="addnomor" periksa="urut" terakhir="<?php echo $jmldata; ?>"><img src="<?php echo base_url(); ?>images/add.png" align="absmiddle" style="border:none" title="Tambah SM" /></a>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <a href="javascript:void(0)" class="min" onclick="$('.urut<?php echo $i; ?>').remove();"><img src="<?php echo base_url(); ?>images/cancel.png" align="absmiddle" style="border:none" title="Hapus SM" /></a>
                                                                <?php
                                                            }
                                                            ?></td>
                                                    </tr>
                                                    <tr class="urut<?php echo $i; ?>">
                                                        ...
                                                        <td><input type="text" size="40" name="PRODUK[BENTUKSEDIAAN][]" id="bentukSediaan" title="Pemilik Izin Edar" value="<?php echo $sess2[$i]['BENTUK_SEDIAAN']; ?>" />
                                                        </td>
                                                    </tr>
                                                    <tr class="urut<?php echo $i; ?>">
                                                    ...
                                                    <tr class="urut<?php echo $i; ?>">
                                                        <td>Kategori Produk</td><td>
                                                            <?php echo form_dropdown('PRODUK[JENIS][]', $jenisProduk, $sess2[$i]['JENIS_PRODUK'], 'title="Golongan SM" class="stext" rel="required"') ?>
                                                        </td>
                                                    </tr><?php
                        ...
                        <div class="accCntnt">
                            <table class="form_tabel_detail">
                                ...
                                <tr id="tglTerbit">
                                    ...
                                    <td></td>
                                    <td style="width: 10%;" class="td_left" colspan="2"><input type="text" class="sdate" name="IKLAN[TANGGAL]" id="tglTugas" title="Tanggal Penerbitan / Tanggal Penayangan" onchange="comp('C')" rel="required" value="<?php echo $sess['TANGGAL']; ?>"/>&nbsp;&nbsp;
                                </tr>
                        ...
                        <div class="accCntnt" id="expand4a">
                            <table class="form_tabel_detail">
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td style="width: 10%;" colspan="2" class="td_left_checklist"><textarea style="width: 98%; height: 75px;" class="stext" title="Narasi / Klaim Iklan" name="IKLANSM[NARASI]" rel="required"><?php echo $sess['NARASI']; ?></textarea></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="collapse">
                        <div class="accCntnt">
                            <table class="form_tabel_detail">
                                ...
                                if (!in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))) {
                                    ?>
                                    <tr class="TDKB" hidden><td class="td_left_checklist"></td><td class="td_left">Tindak Lanjut Balai</td><td></td><td class="td_right"><?php echo form_dropdown('IKLAN[TL_BALAI]', $cb_tindakan_balai, $sess['TL_BALAI'], 'class="stext" id="tDKBalai" title="Tindak Lanjut Pusat"'); ?></td></tr>
                                    <tr class="tDKBalaiRow" hidden><td class="td_left_checklist"></td><td class="td_left"></td><td></td><td class="td_right"><input type="text" class="tDKBalaiRow" id="jmlMusnah" title="Jumlah" placeholder = "Jumlah" maxlength="5" size="5" value="<?php echo $pemusnahan[0] ?>"/>&nbsp;<input type="text" class="tDKBalaiRow" id="satuanMusnah" title="Satuan" placeholder = "Satuan" size="10" value="<?php echo $pemusnahan[1] ?>"/>&nbsp;
                                            ...
                                            if ((array_key_exists('FILE_MUSNAH', $sess) && trim($sess['FILE_MUSNAH']) != "")) {
                                                ...
                                                <span id="file_FILE_MUSNAH"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" id = "del_upload1" url="<?php echo site_url(); ?>/utility/uploads/del_upload_m/<?php echo 'iklan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" jns="FILE_MUSNAH">Edit atau Hapus File ?</a></span>
                                                <span class="upload_FILE_MUSNAH" hidden><input type="file" class="uploadMusnahBalai tDKBalaiRow" jenis="FILE_MUSNAH" allowed="doc-docx-pdf-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_011/2_011'; ?>" id="fileToUpload_FILE_MUSNAH" name="userfile" onchange="do_upload($(this));
                                                    return false;" title="Lampiran Berita Acara" />
                                                    &nbsp;Tipe File : *.doc .docx .pdf .rar</span><span class="file_FILE_MUSNAH"></span>
                                                <?php
                                            } else {
                                                ?>
                                                <span class="upload_FILE_MUSNAH"><input type="file" class="uploadMusnahBalai tDKBalaiRow" jenis="FILE_MUSNAH" allowed="doc-docx-pdf-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_011/2_011'; ?>" id="fileToUpload_FILE_MUSNAH" name="userfile" onchange="do_upload($(this));
                                                    return false;" title="Lampiran Berita Acara" />
                                                    &nbsp;Tipe File : *.doc .docx .pdf .rar</span><span class="file_FILE_MUSNAH"></span>
                                                <?php
                                            }
                                    ...
                                    if (in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))) {
                                        ...
                                        <tr class="vTMK2" hidden><td class="td_left_checklist"></td><td class="td_left"></td><td></td><td class="td_right">
                                                ...
                                                if ((array_key_exists('FILE_MUSNAH_PUSAT', $sess) && trim($sess['FILE_MUSNAH_PUSAT']) != "")) {
                                                    ...
                                                    <span id="file_FILE_MUSNAH_PUSAT"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH_PUSAT']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" id="del_upload2" url="<?php echo site_url(); ?>/utility/uploads/del_upload_m/<?php echo 'iklan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH_PUSAT']; ?>" jns="FILE_MUSNAH_PUSAT">Edit atau Hapus File ?</a></span>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <span class="upload_FILE_MUSNAH_PUSAT"><input type="file" class="uploadMusnahPusat" jenis="FILE_MUSNAH_PUSAT" allowed="doc-docx-pdf-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_011/2_011'; ?>"  id="fileToUpload_FILE_MUSNAH_PUSAT" name="userfile" onchange="do_upload($(this));
                                                        return false;" />
...
//             echo 'Tidak Dapat Tindak Lanjut'
                                                ?></td></tr>-->
                                                <tr><td class="td_left">Tindak Lanjut Pusat</td><td class="td_right"><ul style="list-style-type:decimal; padding-left:20px; margin:0;"><?php
                                                            $temp = array($hasilKesimpulanOpt[2], $hasilKesimpulanOpt[3], $hasilKesimpulanOpt[4], $hasilKesimpulanOpt[5]);
                                                            if (count($temp) > 1)
                                                                echo "<li>" . join("</li><li>", $temp) . "</li>";
                                                            else
                                                                echo "<li>" . $temp . "</li>";
                                                            ?></ul></td></tr><?php if ($hasil[1] != NULL) { ?>
                                                    <tr><td class="td_left">Surat Tindak Lanjut</td><td class="td_right"><ul style="list-style-type:decimal; padding-left:20px; margin:0;"><?php
                                ...
                                <tr>
                                    <td class="td_left_checklist" colspan="5" style="margin-right: 200px">
                                        ...
                                        if (array_key_exists('FILE_IKLAN', $sess) && trim($sess['FILE_IKLAN']) != "") {
                                            ?><input type="hidden" name="IKLAN_SM[FILE_IKLAN]" value="<?php echo $sess['FILE_IKLAN']; ?>">
                                            <span id="file_FILE_IKLAN"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_011'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" url="<?php echo site_url(); ?>/utility/uploads/del_upload/<?php echo 'Iklan SM'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" jns="FILE_IKLAN">Edit atau Hapus File ?</a></span>
                                            <span class="upload_FILE_IKLAN" hidden><input type="file" class="upload_FILE_IKLAN" jenis="FILE_IKLAN" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_s/<?php echo 'iklan_011'; ?>" id="fileToUpload_FILE_IKLAN" name="userfile" onchange="do_upload($(this));
                                            ...
                                            ?>
                                            <span class="upload_FILE_IKLAN"><input type="file" class="upload" jenis="FILE_IKLAN" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_s/<?php echo 'iklan_011'; ?>" id="fileToUpload_FILE_IKLAN" name="userfile" onchange="do_upload($(this));
                ...
                <div style="padding:10px;"></div><div><a href="javascript:void(0)" id="btnSave" class="button <?php echo $icon; ?>" onclick="fpost('#fpengawasanIklan_011', '', '');">
...
<?php } ?>
                                            ...
                                            $("input.namaSM").autocomplete($("input.namaSM").attr("url") + 'pk', {width: 244, selectFirst: false});
                                            $("input.namaSM").result(function(event, data, formatted) {
                                                if (data) {
                                                    $(this).val(data[1]);
...
<?php if (in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))) { ?>
                                                    apd = '<tr class= "' + cls + '"><td>&nbsp;</td></tr><tr class= "' + cls + '"><td width="150">Nama SM</td><td><input type="text" size="40" name="PRODUK[NAMA][]" class="namaSM' + cls + '" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg_2/" title="Nama SM" rel="required" >&nbsp;&nbsp;<a href="javascript:void(0)" class="min" id="minCls' + cls + '" ><img src="<?php echo base_url(); ?>images/cancel.png" align="top" style="border:none" title="Hapus SM" /></a><input type="hidden" name="BBPOM[BBPOM_ID][]" id="bbpomid' + cls + '"><input type="hidden" name="BBPOM[MBBPOM_ID][]" id="mbbpomid' + cls + '"></td></tr><tr class= "' + cls + '"><td width="150">Bentuk Sediaan</td><td><input type="text" size="40" name="PRODUK[BENTUKSEDIAAN][]" id="bentukSediaan' + cls + '" title="Bentuk Sediaan"/></td></tr><tr class= "' + cls + '"><td width="150">Nama Pemilik Izin Edar</td><td><input type="text" size="40" name="PRODUK[NAMAPEMILIKIZINEDAR][]" id="namaPemilikNIE' + cls + '" title="Pemilik Izin Edar"/></td></tr><tr class= "' + cls + '"><td width="150">Nomor Izin Edar</td><td><input type="text" size="40" name="PRODUK[NOMORIZINEDAR][]" id="NIE' + cls + '" title="Nomor Izin Edar" rel="required"/></td></tr><tr class= "' + cls + '"><td width="150">Kategori Produk</td><td><select name="PRODUK[JENIS][]" title="Golongan SM" class="stext" rel="required"><option value="" selected="selected"></option><option value="001">Golongan daya tahan tubuh</option><option value="002">Golongan energy drink</option><option value="003">Golongan kesehatan mata</option><option value="004">Golongan makanan pelengkap (food supplement) dan mineral</option><option value="005">Golongan nutrisi otak</option><option value="006">Golongan persendian</option><option value="007">Golongan vitamin</option</select></td></tr><tr class= "' + cls + '"><td>Evaluasi Premarket</td><td><select name="PRODUK[MERK_PRODUK][]" title="Evaluasi Premarket" rel="required" id="chkEvaluasi' + cls + '"><option value="" selected></option><option value="0">Iklan sudah dipre-review</option><option value="1">Iklan belum dipre-review</option></select></td></tr>';
<?php } else { ?>
                                                    apd = '<tr class= "' + cls + '"><td>&nbsp;</td></tr><tr class= "' + cls + '"><td width="150">Nama SM</td><td><input type="text" size="40" name="PRODUK[NAMA][]" class="namaSM' + cls + '" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg_2/" title="Nama SM" rel="required" >&nbsp;&nbsp;<a href="javascript:void(0)" class="min" id="minCls' + cls + '" ><img src="<?php echo base_url(); ?>images/cancel.png" align="top" style="border:none" title="Hapus SM" /></a><input type="hidden" name="BBPOM[BBPOM_ID][]" id="bbpomid' + cls + '"><input type="hidden" name="BBPOM[MBBPOM_ID][]" id="mbbpomid' + cls + '"></td></tr><tr class= "' + cls + '"><td width="150">Bentuk Sediaan</td><td><input type="text" size="40" name="PRODUK[BENTUKSEDIAAN][]" id="bentukSediaan' + cls + '" title="Bentuk Sediaan"/></td></tr><tr class= "' + cls + '"><td width="150">Nama Pemilik Izin Edar</td><td><input type="text" size="40" name="PRODUK[NAMAPEMILIKIZINEDAR][]" id="namaPemilikNIE' + cls + '" title="Pemilik Izin Edar"/></td></tr><tr class= "' + cls + '"><td width="150">Nomor Izin Edar</td><td><input type="text" size="40" name="PRODUK[NOMORIZINEDAR][]" id="NIE' + cls + '" title="Nomor Izin Edar" rel="required"/></td></tr><tr class= "' + cls + '"><td width="150">Kategori Produk</td><td><select name="PRODUK[JENIS][]" title="Golongan SM" class="stext" rel="required"><option value="" selected="selected"></option><option value="001">Golongan daya tahan tubuh</option><option value="002">Golongan energy drink</option><option value="003">Golongan kesehatan mata</option><option value="004">Golongan makanan pelengkap (food supplement) dan mineral</option><option value="005">Golongan nutrisi otak</option><option value="006">Golongan persendian</option><option value="007">Golongan vitamin</option</select></td></tr>';
<?php } ?>
                                                $("#tb_SM").append(apd);
                                                $(this).attr('terakhir', parseInt(nom) + 1);
                                                $("input.namaSM" + cls).autocomplete($("input.namaSM").attr("url") + 'pk', {width: 244, selectFirst: false});
                                                $("#minCls" + cls).click(function() {
                                                    $("#uraianPenilaian1").val('');
                                                    $(".infoTambahan").attr('checked', false);
                                                    $('.' + cls).remove();
                                                });
                                                $("input.namaSM" + cls).result(function(event, data, formatted) {
                                                    if (data) {
                                                        var golonganSM = data[2].substring(2, 1);
                                                        $(this).val(data[1]);
                                                        $("#namaPemilikNIE" + cls).val(data[3]);
                                                        $("#bentukSediaan" + cls).val(data[9]);
                                                        $("#NIE" + cls).val(data[2]);
                                                        $("#golonganSM" + cls).val(golonganSM);
