...
<div class="content">
	...
	<form action="<?php echo $act; ?>" autocomplete="off" method="post" id="rekapStatus">
		...
		<tr><td class="td_left">Periode Awal Pengawasan</td><td class="td_right"><input type="text" class="sdate" name="AWAL" id="tglAwalPengawasan<?php echo $i; ?>" title="Tanggal Pengawasan Iklan" onchange="comp('A')" rel='required'/></tr>
		<tr><td class="td_left">Periode Akhir Pengawasan</td><td class="td_right"><input type="text" class="sdate" name="AKHIR" id="tglAkhirPengawasan<?php echo $i; ?>" title="Tanggal Pengawasan Iklan" onchange="comp('B')" rel='required'/></td></tr>
