 ...
 <form action="<?php echo $act; ?>" method="post" autocomplete="off" id="fpengawasanIklan_001">
  <div class="adCntnr">
   <div class="acco2">
      ...
      <div class="accCntnt">
       <table class="form_tabel">
        ...
        foreach ($tercantum as $value) {
         if ($value[1] != "Ditujukan Kepada Umum") {
          if ($value[1] != "") {
           ?>
           <tr>
            <td class="td_left"><?php echo $value[1]; ?></td>
    ...
    <!--5-->
    <?php if (($sess['URAIAN_PELANGGARAN'] != NULL && trim($sess['URAIAN_PELANGGARAN']) != "") || trim($tercantumTambahan) != "") { ?>
     ...
     <div class="collapse">
      <div class="accCntnt">
       ...
       <table class="form_tabel">
        ...
        } if ($tercantumTambahan != '') {
         if ($tercantumTambahan == "+")
          echo '<tr><td class="td_left"><b>Ditujukan Kepada Umum</b></td><td class="td_right">Ya</td></tr>';
         else
          echo '<tr><td class="td_left"><b>Ditujukan Kepada Umum</b></td><td class="td_right">Tidak</td></tr>';
        }
        ?>
       </table>
      </div>
         ...
         if ($sess['HASIL_PUSAT'] == "TMK") {
          ...
          <?php if ($hasilKesimpulanOpt[1] != NULL) { ?><tr><td class="td_left">Tindak Lanjut Pusat</td><td class="td_right"><?php
           if ($hasilKesimpulanOpt[1] == 'TL')
            ...
            <tr><td class="td_left">Justifikasi Pusat</td><td class="td_right"><?php echo preg_replace('/(?:<|&lt;)\/?([a-zA-Z]+) *[^<\/]*?(?:>|&gt;)/', '', $sess['JUSTIFIKASI_PUSAT']) . "\n"; ?></td></tr>
            <?php
           }
          }
         } else {
          ...
          <tr><td class="td_left">Verifikasi Pusat</td><td class="td_right"><b><i><?php
              if ($sess['HASIL_PUSAT'] == 'MK')
               ...
               echo 'Tidak Memenuhi Ketentuan';
              ?></i></b></td></tr>
          <tr><td class="td_left">Kategori MK</td><td class="td_right"><?php echo $hasilKesimpulanOpt[0]; ?></td></tr>
    ...
    <?php if ($sess['FILE_IKLAN'] != '') { ?>
     ...
     <div class="collapse">
      <div class="accCntnt">
       <table class="form_tabel">
        <tr><td class="td_left">Lampiran</td><td class="td_right"><a href="<?php echo site_url(); ?>/download/penandaanIklanNoDirPostUpload/<?php echo 'iklan_001'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" target="_blank">Lihat Lampiran</a></td></tr>
       </table>
      </div>
     </div>
     <div style="height:5px;"></div>
...
<?php if (in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit')) || $this->newsession->userdata("SESS_BBPOM_ID") === "00") {
 ?>
          verifikasiPusat($('.verifikasiPusat'));
<?php } ?>
