...
<div class="headersarana">PENGAWASAN IKLAN OT</div>
<?php
 ...
 <form action="<?php echo $act; ?>" method="post" autocomplete="off" id="fpengawasanIklan_010">
  <div class="adCntnr">
   <div class="acco2">
    ...
    <div style="height:5px;"></div><div class="expand"><a title="expand/collapse" href="#" style="display: block;">INFORMASI OT - IKLAN</a></div>
    <div class="collapse">
     <div class="accCntnt">
      <?php echo $sess2; ?>
     </div>
    ...
    <?php if (array_filter($UP)) { ?>
     ...
     <div class="collapse">
      <div class="accCntnt">
       ...
       <table class="form_tabel">
        <?php
        $arrUraianOt = $this->config->item("uraian_iklan_ot");
        foreach ($UP as $value) {
         if (trim($value) != "")
          echo '<tr><td class="td_left" colspan="4">' . $arrUraianOt[$value] . '</td></tr>';
        }
        ?>
       </table>
      </div>
       ...
       <table class="form_tabel">
        <tr><td class="td_left"><?php
          if (!in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit')))
           ...
           echo 'Hasil Penilaian';
          else if (in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit')) && in_array($asalData, $this->newsession->userdata('SESS_BBPOM_ID')))
         ...
         if (trim($sess["TL_BALAI"]) != "" && $sess["TL_BALAI"] != NULL) {
          ?>
         <tr><td class="td_left">Tindak Lanjut Balai</td><td class="td_right"><?php echo $cb_tindakan_balai[$sess["TL_BALAI"]]; ?></td></tr>
         <?php if ($sess["TL_BALAI"] == "Pemusnahan") { ?>
          <tr class="tDKBalaiRow"><td></td><td class="td_right"><input type="text" id="jmlMusnah" title="Jumlah" placeholder = "Jumlah" maxlength="5" size="5" readonly value="<?php echo $pemusnahan[0] ?>"/>&nbsp;<input type="text" id="satuanMusnah" title="Satuan" placeholder = "Satuan" size="10" readonly value="<?php echo $pemusnahan[1] ?>"/>&nbsp;
            <a href="<?php echo base_url(); ?>files/<?php echo 'iklan_010/2_010'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" target="_blank">Lihat Lampiran</a></td></tr>
          <?php
         }
        }
        if ((!$sess['HASIL_PUSAT'] && in_array('2', $this->newsession->userdata('SESS_KODE_ROLE'))) || $editTL == 'YES') {
         ...
         <tr class="vTMK2" hidden><td></td><td class="td_right">
           ...
           if ((array_key_exists('FILE_MUSNAH_PUSAT', $sess) && trim($sess['FILE_MUSNAH_PUSAT']) != "")) {
            ...
            <span id="file_FILE_MUSNAH_PUSAT"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_010/1_010'; ?>/<?php echo $sess['FILE_MUSNAH_PUSAT']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" id="del_upload2" url="<?php echo site_url(); ?>/utility/uploads/del_upload_m/<?php echo 'iklan_010/1_010'; ?>/<?php echo $sess['FILE_MUSNAH_PUSAT']; ?>" jns="FILE_MUSNAH_PUSAT">Edit atau Hapus File ?</a></span>
            <span class="upload_FILE_MUSNAH_PUSAT" hidden><input type="file" class="upload" jenis="FILE_MUSNAH_PUSAT" allowed="doc-docx-pdf" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_010/1_010'; ?>"  id="fileToUpload_FILE_MUSNAH_PUSAT" name="userfile" onchange="do_upload($(this));
                 return false;" />
             &nbsp;Tipe File : *.doc .docx.pdf</span><span class="file_FILE_MUSNAH_PUSAT"></span>
            <?php
           } else {
            ?>
            <span class="upload_FILE_MUSNAH_PUSAT"><input type="file" class="upload" jenis="FILE_MUSNAH_PUSAT" allowed="doc-docx-pdf" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'iklan_010/1_010'; ?>"  id="fileToUpload_FILE_MUSNAH_PUSAT" name="userfile" onchange="do_upload($(this));
                 return false;" />
             &nbsp;Tipe File : *.doc .docx.pdf</span><span class="file_FILE_MUSNAH_PUSAT"></span>
            <?php
           }
         ...
         if ($sess['HASIL_PUSAT'] == "TMK") {
          ...
          <tr><td class="td_left">Verifikasi Pusat</td><td class="td_right"><b><i><?php
              if ($sess['HASIL_PUSAT'] == 'MK')
               ...
               echo 'Tidak Memenuhi Ketentuan';
              ?></i></b></td></tr>
          <?php if ($sess['TL_PUSAT'] != NULL) { ?><tr><td class="td_left">Tindak Lanjut Pusat</td><td class="td_right"><?php
           echo $cb_tindakan2[$sess['TL_PUSAT']];
           ?></td></tr>
          ...
          <?php } if ($sess['PEMUSNAHANPUSAT'] != NULL && trim($sess['PEMUSNAHANPUSAT']) != '^') { ?>
           <tr><td></td><td class="td_right"><input type="text" title="Jumlah" placeholder = "Jumlah" maxlength="4" size="5" value="<?php echo $pemusnahanPusat[0] ?>"/>&nbsp;<input type="text" title="Satuan" placeholder = "Satuan" size="10" value="<?php echo $pemusnahanPusat[1] ?>"/>&nbsp;<a href="<?php echo base_url(); ?>files/<?php echo 'iklan_010/1_010'; ?>/<?php echo $sess['FILE_MUSNAH_PUSAT']; ?>" target="_blank">Lihat Lampiran</a></td></tr>
       ...
       <table class="form_tabel">
        ...
        if (trim($sess["TL_BALAI"]) != "" && $sess["TL_BALAI"] != NULL) {
         ...
         <?php if ($sess["TL_BALAI"] == "2") { ?>
          <tr><td></td><td class="td_right"><input type="text" id="jmlMusnah" title="Jumlah" placeholder = "Jumlah" maxlength="4" size="5" readonly value="<?php echo $pemusnahan[0] ?>"/>&nbsp;<input type="text"  id="satuanMusnah" title="Satuan" placeholder = "Satuan" size="10" readonly value="<?php echo $pemusnahan[1] ?>"/>&nbsp;
            <?php ?>
            <a href="<?php echo base_url(); ?>files/<?php echo 'iklan_010/2_010'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" target="_blank">Lihat Lampiran</a></td></tr>
          <?php
         }
    ...
    if ($sess['FILE_IKLAN'] != '') {
     ...
     <div class="collapse">
      <div class="accCntnt">
       <table class="form_tabel">
        <tr><td class="td_left">Lampiran</td><td class="td_right"><a href="<?php echo base_url(); ?>files/<?php echo 'iklan_010'; ?>/<?php echo $sess['FILE_IKLAN']; ?>" target="_blank" <?php if ($arrLamp[1] == "rar") echo 'onclick="dotRar();return false;"'; ?>>Lihat Lampiran</a></td></tr>
       </table>
      </div>
     </div>
     <div style="height:5px;"></div>
    ...
    <?php } ?>
    <div style="padding:10px;"></div><div><?php if ($formEdit === 'check') { ?><a href="javascript:void(0)" id="btnSave" class="button check" onclick="fpost('#fpengawasanIklan_010', '', '');">
