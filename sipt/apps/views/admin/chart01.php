...
google.load("visualization", "1", {packages:["corechart"]}); google.setOnLoadCallback(function(){setTimeout(function(){ $('#all').load(isUrl+'index.php/admin/utility/chart_pemeriksaan/all'); $.get(isUrl+'index.php/admin/utility/chart_pemeriksaan/week', function(hasil){ hasil = $.trim(hasil); drawChart(hasil, "week");}); $.get(isUrl+'index.php/admin/utility/chart_pemeriksaan/month', function(hasil){ hasil = $.trim(hasil); drawChart(hasil, "month");}); $.get(isUrl+'index.php/admin/utility/chart_pemeriksaan/year', function(hasil){ hasil = $.trim(hasil); drawChart(hasil, "year");}); jLoadingClose();}, 2000);});
