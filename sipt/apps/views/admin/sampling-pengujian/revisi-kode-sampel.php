<form action="<?php echo site_url(); ?>/utility/tools/revisi_nomor/first/sampel" id="frevisi-sampel" name="frevisi-sampel" method="post">
  <table class="form_tabel">
    <tr>
      <td class="td_left">Kode Sampel</td>
      <td class="td_right"><input type="text" class="stext" title="Masuk kode sampel yang akan di revisi" rel="required" name="KODE_SAMPEL" /></td>
    </tr>
  </table>
  <div style="padding-left:5px;" id="div-btn-reset"><a href="#" class="button download" id="btn-check" onclick="save_tools('#frevisi-sampel'); return false;"><span><span class="icon"></span>&nbsp; Check Data &nbsp;</span></a></div>
