        ...
        <div class="collapse">
          <div class="accCntnt">
            <table class="form_tabel">
              ...
              <tr <?php echo (strlen($sess['UR_KATEGORI']) > 1) ? '' : 'class="hideme"' ;?> id="tdanak1" ke="1">
                <td class="td_left">Sub Kategori</td>
                <td class="td_right"><?= $sess['UR_KATEGORI']; ?></td>
              </tr>
              <tr <?php echo strlen($sess['UR_SUB_KATEGORI']) > 1 ? '' : 'class="hideme"' ;?> id="tdanak2" ke="2">
                <td class="td_left">&nbsp;</td>
                <td class="td_right"><?= $sess['UR_SUB_KATEGORI']; ?></td>
              </tr>
              <tr <?php echo strlen($sess['UR_SUB_SUB_KATEGORI']) > 1 ? '' : 'class="hideme"' ;?> id="tdanak3" ke="3">
                <td class="td_left">&nbsp;</td>
                <td class="td_right"><?= $sess['UR_SUB_SUB_KATEGORI']; ?></td>
              </tr>
              <tr <?php echo strlen($sess['UR_SUB_SUB_SUB_KATEGORI']) > 1 ? '' : 'class="hideme"' ;?> id="tdanak4" ke="4">
                <td class="td_left">&nbsp;</td>
              ...
              <tr>
                ...
                <td class="td_right"><?= $sess['PRIORITAS']; ?></td>
              </tr>
              <tr>
                <td class="td_left">User Entri</td>
                <td class="td_right"><?= $sess['NAMA_USER']; ?></td>
              </tr>
              <tr>
                <td class="td_left">BBPOM / BPOM</td>
