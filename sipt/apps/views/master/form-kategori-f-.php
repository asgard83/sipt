					...
					$.get($this.attr("data-url") + $this.val(), function($data){
						if($data){
							...
							if($this.val().length == 6){
								if($this.val() == '011002'){
									$next.children().first().html('Sub Sub Kategori');
									$input.children().children().attr("placeholder", "Sub Sub Kategori Baru");
								}else if($this.val() == '011003'){
									$next.children().first().html('Zat Aktif');
									$input.children().children().attr("placeholder", "Zat Aktif Baru");
								}
							}
							else if($this.val().length == 8){
								if($this.val() == '01100211'){
									$parent.children().first().html('Sub Sub Kategori');
									$next.children().first().html('Jenis Alkes');
									$input.children().children().attr("placeholder", "Jenis ALKES Baru");
								}else if($this.val() == '01100212'){
									$parent.children().first().html('Sub Sub Kategori');
									$next.children().first().html('Jenis PKRT');
									$input.children().children().attr("placeholder", "Jenis PKRT Baru");
								}else{
