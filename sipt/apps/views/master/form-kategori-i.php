          ...
          <div class="accCntnt">
            <table class="form_tabel">
              ...
              <tr id="cbpanel-kategori" data-target = "#cbpanel-sub-kategori" data-position="1">
                ...
                <td class="td_right"><?= form_dropdown('KLASIFIKASI_ID[]',$cbkategori,'','class="select-kategori stext" style="width:100%;" id="kategori" data-url = "'.site_url().'/get/kategori/ac_kategori/" title ="Zat Aktif"', array("011001")); ?></td>
              </tr>
              <tr class="trcb" id="cbpanel-sub-kategori" data-target = "#cbpanel-sub-sub-kategori" style="display:none;" data-before="#cbpanel-sub-sub-kategori" data-position="2">
                ...
                <td class="td_right"><?= form_dropdown('','','','class="select-kategori stext" style="width:100%;" id="sub-kategori"; data-url = "'.site_url().'/get/kategori/ac_kategori/" title="Bentuk Sediaan" data-new="1"'); ?></td>
              </tr>
              <tr class="trcb" id="cbpanel-sub-sub-kategori" data-target = "#cbpanel-sub-sub-sub-kategori" style="display:none;" data-before = "#cbpanel-sub-sub-kategori" data-position="3">
                <td class="td_left bold"></td>
                <td class="td_right"><?= form_dropdown('','','','class="select-kategori stext" style="width:100%;" id = "sub-sub-kategori" data-url = "'.site_url().'/get/kategori/ac_kategori/" title="Sediaan Pustaka"'); ?></td>
              </tr>
			  <tr class="trcb" id="cbpanel-sub-sub-sub-kategori" style="display:none;" data-before = "#cbpanel-sub-sub-kategori" data-position="4">
                <td class="td_left bold"></td>
                <td class="td_right"><?= form_dropdown('','','','class="select-kategori stext" style="width:100%;" id = "sub-sub-sub-kategori" data-url = "'.site_url().'/get/kategori/ac_kategori/" title="Tes"'); ?></td>
              </tr>
					...
					$.get($this.attr("data-url") + $this.val() + $chk, function($data){
						if($data){
							...
							if($this.val().length == 8){
								...
								$input.show();	
									$next.children().first().html('');
									$input.children().children().attr("placeholder", "Baru");
							}else if($this.val().length > 10){
								$input.hide();
							}
						}else{
