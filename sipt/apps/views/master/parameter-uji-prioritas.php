      ...
      <div class="col-lg-11"> 
        ...
        <section class="panel">
          ...
          <ul class="list-group" id="notif-pelaporan">
            ...
            <li class="list-group-item notif">&bull;&nbsp;Kategori E<span class="badge bg-info"><a href="<?php echo site_url(); ?>/home/prioritas/parameter-uji/0107" class="link-jml" id="0107-all" url="<?php echo site_url(); ?>/load/utility/get_prioritas/0107">0</a></span></li>
            ...
            <li class="list-group-item notif">&bull;&nbsp;Kategori Trigerred<span class="badge bg-info"><a href="<?php echo site_url(); ?>/home/prioritas/parameter-uji/0113" class="link-jml" id="0110-all" url="<?php echo site_url(); ?>/load/utility/get_prioritas/0110">0</a></span></li>
            <?php
