...
if($ispreview){
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Alamat Gudang / Pabrik</td><td class="td_right"><textarea name="SARANA[ALAMAT_2]" class="stext" title="Alamat Gudang / Pabrik. Jika lebih dari satu, gunakan tanda pemisah ; (titik koma)" rel="required"><?php echo $sess['ALAMAT_2'];?></textarea></td></tr>                <tr><td class="td_left">Propinsi</td><td class="td_right"><?php echo form_dropdown('SARANA[PROPINSI]',$propinsi,$sel_propinsi,'id="propinsi" class="stext" rel="required" title="Nama Propinsi asal sarana" url="'.site_url().'/autocompletes/autocomplete/set_kota/"'); ?></td></tr>
