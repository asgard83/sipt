    ...
    <div class="acco2">
        ...
        <div class="collapse">
				...
				<table class="form_tabel">
                	<tr><td class="td_left">Golongan Sarana</td><td class="td_right"><?php echo form_dropdown('GOLONGAN[GOLONGAN_SARANA]',$arr_golongan,$sess['GOLONGAN_SARANA'],'class="stext" id="golongan" title="Pilih salah satu golongan sarana"'); ?></td></tr>
