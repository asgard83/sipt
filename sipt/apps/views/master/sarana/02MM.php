...
if($ispreview){
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Alamat Gudang / Pabrik</td><td class="td_right"><ul style="list-style-type:disc; padding-left:15px; margin:0;"><?php $alamat_2 = explode(";", $sess['ALAMAT_2']); echo "<li>".join("</li><li>", $alamat_2)."</li>"; ?></ul></td></tr>
        ...
        <tr><td class="td_left">No SIK</td><td class="td_right"><?php echo $sess['NO_SIK']; ?></td></tr>
    </table>
    <?php
}else{
	?>
    <table class="form_tabel detil">
        <tr><td class="td_left">Alamat Kantor</td><td class="td_right"><textarea name="SARANA[ALAMAT_1]" class="stext" title="Alamat Kantor Pusat / Cabang. Jika lebih dari satu, gunakan tanda pemisah ; (titik koma)" rel="required"><?php echo $sess['ALAMAT_1'];?></textarea></td></tr>
        <tr><td class="td_left">Alamat Gudang / Pabrik</td><td class="td_right"><textarea name="SARANA[ALAMAT_2]" class="stext" title="Alamat Gudang / Pabrik. Jika lebih dari satu, gunakan tanda pemisah ; (titik koma)" rel="required"><?php echo $sess['ALAMAT_2'];?></textarea></td></tr>                
        ...
        <tr><td class="td_left">No SIK</td><td class="td_right"><input type="text" name="SARANA[NO_SIK]" value="<?php echo $sess['NO_SIK']; ?>" class="stext" title="No SIK Sarana."/></td></tr>
    </table>
    <?php
}
?>
