...
<table class="form_tabel detil">
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Jenis Industri</td><td class="td_right"><?php echo form_dropdown('SARANA[JENIS_INDUSTRI]',$jenis_industri[1],$sess['JENIS_INDUSTRI'],'class="stext" title="Pilih salah satu jenis industri"'); ?></td></tr>
        <tr><td class="td_left">Kegiatan yang Dilakukan oleh Sarana Produksi</td><td class="td_right"><textarea class="stext" name="SARANA[KEGIATAN_SARANA]" title="Kegiatan yang dilakukan oleh sarana produksi. Jika melakukan kegiatan lebih dari satu, pisahkan dengan tanda ; (titik koma). Pilihan : Produksi bahan baku OT; Produksi produk jadi OT; Produksi produk antara dan bulk; Pengujian/laboratorium"><?php echo $sess['KEGIATAN_SARANA']; ?></textarea></td></tr>
