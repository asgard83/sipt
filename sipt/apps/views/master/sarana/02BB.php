...
if($ispreview){
    ...
    <table class="form_tabel detil">
        <tr>
          <td class="td_left">Alamat Kantor</td><td class="td_right"><ul style="list-style-type:disc; padding-left:15px; margin:0;"><?php $alamat_1 = explode(";", $sess['ALAMAT_1']); echo "<li>".join("</li><li>", $alamat_1)."</li>"; ?></ul></td></tr>
        <tr>
          <td class="td_left">Alamat Gudang</td>
          <td class="td_right"><ul style="list-style-type:disc; padding-left:15px; margin:0;"><?php $alamat_2 = explode(";", $sess['ALAMAT_2']); echo "<li>".join("</li><li>", $alamat_2)."</li>"; ?></ul></td>
        </tr>
        ...
        <tr><td class="td_left">Nama Izin</td><td class="td_right"><?php echo $sess['NOMOR_IZIN']; ?></td></tr>
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Nomor Izin</td><td class="td_right"><input type="text" name="SARANA[NOMOR_IZIN]" value="<?php echo $sess['NOMOR_IZIN']; ?>" class="stext" title="Nama Izin yang dimiliki"/></td></tr>
