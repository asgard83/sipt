...
if($ispreview){
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Nama Pengelola Obat</td><td class="td_right"><?php echo $sess['PENANGGUNG_JAWAB']; ?></td></tr>
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Nama Pengelola Obat</td><td class="td_right"><input type="text" name="SARANA[PENANGGUNG_JAWAB]" value="<?php echo $sess['PENANGGUNG_JAWAB']; ?>" class="stext" title="Nama Pengelola Obat."/></td></tr>
