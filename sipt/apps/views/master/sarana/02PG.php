...
if($ispreview){
    ...
    <table class="form_tabel detil">
        <tr><td class="td_left">Alamat</td><td class="td_right"><?php $alamat_1 = explode(";", $sess['ALAMAT_1']); echo join("<br>", $alamat_1); ?></td></tr>
        ...
        <tr><td class="td_left">Golongan Sarana</td><td class="td_right"><?php echo $sess['GOLONGAN_SARANA']; ?></td></tr>
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Telepon</td><td class="td_right"><input type="text" class="stext" name="SARANA[TELEPON]" value="<?php echo $sess['TELEPON']; ?>" title="No. Telepon Sarana. Jika lebih dari satu, pisahkan dengan tanda ; (titik koma)" /></td></tr>
        ...
        <tr><td class="td_left">Nomor Izin Perdagangan</td><td class="td_right"><input type="text" class="stext" name="SARANA[NOMOR_IZIN]" value="<?php echo $sess['NOMOR_IZIN']; ?>" title="Nomor Izin Perdaganan Sarana" /></td></tr>
        <tr><td class="td_left">Golongan Sarana</td><td class="td_right"><?php echo form_dropdown('SARANA[GOLONGAN_SARANA]', $arr_golongan, $sess['GOLONGAN_SARANA'], 'class="stext" title="Pilih salah satu jenis golongan sarana"'); ?></td></tr>
