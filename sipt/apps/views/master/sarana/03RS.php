...
if($ispreview){
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Telepon</td><td class="td_right"><?php echo $sess['TELEPON']; ?></td></tr>
        <tr><td class="td_left">Nama Pimpinan</td><td class="td_right"><?php echo $sess['PENANGGUNG_JAWAB']; ?></td></tr>
        <tr><td class="td_left">Nama Penanggung Jawab</td><td class="td_right"><?php echo $sess['NAMA_PIMPINAN']; ?></td></tr>
    ...
    <table class="form_tabel detil">
        ...
        <tr><td class="td_left">Nama Pimpinan</td><td class="td_right"><input type="text" name="SARANA[PENANGGUNG_JAWAB]" value="<?php echo $sess['PENANGGUNG_JAWAB']; ?>" class="stext" title="Nama Pemilik."/></td></tr>
        <tr><td class="td_left">Nama Penanggung Jawab</td><td class="td_right"><input type="text" name="SARANA[NAMA_PIMPINAN]" value="<?php echo $sess['NAMA_PIMPINAN']; ?>" class="stext" title="Nama Pimpinan Sarana"/></td></tr>
