...
<div id="accordion">
    ...
    <form action="<?php echo $act; ?>" autocomplete="off" method="post" id="rkpstatus">
        <table class="form_tabel">
            ...
            <tr><td class="td_left">Balai Besar / Balai POM</td><td class="td_right"><?php echo form_dropdown('BBPOM_ID',$bbpom,'','class="stext" title="Pilih Balai Besar / Balai POM"'); ?>
            <?php
			if(array_key_exists('1', $this->newsession->userdata('SESS_KODE_ROLE'))){
				?>
                &nbsp;<div style="padding-top:7px;"><input type="checkbox" name="isjenis" value="1" />&nbsp;&nbsp;Proses Sebagai RHPK Status Dokumen</div>
                <?php
			}
			?>
            </td></tr>
