...
<div class="headersarana">PENGAWASAN PENANDAAN - SUPLEMEN MAKANAN</div>
<?php
...
?>
<div class="content">
    <form action="<?php echo $act; ?>" method="post" autocomplete="off" id="fpengawasanPenandaan_011">
        <div class="adCntnr">
            <div class="acco2">
                ...
                <div class="acco2"><div class="expand"><a title="expand/collapse" href="#" style="display: block;">INFORMASI SUPLEMEN MAKANAN - PENANDAAN</a></div>
                    <div class="collapse">
                        <div class="accCntnt">
                            <table class="form_tabel">
                                <tr>
                                    <td class="td_left">Nama Produk <br /><br />Bentuk Sediaan</td><td class="td_right"><input type="text" class="stext namaSMJadi" id="namaSMJadi" url="<?php echo site_url(); ?>/autocompletes/autocomplete/produk_reg_2/" title="Nama Produk" rel="required" name="PENANDAANPRODUK[NAMA_PRODUK]" value="<?php echo $sess['NAMA_PRODUK'] ?>" /> <br /><br /><input type="text" class="stext" id="bentukSediaan" title="Bentuk Sediaan" name="PENANDAANPRODUK[BENTUK_SEDIAAN]" value="<?php echo $sess['BENTUK_SEDIAAN'] ?>"/></td>
                                    <td class="td_left">Komposisi</td><td class="td_right"><textarea class="stext" id="komposisi" title="Komposisi" name="PENANDAANPRODUK[KOMPOSISI]" style="height: 40px;" rel ="required"><?php echo $sess['KOMPOSISI'] ?></textarea></td>
                                </tr>
                                <tr>
                            ...
                            <?php if (trim($sess['PENILAIANBL']) != "" && trim($detail[0]) != "") { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <table class="form_tabel" class="div_bL" style="width: 100%;">
                                        ...
                                        <tr class="infoPenandaanSM_bLRow">
                                        ...
                                        <tr class="BahasaImporbL infoPenandaanSM_bLRow" hidden>
                                ...
                                <?php if (trim($sess['PENILAIANBL']) != "" && trim($detail2[0]) != "") { ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <table class="form_tabel" class="div_kP" style="width: 100%;">
                                            ...
                                            <tr class="infoPenandaanSM_kPRow">
                                                <!--<td class="td_left_checklist">1</td>-->
                                                <td class="td_left_header_checklist" style="vertical-align: top">No Bets </td>
                                                <td class="td_left">
                                            ...
                                            <tr class="BahasaImporkP infoPenandaanSM_kPRow" hidden>
                                                <td class="td_left_header_checklist" style="vertical-align: top;">Importir </td>
                                                <td class="td_left">
                                                ...
                                                do {
                                                    if (array_key_exists('LAMPIRAN', $sess) && trim($sess['LAMPIRAN']) != "") {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td_left_header_checklist" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="file_FILE_PENANDAAN_SM<?php echo $i; ?>"><input type="hidden" name="PENANDAAN_SM[]" value="<?php echo $arrDataLamp[$i]; ?>"><a href="<?php echo base_url(); ?>files/<?php echo 'penandaan_011'; ?>/<?php echo $arrDataLamp[$i]; ?>" target="_blank" <?php if ($arrLamp[1] == "rar") echo 'onclick="dotRar();return false;"'; ?>>File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" url="<?php echo site_url(); ?>/utility/uploads/del_upload_s/<?php echo 'penandaan_011/'; ?><?php echo $arrDataLamp[$i]; ?>" jns="FILE_PENANDAAN_SM<?php echo $i; ?>">Edit atau Hapus File ?</a></span><span class="upload_FILE_PENANDAAN_SM<?php echo $i; ?>" hidden><input type="file" jenis="FILE_PENANDAAN_SM<?php echo $i; ?>" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_s/<?php echo 'penandaan_011'; ?>" id="fileToUpload_FILE_PENANDAAN_SM<?php echo $i; ?>" name="userfile" onchange="do_upload($(this));
                                                    return false;" />
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td class="td_left_header_checklist" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="upload_FILE_PENANDAAN_SM"><input type="file" class="upload upSM" jenis="FILE_PENANDAAN_SM" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_s/<?php echo 'penandaan_011'; ?>" id="fileToUpload_FILE_PENANDAAN_SM" name="userfile" onchange="do_upload($(this));
                                                    return false;" />
                                                                    &nbsp;Tipe File : *.jpg .jpeg .pdf .doc .docx .rar</span><span class="file_FILE_PENANDAAN_SM"></span></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    $i++;
                                                    ...
                                                    <?php if (!in_array($this->newsession->userdata('SESS_BBPOM_ID'), $this->config->item('cfg_unit'))) { ?>
                                                        ...
                                                        <tr class="tDKBalaiRow" hidden><td class="td_left"></td><td colspan="2"><?php
                                                                if ((array_key_exists('FILE_MUSNAH', $sess) && trim($sess['FILE_MUSNAH']) != "")) {
                                                                    ...
                                                                    <span id="file_FILE_MUSNAH"><a href="<?php echo base_url(); ?>files/<?php echo 'penandaan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" target="_blank">File Lampiran</a>&nbsp;&bull;&nbsp;<a href="#" class="del_upload" id = "del_upload1" url="<?php echo site_url(); ?>/utility/uploads/del_upload_m/<?php echo 'penandaan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" jns="FILE_MUSNAH">Edit atau Hapus File ?</a></span>
                                                                    <span class="upload_FILE_MUSNAH" hidden><input type="file" class="uploadMusnahBalai tDKBalaiRow" jenis="FILE_MUSNAH" allowed="doc-docx-pdf" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'penandaan_011/2_011'; ?>" id="fileToUpload_FILE_MUSNAH" name="userfile" onchange="do_upload($(this));
                                                    return false;" title="Lampiran Berita Acara" />
                                                                        &nbsp;Tipe File : *.doc .docx.pdf</span><span class="file_FILE_MUSNAH"></span>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <span class="upload_FILE_MUSNAH"><input type="file" class="uploadMusnahBalai tDKBalaiRow" jenis="FILE_MUSNAH" allowed="doc-docx-pdf" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'penandaan_011/2_011'; ?>" id="fileToUpload_FILE_MUSNAH" name="userfile" onchange="do_upload($(this));
                                                    return false;" title="Lampiran Berita Acara" />
                                                                        &nbsp;Tipe File : *.doc .docx.pdf</span><span class="file_FILE_MUSNAH"></span>
                                                                    <?php
                                                                }
                                        ...
                                        <div class="accCntnt">
                                            <table class="form_tabel" style="width: 100%;">
                                                ...
                                                if ((trim($sess['PUSAT']) == "" && in_array('2', $this->newsession->userdata('SESS_KODE_ROLE'))) || $editTL == 'YES') {
                                                    ...
                                                    <tr class="vJustifikasi" hidden><td class="td_left" style="background-color: white; vertical-align: top;">Justifikasi</td><td class="td_left" style="background-color: white;"><textarea name="JUSTIFIKASI" title="Justifikasi Pusat" class="stext chkJustifikasi" id="XXX" style="height: 140px;"><?php echo $pusat[3]; ?></textarea></td></tr> <?php
                                                } else {
                                                    if ($pusat[0] == "TMK") {
                                                        ?>
                                ...
                                <div style="padding:10px;"></div><div><a href="javascript:void(0)" id="btnSave" class="button <?php echo $icon; ?>" onclick="fpost('#fpengawasanPenandaan_011', '', '');">
...
?>
                                            $("input.namaSMJadi").autocomplete($("input.namaSMJadi").attr("url") + 'pk', {width: 244, selectFirst: false});
                                            $("input.namaSMJadi").result(function(event, data, formatted) {
                                                if (data) {
                                                    var jenisProduk = data[2].substring(0, 2);
                                                    $('#namaSMJadi').val(data[1]);
                                                    $('#NIE').val(data[2]);
                                            ...
                                            function mkTmk(load) {
                                                ...
                                                if ((X === true && X2 === true) || (X !== true && X2 === true) || (X === true && X2 !== true)) {
                                                    ...
                                                    $("#fileToUpload_FILE_PENANDAAN_SM").attr("rel", "required");
                                                    $(".TDKB").show("");
                                                    ...
                                                    $("#fileToUpload_FILE_PENANDAAN_SM").attr("rel", "");
                                                    $(".TDKB").hide("");
                                                    $(".TDKB").val("");
                                                    $(".TDKB").attr("rel", "");
                                                    $("#tDKBalai").attr("rel", "");
                                            ...
                                            $('.addLampiran').click(function() {
                                                ...
                                                $("#tb_Lamp").append('<tr id= "id_' + nom + '"><td class="td_left_header_checklist" colspan="2"><a href="javascript:void(0)" class="min" id="minCls' + nom + '" ><img src="<?php echo base_url(); ?>images/cancel.png" align="top" style="border:none" title="Hapus Lampiran" /></a>&nbsp;<span class="upload_FILE_PENANDAAN_SM' + nom + '"><input type="file" class="upload upSM" jenis="FILE_PENANDAAN_SM' + nom + '" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_s/<?php echo 'penandaan_011'; ?>" id="fileToUpload_FILE_PENANDAAN_SM' + nom + '" name="userfile" onchange="do_upload($(this));return false;" />&nbsp;Tipe File : *.jpg .jpeg .pdf .doc .docx .rar</span><span class="file_FILE_PENANDAAN_SM' + nom + '"></span></td></tr>');
