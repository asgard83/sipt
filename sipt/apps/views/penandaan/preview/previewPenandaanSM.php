    ...
    <form action="<?php echo $act; ?>" method="post" autocomplete="off" id="fpengawasanPenandaan_011">
        <div class="adCntnr">
            <div class="acco2">
                ...
                <div class="collapse">
                    <div class="accCntnt">
                        ...
                        <table class="form_tabel">
                            ...
                            <tr><td class="td_left">Alamat Importir</td><td><?php echo $sess['ALAMAT_PENDAFTAR']; ?></td></tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="collapse">
                        <div class="accCntnt">
                                        ...
                                        <table class="form_tabel">
                                            ...
                                            if (trim($sess['LAMPIRAN']) != '' && $sess['LAMPIRAN'] != 0) {
                                                ...
                                                foreach ($arrDataLamp as $value) {
                                                    ...
                                                    ?>
                                                    <tr><td class="td_left" style="padding-left: 20px" colspan="3"><a href="<?php echo base_url(); ?>files/<?php echo 'penandaan_011/'; ?><?php echo $value; ?>" target="_blank" <?php if ($arrLamp[1] == "rar") echo 'onclick="dotRar();return false;"'; ?>>Lihat Lampiran</a></td></tr>
                                                    <?php
                                                }
                                            } else {
                                                ?>
                                            ...
                                            <?php if ($sess['TL_BALAI'] != 0) { ?><tr><td class="td_left" style="padding-left: 20px">Tindak Lanjut</td><td class="td_right"><?php echo $cb_tindakan_balai[$sess["TL_BALAI"]]; ?></td></tr>
                                            <?php } if ($sess["TL_BALAI"] == "1") { ?><tr><td class="td_left" style="padding-left: 20px"></td><td><input type="text" class="tDKBalaiRow TDKB" id="jmlMusnah" title="Jumlah" placeholder = "Jumlah" maxlength="5" size="5" value="<?php echo $pemusnahan2[0] ?>" readonly/>&nbsp;<input type="text" class="tDKBalaiRow TDKB" id="satuanMusnah" title="Satuan" placeholder = "Satuan" size="10" value="<?php echo $pemusnahan[1] ?>" readonly/>&nbsp;<input type="text" class="tDKBalaiRow TDKB" id="estimasiMusnah" title="Estimasi Harga" placeholder = "Estimasi Harga" maxlength="10" size="10" value="<?php
                                                if (trim($pemusnahan2[1]) != "")
                                                    echo $pemusnahan2[1];
                                                else
                                                    echo "-"
                                                    ?>" readonly/></td></tr>
                                                <tr><td class="td_left" style="padding-left: 20px"></td><td><input type="hidden" name="MUSNAH[]" id = "fileMusnah" value="<?php echo $sess['FILE_MUSNAH']; ?>"><span id="file_FILE_MUSNAH"><a href="<?php echo base_url(); ?>files/<?php echo 'penandaan_011/2_011'; ?>/<?php echo $sess['FILE_MUSNAH']; ?>" target="_blank">File Lampiran Pemusnahan</a></td></tr><?php } ?>
                                        </table>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php if ($formEdit === 'check') { ?>
                                ...
                                <div style="height:5px;"></div>
                            <?php } ?>
                            <div style="padding:10px;"></div><div><?php if ($formEdit === 'check') { ?><a href="javascript:void(0)" id="btnSave" class="button check" onclick="fpost('#fpengawasanPenandaan_011', '', '');">
                ...
                <input type="hidden" name="PENILAIANBL" value="<?php echo $sess['PENILAIANBL']; ?>" />
                <input type="hidden" name="PENILAIANKP" value="<?php echo $sess['PENILAIANKP']; ?>" />
