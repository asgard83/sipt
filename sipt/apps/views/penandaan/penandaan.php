...
<div class="content">
 ...
 <div id="accordion">
  <h2 class="current">Pengawasan Penandaan</h2>
  <form name="fpemantauan_" id="fpenandaan_" method="post" action="<?php echo $act; ?>" autocomplete="off">
   <table>
    <tr>
     <td>
      <table>
         ...
         <table>
          <tbody id="tb_surat">
           <tr class="urut<?php echo $i; ?>">
            <td width="150">Nomor Surat Tugas</td><td><input type="text" class="stext" name="SURAT" id="stugas_"  title="Di isi dengan nomor surat tugas pengawasan" placeholder="Apabila Ada Surat Tugas Pengawasan" value="<?php echo $suratTugas ?>"/>&nbsp;&nbsp;
            </td>
           </tr>
           <tr class="urut<?php echo $i; ?>">
           ...
           <tr class="urut<?php echo $i; ?>">
            <td class="atas">Petugas Pengawasan Penandaan</td>
      ...
      <div style="padding-left:5px;">
       <a href="#" class="button save" onclick="fpost('#fpenandaan_', '', '');
