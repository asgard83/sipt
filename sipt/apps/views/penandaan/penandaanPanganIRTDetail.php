...
<div class="headersarana">PENGAWASAN PENANDAAN - PANGAN IRT</div>
<?php
                ...
                <div class="acco2"><div class="expand"><a title="expand/collapse" href="#" style="display: block;">INFORMASI PANGAN - PENANDAAN</a></div>
                    <div class="collapse">
                        <div class="accCntnt">
                            <table class="form_tabel">
                                <tr>
                                    <td class="td_left">Nama Produk </td><td class="td_right"><input type="text" size="45" class="namaPanganJadi" id="namaPanganJadi" title="Nama Produk" rel="required" name="PENANDAANPRODUK[NAMA_PRODUK]" value="<?php echo $sess['NAMA_PRODUK'] ?>" /></td>
                                    <td class="td_left">Nomor Izin Edar</td><td class="td_right"><input type="text" size="45" id="NIE" title="NIE" title="Nomor Izin Edar" rel="required" name="PENANDAANPRODUK[NIE]" value="<?php echo $sess['NOMOR_IZIN_EDAR'] ?>" /></td>
                                </tr>
                                <tr>
                                    <td class="td_left">Merk Pangan</td><td class="td_right"><input type="text" size="45" id="merk" title="Merk Pangan" rel="required" name="PENANDAANPRODUK[MERK_PRODUK]" value="<?php echo $sess['MERK_PRODUK'] ?>" /></td>
                                    <td class="td_left">Kemasan (Netto)</td><td class="td_right"><input type="text" size="45" id="kemasan" title="Kemasan" rel="required" name="PENANDAANPRODUK[BESAR_KEMASAN]" value="<?php echo $sess['BESAR_KEMASAN'] ?>"/></td>
                                </tr>
                                <tr>
                                    <td class="td_left">Produsen</td><td class="td_right"><input type="text" size="45" id="produsen" title="Nama Produsen" rel="required" name="PENANDAANPRODUK[PRODUSEN]" value="<?php echo $sess['PRODUSEN'] ?>"/></td>
                                    <td class="td_left">Importir / Distributor</td><td class="td_right"><input type="text" size="45" id="importir" rel="required" name="PENANDAANPRODUK[IMPORTIR]" title="Nama Importir / Produsen" value="<?php echo $sess['IMPORTIR'] ?>" /></td>
                                </tr>
                                <tr>
                                    <td class="td_left">Alamat Produsen</td><td class="td_right"><textarea id="alamatProdusen" class="stext" style="height: 50px" rel="required" title="Alamat Produsen" name="PENANDAANPRODUK[ALAMAT_PRODUSEN]"><?php echo $sess['ALAMAT_PRODUSEN'] ?></textarea></td>
                                    <td class="td_left">Alamat Importir / Distributor</td><td class="td_right"><textarea id="alamatImportir" class="stext" style="height: 50px" rel="required" title="Alamat Produsen" name="PENANDAANPRODUK[ALAMAT_IMPORTIR]"><?php echo $sess['ALAMAT_IMPORTIR'] ?></textarea></td>
                                </tr>
                                <tr>
                                    <td class="td_left">Jenis Pangan</td><td class="td_right"><input type="text" size="45" id="jenisPangan" title="Jenis Pangan" rel = "required" name="PENANDAANPRODUK[GOLONGAN_PRODUK]" value="<?php echo $sess['GOLONGAN_PRODUK'] ?>"/></td>
                                    <td colspan="2"></td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <table class="form_tabel">
                            ...
                            <tr class="infoPenandaanPNGRow">
                                ...
                                <td class="td_left">
                                    ...
                                    <span style="margin-left: 5px;"></span>
                                    <input class="uraianPenandaan" param="Bobot" type="radio" id="radioE3" name="CHK[4]" value="X_Bobot Tuntas" <?php if ($d[3][0] == '+') echo 'checked'; ?>>
                            ...
                            <tr id="Halal" hidden>
                                <td class="td_left_checklist"></td>
                                <td>&nbsp;<input type="text" name="URN[10]" class="uPenandaan halal" title="Uraian Penandaan" size="45" id="CHK[10]" value="<?php echo $detail2[10]; ?>" /></td>
                            </tr>
                            <tr class="infoPenandaanPNGRow">
                            ...
                            <tr class="infoPenandaanPNGRow" id="rutinRow" hidden>
                                ...
                                <td class="td_left">
                                    <input class="uraianPenandaan" param="Rutin" type="radio" id="radioR1" name="CHK[11]" value="+_Menyesatkan" <?php if ($d[10][0] == '+') echo 'checked'; ?>>
                            ...
                            <tr class="infoPenandaanPNGRow">
                                ...
                                <td>&nbsp;<textarea name="URN[11]" class="uPenandaan" title="Uraian Penandaan" id="CHK[11]" style="width: 34%; height: 100px;" ><?php echo $detail2[10]; ?></textarea></td>
                               ...
                               <!--<td class="td_left_checklist" style="vertical-align: top">37</td>-->
                                <td class="td_left_header_checklist">Lampiran : </td><td><?php
                                    if (array_key_exists('LAMPIRAN', $sess) && trim($sess['LAMPIRAN']) != "") {
                                        ...
                                        ?>
                                        <span class="upload_FILE_PENANDAAN_PANGAN"><input type="file" class="upload upPANGAN" jenis="FILE_PENANDAAN_PANGAN" allowed="jpg-jpeg-pdf-doc-docx-rar" url="<?php echo site_url(); ?>/utility/uploads/get_upload_m/<?php echo 'penandaan_013/irt'; ?>" id="fileToUpload_FILE_PENANDAAN_PANGAN" name="userfile" onchange="do_upload($(this));
                                                return false;" />
