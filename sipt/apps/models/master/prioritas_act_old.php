		...
		if((in_array('1', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('9', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('4', $this->newsession->userdata('SESS_KODE_ROLE'))) && $this->newsession->userdata('LOGGED_IN') ==  TRUE){
			...
			if($id == "0101"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0101' AND STATUS IN ('2','9') AND VERIFI = '01'";
				...
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0102' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				$this->newtable->width(array('BIDANG UJI' => 75,'ZAT AKTIF' => 200, 'BAHAN AKTIF' => 200, 'BENTUK SEDIAAN' => 200, 'PARAMETER UJI' => 200, 'PUSTAKA' => 150, 'METODE' => 150, 'SYARAT' => 150, 'PRIORITAS' => 50));
				$this->newtable->search(array(array("CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END", "Berdasarkan Bidang Pengujian"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END", "Berdasarkan Zat Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END", "Berdasarkan Bahan Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END", "Berdasarkan Bentuk Sediaan"),array("PARAMETER_UJI", "Berdasarkan Parameter Uji"),array("PUSTAKA", "Berdasarkan Pustaka"),array("METODE", "Berdasarkan Metode"),array("SYARAT", "Berdasarkan Syarat"), array("PRIORITAS_TAHUN","Berdasarkan Prioritas")));
			}else if($id == "0103"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  END AS [SEDIAAN PUSTAKA],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0103' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				$this->newtable->width(array('BIDANG UJI' => 75,'NAMA OBAT' => 200, 'ZAT AKTIF' => 200, 'SEDIAAN PUSTAKA' => 200, 'PARAMETER UJI' => 200, 'PUSTAKA' => 150, 'METODE' => 150, 'SYARAT' => 150, 'PRIORITAS' => 50));
				$this->newtable->search(array(array("CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END", "Berdasarkan Bidang Pengujian"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END", "Berdasarkan Nama Obat"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END", "Berdasarkan Zat Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END", "Berdasarkan Sediaan Pustaka"),array("PARAMETER_UJI", "Berdasarkan Parameter Uji"),array("PUSTAKA", "Berdasarkan Pustaka"),array("METODE", "Berdasarkan Metode"),array("SYARAT", "Berdasarkan Syarat"), array("PRIORITAS_TAHUN","Berdasarkan Prioritas")));
			}else if($id == "0104"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7))
						  ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6))
						  ...
						  END AS [SEDIAAN PUSTAKA],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0104' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				$this->newtable->width(array('BIDANG UJI' => 75,'ZAT AKTIF' => 200, 'BAHAN AKTIF' => 200, 'BENTUK SEDIAAN' => 200, 'PARAMETER UJI' => 200, 'PUSTAKA' => 150, 'METODE' => 150, 'SYARAT' => 150, 'PRIORITAS' => 50));
				$this->newtable->search(array(array("CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END", "Berdasarkan Bidang Pengujian"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END", "Berdasarkan Zat Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END", "Berdasarkan Bahan Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END", "Berdasarkan Bentuk Sediaan"),array("PARAMETER_UJI", "Berdasarkan Parameter Uji"),array("PUSTAKA", "Berdasarkan Pustaka"),array("METODE", "Berdasarkan Metode"),array("SYARAT", "Berdasarkan Syarat"), array("PRIORITAS_TAHUN","Berdasarkan Prioritas")));
			}else if($id == "0105"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  END AS [BENTUK SEDIAAN],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0105' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				...
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  END AS [KOMPOSISI],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0106' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				...
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  ...
						  END AS [BENTUK SEDIAAN],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0108' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				...
				$this->newtable->search(array(array("CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END", "Berdasarkan Bidang Pengujian"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END", "Berdasarkan Nama Obat"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END", "Berdasarkan Zat Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END", "Bentuk Sediaan"),array("PARAMETER_UJI", "Berdasarkan Parameter Uji"),array("PUSTAKA", "Berdasarkan Pustaka"),array("METODE", "Berdasarkan Metode"),array("SYARAT", "Berdasarkan Syarat"), array("PRIORITAS_TAHUN","Berdasarkan Prioritas")));
			}else if($id == "0109"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7))
						  ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6))
						  ...
						  END AS [SEDIAAN PUSTAKA],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '0109' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
			...
			else if($id == "0110" || $id == "0111" || $id == "0112"){
				$query = "SELECT SRL_ID, CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END AS [BIDANG UJI],
						  CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7))
						  ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6))
						  END AS [ZAT AKTIF],
						  ...
						  END AS [SEDIAAN PUSTAKA],
						  PARAMETER_UJI AS [PARAMETER UJI], PUSTAKA, METODE, SYARAT, PRIORITAS_TAHUN AS PRIORITAS 
						  FROM M_PRIORITAS WHERE LEFT(GOLONGAN,4) = '".$id."' AND STATUS IN ('2','9') AND VERIFI = '01'";
				$this->newtable->columns(array("SRL_ID", "CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END" ,"CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END","CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END","PARAMETER_UJI", "PUSTAKA","METODE","SYARAT","PRIORITAS_TAHUN"));
				$this->newtable->width(array('BIDANG UJI' => 75,'ZAT AKTIF' => 200, 'BENTUK SEDIAAN' => 200, 'SEDIAAN PUSTAKA' => 200, 'PARAMETER UJI' => 200, 'PUSTAKA' => 150, 'METODE' => 150, 'SYARAT' => 150, 'PRIORITAS' => 50));
				$this->newtable->search(array(array("CASE WHEN BIDANG_UJI = '01' THEN 'Mikrobiologi' WHEN BIDANG_UJI = '02' THEN 'Kimia' END", "Berdasarkan Bidang Pengujian"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,7)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,6)) END", "Berdasarkan Zat Aktif"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,9)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,8)) END", "Berdasarkan Bentuk Sediaan"), array("CASE WHEN LEN(GOLONGAN) = 11 THEN dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,11)) ELSE dbo.GOLONGAN_SAMPEL_NEW(SUBSTRING(GOLONGAN,1,10)) END", "Sediaan Pustaka"),array("PARAMETER_UJI", "Berdasarkan Parameter Uji"),array("PUSTAKA", "Berdasarkan Pustaka"),array("METODE", "Berdasarkan Metode"),array("SYARAT", "Berdasarkan Syarat"), array("PRIORITAS_TAHUN","Berdasarkan Prioritas")));
			}
	...
	function get_prioritas($kategori,$id){
		if($this->newsession->userdata('LOGGED_IN') == TRUE){
			...
			if($digit == 2){
				...
				$arrdata['kategori'] = $sipt->main->combobox("SELECT LTRIM(RTRIM(KLASIFIKASI_ID)) AS KLASIFIKASI_ID, KLASIFIKASI FROM M_GOLONGAN_NEW WHERE LEFT(KLASIFIKASI_ID,2) = '".$kategori."' AND LEN(KLASIFIKASI_ID) = 4 AND KLASIFIKASI IS NOT NULL ORDER BY 2","KLASIFIKASI_ID","KLASIFIKASI", TRUE);
			}else{
				$arrdata['komoditi'] = $sipt->main->get_uraian("SELECT KLASIFIKASI FROM M_GOLONGAN_NEW WHERE LEFT(KLASIFIKASI_ID,2) = '".substr($kategori,0,2)."'","KLASIFIKASI");
				$arrdata['kategori'] = $sipt->main->combobox("SELECT LTRIM(RTRIM(KLASIFIKASI_ID)) AS KLASIFIKASI_ID, KLASIFIKASI FROM M_GOLONGAN_NEW WHERE KLASIFIKASI_ID = '".$kategori."'","KLASIFIKASI_ID","KLASIFIKASI",TRUE);
			}
