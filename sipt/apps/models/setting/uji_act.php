	...
	function set_uji($multi, $balai, $bidang, $komoditi, $reset=""){
		if(in_array('1', $this->newsession->userdata('SESS_KODE_ROLE')) || in_array('9', $this->newsession->userdata('SESS_KODE_ROLE'))){
			if($multi == "single"){
				...
				$ret = $this->db->update("M_REF_UJI", $arrdata);
